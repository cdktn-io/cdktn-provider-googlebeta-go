...
func (j *jsiiProxy_GoogleVmwareenginePrivateCloudNsxList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGoogleVmwareenginePrivateCloudNsxList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleVmwareenginePrivateCloudNsxList {
	_init_.Initialize()
...
func NewGoogleVmwareenginePrivateCloudNsxList_Override(g GoogleVmwareenginePrivateCloudNsxList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleVmwareenginePrivateCloudNsxList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleVmwareenginePrivateCloudNsxList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleVmwareenginePrivateCloudNsxList) Resolve(context cdktn.IResolveContext) interface{} {
