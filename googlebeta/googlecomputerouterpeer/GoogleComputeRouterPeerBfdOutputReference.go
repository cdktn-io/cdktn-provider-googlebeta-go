...
func (g *jsiiProxy_GoogleComputeRouterPeerBfdOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleComputeRouterPeerBfdOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
