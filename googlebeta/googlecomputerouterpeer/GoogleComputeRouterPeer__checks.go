...
func (g *jsiiProxy_GoogleComputeRouterPeer) validatePutAdvertisedIpRangesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleComputeRouterPeerAdvertisedIpRanges; received %#v (a %T)", value, value)
		}
	}
...
func (g *jsiiProxy_GoogleComputeRouterPeer) validatePutCustomLearnedIpRangesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleComputeRouterPeerCustomLearnedIpRanges; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_GoogleComputeRouterPeer) validateSetDeletionPolicyParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
