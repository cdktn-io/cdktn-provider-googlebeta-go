...
func (j *jsiiProxy_GoogleComputeFirewallPolicyRuleMatchSrcSecureTagsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleComputeFirewallPolicyRuleMatchSrcSecureTagsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleComputeFirewallPolicyRuleMatchSrcSecureTagsList {
	_init_.Initialize()
...
func NewGoogleComputeFirewallPolicyRuleMatchSrcSecureTagsList_Override(g GoogleComputeFirewallPolicyRuleMatchSrcSecureTagsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleComputeFirewallPolicyRuleMatchSrcSecureTagsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleComputeFirewallPolicyRuleMatchSrcSecureTagsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleComputeFirewallPolicyRuleMatchSrcSecureTagsList) Resolve(context cdktf.IResolveContext) interface{} {
