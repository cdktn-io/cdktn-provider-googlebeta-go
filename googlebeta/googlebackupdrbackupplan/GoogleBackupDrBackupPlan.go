...
func (g *jsiiProxy_GoogleBackupDrBackupPlan) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleBackupDrBackupPlan) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
