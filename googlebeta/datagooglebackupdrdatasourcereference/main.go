...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.dataGoogleBackupDrDataSourceReference.DataGoogleBackupDrDataSourceReference",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dataSourceReferenceId", GoGetter: "DataSourceReferenceId"},
			_jsii_.MemberProperty{JsiiProperty: "dataSourceReferenceIdInput", GoGetter: "DataSourceReferenceIdInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "lastSuccessfulBackupTime", GoGetter: "LastSuccessfulBackupTime"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.dataGoogleBackupDrDataSourceReference.DataGoogleBackupDrDataSourceReferenceConfig",
