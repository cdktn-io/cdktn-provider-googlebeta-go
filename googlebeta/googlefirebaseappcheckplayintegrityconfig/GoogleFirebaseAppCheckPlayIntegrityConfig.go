...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googlefirebaseappcheckplayintegrityconfig/internal"
...
func (j *jsiiProxy_GoogleFirebaseAppCheckPlayIntegrityConfig) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleFirebaseAppCheckPlayIntegrityConfig) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleFirebaseAppCheckPlayIntegrityConfig) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleFirebaseAppCheckPlayIntegrityConfig) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleFirebaseAppCheckPlayIntegrityConfig) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.1/docs/resources/google_firebase_app_check_play_integrity_config google_firebase_app_check_play_integrity_config} Resource.
func NewGoogleFirebaseAppCheckPlayIntegrityConfig(scope constructs.Construct, id *string, config *GoogleFirebaseAppCheckPlayIntegrityConfigConfig) GoogleFirebaseAppCheckPlayIntegrityConfig {
	...
	_jsii_.Create(
		"@cdktn/provider-google-beta.googleFirebaseAppCheckPlayIntegrityConfig.GoogleFirebaseAppCheckPlayIntegrityConfig",
...
func (j *jsiiProxy_GoogleFirebaseAppCheckPlayIntegrityConfig)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleFirebaseAppCheckPlayIntegrityConfig)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleFirebaseAppCheckPlayIntegrityConfig)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleFirebaseAppCheckPlayIntegrityConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleFirebaseAppCheckPlayIntegrityConfig) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleFirebaseAppCheckPlayIntegrityConfig) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleFirebaseAppCheckPlayIntegrityConfig) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleFirebaseAppCheckPlayIntegrityConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleFirebaseAppCheckPlayIntegrityConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleFirebaseAppCheckPlayIntegrityConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
