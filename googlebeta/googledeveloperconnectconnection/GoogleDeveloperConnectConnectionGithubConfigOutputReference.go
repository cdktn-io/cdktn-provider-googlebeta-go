...
func (g *jsiiProxy_GoogleDeveloperConnectConnectionGithubConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDeveloperConnectConnectionGithubConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
