...
type GoogleDeveloperConnectConnectionGithubEnterpriseConfig struct {
	...
	ServiceDirectoryConfig *GoogleDeveloperConnectConnectionGithubEnterpriseConfigServiceDirectoryConfig `field:"optional" json:"serviceDirectoryConfig" yaml:"serviceDirectoryConfig"`
