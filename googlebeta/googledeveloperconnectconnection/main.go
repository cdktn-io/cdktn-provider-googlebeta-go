...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetTokenSecretVersion", GoMethod: "ResetTokenSecretVersion"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberProperty{JsiiProperty: "tokenSecretVersion", GoGetter: "TokenSecretVersion"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "bearerTokenAuthentication", GoGetter: "BearerTokenAuthentication"},
			_jsii_.MemberProperty{JsiiProperty: "bearerTokenAuthenticationInput", GoGetter: "BearerTokenAuthenticationInput"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putBearerTokenAuthentication", GoMethod: "PutBearerTokenAuthentication"},
			_jsii_.MemberMethod{JsiiMethod: "putServiceDirectoryConfig", GoMethod: "PutServiceDirectoryConfig"},
			_jsii_.MemberMethod{JsiiMethod: "resetBasicAuthentication", GoMethod: "ResetBasicAuthentication"},
			_jsii_.MemberMethod{JsiiMethod: "resetBearerTokenAuthentication", GoMethod: "ResetBearerTokenAuthentication"},
			_jsii_.MemberMethod{JsiiMethod: "resetServiceDirectoryConfig", GoMethod: "ResetServiceDirectoryConfig"},
			_jsii_.MemberMethod{JsiiMethod: "resetSslCaCertificate", GoMethod: "ResetSslCaCertificate"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "serviceDirectoryConfig", GoGetter: "ServiceDirectoryConfig"},
