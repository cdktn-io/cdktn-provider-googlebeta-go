...
func (g *jsiiProxy_GoogleAppEngineStandardAppVersionAutomaticScalingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleAppEngineStandardAppVersionAutomaticScalingOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
