...
func (j *jsiiProxy_GoogleAppEngineStandardAppVersion) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleAppEngineStandardAppVersion) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleAppEngineStandardAppVersion) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleAppEngineStandardAppVersion) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleAppEngineStandardAppVersion) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.43.0/docs/resources/google_app_engine_standard_app_version google_app_engine_standard_app_version} Resource.
...
func (j *jsiiProxy_GoogleAppEngineStandardAppVersion)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleAppEngineStandardAppVersion)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleAppEngineStandardAppVersion)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleAppEngineStandardAppVersion_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleAppEngineStandardAppVersion) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleAppEngineStandardAppVersion) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleAppEngineStandardAppVersion) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleAppEngineStandardAppVersion) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleAppEngineStandardAppVersion) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleAppEngineStandardAppVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
