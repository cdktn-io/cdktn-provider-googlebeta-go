...
func (g *jsiiProxy_GoogleAppEngineStandardAppVersionDeploymentOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleAppEngineStandardAppVersionDeploymentOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
