...
func (j *jsiiProxy_GoogleComputeBackendBucket) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleComputeBackendBucket) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleComputeBackendBucket) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleComputeBackendBucket) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleComputeBackendBucket) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleComputeBackendBucket)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleComputeBackendBucket)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleComputeBackendBucket)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleComputeBackendBucket_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleComputeBackendBucket) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleComputeBackendBucket) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleComputeBackendBucket) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleComputeBackendBucket) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleComputeBackendBucket) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleComputeBackendBucket) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
