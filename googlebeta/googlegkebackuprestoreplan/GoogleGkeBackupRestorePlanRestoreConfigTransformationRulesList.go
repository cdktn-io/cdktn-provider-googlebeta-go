...
func (j *jsiiProxy_GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGoogleGkeBackupRestorePlanRestoreConfigTransformationRulesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesList {
	_init_.Initialize()
...
func NewGoogleGkeBackupRestorePlanRestoreConfigTransformationRulesList_Override(g GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleGkeBackupRestorePlanRestoreConfigTransformationRulesList) Resolve(context cdktn.IResolveContext) interface{} {
