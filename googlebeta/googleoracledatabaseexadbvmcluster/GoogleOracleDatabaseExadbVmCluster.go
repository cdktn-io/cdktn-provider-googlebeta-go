...
func (g *jsiiProxy_GoogleOracleDatabaseExadbVmCluster) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleOracleDatabaseExadbVmCluster) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
