...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googlecomputenetworkpeeringroutesconfig/internal"
...
func (j *jsiiProxy_GoogleComputeNetworkPeeringRoutesConfig) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleComputeNetworkPeeringRoutesConfig) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleComputeNetworkPeeringRoutesConfig) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleComputeNetworkPeeringRoutesConfig) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleComputeNetworkPeeringRoutesConfig) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewGoogleComputeNetworkPeeringRoutesConfig(scope constructs.Construct, id *string, config *GoogleComputeNetworkPeeringRoutesConfigConfig) GoogleComputeNetworkPeeringRoutesConfig {
	...
	_jsii_.Create(
		"@cdktn/provider-google-beta.googleComputeNetworkPeeringRoutesConfig.GoogleComputeNetworkPeeringRoutesConfig",
...
func (j *jsiiProxy_GoogleComputeNetworkPeeringRoutesConfig)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleComputeNetworkPeeringRoutesConfig)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleComputeNetworkPeeringRoutesConfig)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleComputeNetworkPeeringRoutesConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleComputeNetworkPeeringRoutesConfig) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleComputeNetworkPeeringRoutesConfig) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleComputeNetworkPeeringRoutesConfig) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleComputeNetworkPeeringRoutesConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleComputeNetworkPeeringRoutesConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleComputeNetworkPeeringRoutesConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
