...
func (g *jsiiProxy_GoogleDataprocClusterVirtualClusterConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDataprocClusterVirtualClusterConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
