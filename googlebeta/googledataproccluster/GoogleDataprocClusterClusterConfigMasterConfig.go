...
type GoogleDataprocClusterClusterConfigMasterConfig struct {
	...
	InstanceFlexibilityPolicy *GoogleDataprocClusterClusterConfigMasterConfigInstanceFlexibilityPolicy `field:"optional" json:"instanceFlexibilityPolicy" yaml:"instanceFlexibilityPolicy"`
