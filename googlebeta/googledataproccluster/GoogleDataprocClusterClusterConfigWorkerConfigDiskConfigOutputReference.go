...
type GoogleDataprocClusterClusterConfigWorkerConfigDiskConfigOutputReference interface {
	cdktn.ComplexObject
	AttachedDiskConfig() GoogleDataprocClusterClusterConfigWorkerConfigDiskConfigAttachedDiskConfigList
...
func (j *jsiiProxy_GoogleDataprocClusterClusterConfigWorkerConfigDiskConfigOutputReference) AttachedDiskConfig() GoogleDataprocClusterClusterConfigWorkerConfigDiskConfigAttachedDiskConfigList {
	var returns GoogleDataprocClusterClusterConfigWorkerConfigDiskConfigAttachedDiskConfigList
	_jsii_.Get(
		j,
		"attachedDiskConfig",
		&returns,
...
func (j *jsiiProxy_GoogleDataprocClusterClusterConfigWorkerConfigDiskConfigOutputReference) AttachedDiskConfigInput() interface{} {
...
func (j *jsiiProxy_GoogleDataprocClusterClusterConfigWorkerConfigDiskConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGoogleDataprocClusterClusterConfigWorkerConfigDiskConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) GoogleDataprocClusterClusterConfigWorkerConfigDiskConfigOutputReference {
	_init_.Initialize()
...
func NewGoogleDataprocClusterClusterConfigWorkerConfigDiskConfigOutputReference_Override(g GoogleDataprocClusterClusterConfigWorkerConfigDiskConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleDataprocClusterClusterConfigWorkerConfigDiskConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleDataprocClusterClusterConfigWorkerConfigDiskConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleDataprocClusterClusterConfigWorkerConfigDiskConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (g *jsiiProxy_GoogleDataprocClusterClusterConfigWorkerConfigDiskConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleDataprocClusterClusterConfigWorkerConfigDiskConfigOutputReference) PutAttachedDiskConfig(value interface{}) {
...
func (g *jsiiProxy_GoogleDataprocClusterClusterConfigWorkerConfigDiskConfigOutputReference) ResetAttachedDiskConfig() {
	_jsii_.InvokeVoid(
		g,
		"resetAttachedDiskConfig",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleDataprocClusterClusterConfigWorkerConfigDiskConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
