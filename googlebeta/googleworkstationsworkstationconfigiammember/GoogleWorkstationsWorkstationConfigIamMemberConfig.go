...
type GoogleWorkstationsWorkstationConfigIamMemberConfig struct {
	// Experimental.
	...
	Condition *GoogleWorkstationsWorkstationConfigIamMemberCondition `field:"optional" json:"condition" yaml:"condition"`
