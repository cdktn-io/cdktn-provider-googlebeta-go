...
func (g *jsiiProxy_GoogleGkeHubFeatureFleetDefaultMemberConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleGkeHubFeatureFleetDefaultMemberConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
