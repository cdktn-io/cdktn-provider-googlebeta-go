...
func (g *jsiiProxy_GoogleGkeHubFeatureSpecRbacrolebindingactuationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleGkeHubFeatureSpecRbacrolebindingactuationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
