...
type GoogleBiglakeIcebergCatalogIamBindingConfig struct {
	// Experimental.
	...
	Condition *GoogleBiglakeIcebergCatalogIamBindingCondition `field:"optional" json:"condition" yaml:"condition"`
