...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.dataGoogleArtifactRegistryNpmPackages.DataGoogleArtifactRegistryNpmPackagesConfig",
		reflect.TypeOf((*DataGoogleArtifactRegistryNpmPackagesConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.dataGoogleArtifactRegistryNpmPackages.DataGoogleArtifactRegistryNpmPackagesNpmPackages",
