...
func (d *jsiiProxy_DataGoogleComputeRegionBackendServiceTlsSettingsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataGoogleComputeRegionBackendServiceTlsSettingsList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_DataGoogleComputeRegionBackendServiceTlsSettingsList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_DataGoogleComputeRegionBackendServiceTlsSettingsList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
