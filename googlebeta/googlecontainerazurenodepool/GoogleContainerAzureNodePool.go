...
func (j *jsiiProxy_GoogleContainerAzureNodePool) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleContainerAzureNodePool) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleContainerAzureNodePool) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleContainerAzureNodePool) EffectiveAnnotations() cdktn.StringMap {
...
func (j *jsiiProxy_GoogleContainerAzureNodePool) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleContainerAzureNodePool) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleContainerAzureNodePool) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleContainerAzureNodePool) Reconciling() cdktn.IResolvable {
...
func (j *jsiiProxy_GoogleContainerAzureNodePool) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleContainerAzureNodePool)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_GoogleContainerAzureNodePool)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleContainerAzureNodePool)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleContainerAzureNodePool)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleContainerAzureNodePool_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleContainerAzureNodePool) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleContainerAzureNodePool) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleContainerAzureNodePool) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleContainerAzureNodePool) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleContainerAzureNodePool) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleContainerAzureNodePool) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleContainerAzureNodePool) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
