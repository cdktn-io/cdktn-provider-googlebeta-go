...
func (d *jsiiProxy_DataGoogleComputeInstanceGroupManagerTargetSizePolicyList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (d *jsiiProxy_DataGoogleComputeInstanceGroupManagerTargetSizePolicyList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataGoogleComputeInstanceGroupManagerTargetSizePolicyList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataGoogleComputeInstanceGroupManagerTargetSizePolicyList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
