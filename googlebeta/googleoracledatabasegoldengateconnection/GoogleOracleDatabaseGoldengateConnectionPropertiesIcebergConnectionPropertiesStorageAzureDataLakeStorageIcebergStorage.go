...
type GoogleOracleDatabaseGoldengateConnectionPropertiesIcebergConnectionPropertiesStorageAzureDataLakeStorageIcebergStorage struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.41.0/docs/resources/google_oracle_database_goldengate_connection#azure_account GoogleOracleDatabaseGoldengateConnection#azure_account}
	AzureAccount *string `field:"required" json:"azureAccount" yaml:"azureAccount"`
	// The container of Azure Data Lake Storage.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.41.0/docs/resources/google_oracle_database_goldengate_connection#container GoogleOracleDatabaseGoldengateConnection#container}
	Container *string `field:"required" json:"container" yaml:"container"`
	// The account key of Azure Data Lake Storage.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.41.0/docs/resources/google_oracle_database_goldengate_connection#account_key_secret GoogleOracleDatabaseGoldengateConnection#account_key_secret}
