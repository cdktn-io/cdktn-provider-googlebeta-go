...
type GoogleOracleDatabaseGoldengateConnectionPropertiesIcebergConnectionPropertiesStorage struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_oracle_database_goldengate_connection#storage_type GoogleOracleDatabaseGoldengateConnection#storage_type}
	StorageType *string `field:"required" json:"storageType" yaml:"storageType"`
	// amazon_s3_iceberg_storage block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_oracle_database_goldengate_connection#amazon_s3_iceberg_storage GoogleOracleDatabaseGoldengateConnection#amazon_s3_iceberg_storage}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_oracle_database_goldengate_connection#azure_data_lake_storage_iceberg_storage GoogleOracleDatabaseGoldengateConnection#azure_data_lake_storage_iceberg_storage}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_oracle_database_goldengate_connection#google_cloud_storage_iceberg_storage GoogleOracleDatabaseGoldengateConnection#google_cloud_storage_iceberg_storage}
