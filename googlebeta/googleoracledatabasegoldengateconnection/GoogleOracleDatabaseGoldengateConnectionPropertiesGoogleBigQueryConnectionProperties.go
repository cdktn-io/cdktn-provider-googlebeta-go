...
type GoogleOracleDatabaseGoldengateConnectionPropertiesGoogleBigQueryConnectionProperties struct {
	// The service account key file Cloud Storage containing the credentials required to use Google BigQuery.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.43.0/docs/resources/google_oracle_database_goldengate_connection#service_account_key_file GoogleOracleDatabaseGoldengateConnection#service_account_key_file}
