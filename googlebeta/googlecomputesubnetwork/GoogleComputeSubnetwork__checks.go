...
func (g *jsiiProxy_GoogleComputeSubnetwork) validatePutSecondaryIpRangeParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleComputeSubnetworkSecondaryIpRange; received %#v (a %T)", value, value)
		}
	}
