...
func (g *jsiiProxy_GoogleComputeSubnetworkLogConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleComputeSubnetworkLogConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
