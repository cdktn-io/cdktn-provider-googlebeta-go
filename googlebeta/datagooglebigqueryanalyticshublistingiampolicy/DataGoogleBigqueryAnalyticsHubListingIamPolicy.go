...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/datagooglebigqueryanalyticshublistingiampolicy/internal"
...
func (j *jsiiProxy_DataGoogleBigqueryAnalyticsHubListingIamPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataGoogleBigqueryAnalyticsHubListingIamPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataGoogleBigqueryAnalyticsHubListingIamPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataGoogleBigqueryAnalyticsHubListingIamPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataGoogleBigqueryAnalyticsHubListingIamPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewDataGoogleBigqueryAnalyticsHubListingIamPolicy(scope constructs.Construct, id *string, config *DataGoogleBigqueryAnalyticsHubListingIamPolicyConfig) DataGoogleBigqueryAnalyticsHubListingIamPolicy {
	...
	_jsii_.Create(
		"@cdktn/provider-google-beta.dataGoogleBigqueryAnalyticsHubListingIamPolicy.DataGoogleBigqueryAnalyticsHubListingIamPolicy",
...
func (j *jsiiProxy_DataGoogleBigqueryAnalyticsHubListingIamPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataGoogleBigqueryAnalyticsHubListingIamPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataGoogleBigqueryAnalyticsHubListingIamPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataGoogleBigqueryAnalyticsHubListingIamPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataGoogleBigqueryAnalyticsHubListingIamPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleBigqueryAnalyticsHubListingIamPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleBigqueryAnalyticsHubListingIamPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataGoogleBigqueryAnalyticsHubListingIamPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
