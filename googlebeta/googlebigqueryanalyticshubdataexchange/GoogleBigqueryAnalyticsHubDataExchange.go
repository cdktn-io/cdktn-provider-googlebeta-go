...
func (j *jsiiProxy_GoogleBigqueryAnalyticsHubDataExchange) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleBigqueryAnalyticsHubDataExchange) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.44.0/docs/resources/google_bigquery_analytics_hub_data_exchange google_bigquery_analytics_hub_data_exchange} Resource.
...
func (j *jsiiProxy_GoogleBigqueryAnalyticsHubDataExchange)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleBigqueryAnalyticsHubDataExchange) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleBigqueryAnalyticsHubDataExchange) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleBigqueryAnalyticsHubDataExchange) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
