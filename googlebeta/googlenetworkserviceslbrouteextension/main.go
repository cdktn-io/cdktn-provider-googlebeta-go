...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "forwardAttributes", GoGetter: "ForwardAttributes"},
			_jsii_.MemberProperty{JsiiProperty: "forwardAttributesInput", GoGetter: "ForwardAttributesInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "name", GoGetter: "Name"},
			_jsii_.MemberProperty{JsiiProperty: "nameInput", GoGetter: "NameInput"},
			_jsii_.MemberProperty{JsiiProperty: "observabilityMode", GoGetter: "ObservabilityMode"},
			_jsii_.MemberProperty{JsiiProperty: "observabilityModeInput", GoGetter: "ObservabilityModeInput"},
			_jsii_.MemberProperty{JsiiProperty: "requestBodySendMode", GoGetter: "RequestBodySendMode"},
			_jsii_.MemberProperty{JsiiProperty: "requestBodySendModeInput", GoGetter: "RequestBodySendModeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetForwardAttributes", GoMethod: "ResetForwardAttributes"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetObservabilityMode", GoMethod: "ResetObservabilityMode"},
			_jsii_.MemberMethod{JsiiMethod: "resetRequestBodySendMode", GoMethod: "ResetRequestBodySendMode"},
