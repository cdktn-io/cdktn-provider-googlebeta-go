...
type GoogleNetworkServicesLbRouteExtensionConfig struct {
	// Experimental.
	...
	Timeouts *GoogleNetworkServicesLbRouteExtensionTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}
