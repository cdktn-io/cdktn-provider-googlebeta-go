...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.googleIapWebForwardingRuleServiceIamBinding.GoogleIapWebForwardingRuleServiceIamBinding",
		reflect.TypeOf((*GoogleIapWebForwardingRuleServiceIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_GoogleIapWebForwardingRuleServiceIamBinding{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnTerraformResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleIapWebForwardingRuleServiceIamBinding.GoogleIapWebForwardingRuleServiceIamBindingCondition",
		reflect.TypeOf((*GoogleIapWebForwardingRuleServiceIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleIapWebForwardingRuleServiceIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleIapWebForwardingRuleServiceIamBinding.GoogleIapWebForwardingRuleServiceIamBindingConfig",
		reflect.TypeOf((*GoogleIapWebForwardingRuleServiceIamBindingConfig)(nil)).Elem(),
	)
}
