...
type GoogleBiglakeTableHiveOptionsStorageDescriptorOutputReference interface {
	...
	SerdeInfo() GoogleBiglakeTableHiveOptionsStorageDescriptorSerdeInfoOutputReference
	SerdeInfoInput() *GoogleBiglakeTableHiveOptionsStorageDescriptorSerdeInfo
	// Experimental.
	...
	PutSerdeInfo(value *GoogleBiglakeTableHiveOptionsStorageDescriptorSerdeInfo)
	ResetInputFormat()
	ResetLocationUri()
	ResetOutputFormat()
	ResetSerdeInfo()
...
func (j *jsiiProxy_GoogleBiglakeTableHiveOptionsStorageDescriptorOutputReference) SerdeInfo() GoogleBiglakeTableHiveOptionsStorageDescriptorSerdeInfoOutputReference {
	var returns GoogleBiglakeTableHiveOptionsStorageDescriptorSerdeInfoOutputReference
	_jsii_.Get(
		j,
		"serdeInfo",
		&returns,
...
func (j *jsiiProxy_GoogleBiglakeTableHiveOptionsStorageDescriptorOutputReference) SerdeInfoInput() *GoogleBiglakeTableHiveOptionsStorageDescriptorSerdeInfo {
...
func (j *jsiiProxy_GoogleBiglakeTableHiveOptionsStorageDescriptorOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGoogleBiglakeTableHiveOptionsStorageDescriptorOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) GoogleBiglakeTableHiveOptionsStorageDescriptorOutputReference {
	_init_.Initialize()
...
func NewGoogleBiglakeTableHiveOptionsStorageDescriptorOutputReference_Override(g GoogleBiglakeTableHiveOptionsStorageDescriptorOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleBiglakeTableHiveOptionsStorageDescriptorOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleBiglakeTableHiveOptionsStorageDescriptorOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleBiglakeTableHiveOptionsStorageDescriptorOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (g *jsiiProxy_GoogleBiglakeTableHiveOptionsStorageDescriptorOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleBiglakeTableHiveOptionsStorageDescriptorOutputReference) PutSerdeInfo(value *GoogleBiglakeTableHiveOptionsStorageDescriptorSerdeInfo) {
...
func (g *jsiiProxy_GoogleBiglakeTableHiveOptionsStorageDescriptorOutputReference) ResetSerdeInfo() {
	_jsii_.InvokeVoid(
		g,
		"resetSerdeInfo",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleBiglakeTableHiveOptionsStorageDescriptorOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
