...
func (g *jsiiProxy_GoogleBiglakeTableHiveOptionsStorageDescriptorOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleBiglakeTableHiveOptionsStorageDescriptorOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
