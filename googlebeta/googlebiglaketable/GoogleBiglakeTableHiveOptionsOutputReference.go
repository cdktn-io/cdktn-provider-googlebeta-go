...
func (g *jsiiProxy_GoogleBiglakeTableHiveOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleBiglakeTableHiveOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
