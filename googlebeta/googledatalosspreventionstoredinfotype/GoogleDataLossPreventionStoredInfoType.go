...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googledatalosspreventionstoredinfotype/internal"
...
func (j *jsiiProxy_GoogleDataLossPreventionStoredInfoType) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleDataLossPreventionStoredInfoType) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleDataLossPreventionStoredInfoType) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleDataLossPreventionStoredInfoType) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleDataLossPreventionStoredInfoType) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_data_loss_prevention_stored_info_type google_data_loss_prevention_stored_info_type} Resource.
...
func (j *jsiiProxy_GoogleDataLossPreventionStoredInfoType)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleDataLossPreventionStoredInfoType)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleDataLossPreventionStoredInfoType)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleDataLossPreventionStoredInfoType_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleDataLossPreventionStoredInfoType) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleDataLossPreventionStoredInfoType) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleDataLossPreventionStoredInfoType) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleDataLossPreventionStoredInfoType) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleDataLossPreventionStoredInfoType) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleDataLossPreventionStoredInfoType) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
