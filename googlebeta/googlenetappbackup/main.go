...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "ontapSource", GoGetter: "OntapSource"},
			_jsii_.MemberProperty{JsiiProperty: "ontapSourceInput", GoGetter: "OntapSourceInput"},
			_jsii_.MemberMethod{JsiiMethod: "overrideLogicalId", GoMethod: "OverrideLogicalId"},
			_jsii_.MemberProperty{JsiiProperty: "project", GoGetter: "Project"},
			_jsii_.MemberProperty{JsiiProperty: "projectInput", GoGetter: "ProjectInput"},
			_jsii_.MemberProperty{JsiiProperty: "provider", GoGetter: "Provider"},
			_jsii_.MemberProperty{JsiiProperty: "provisioners", GoGetter: "Provisioners"},
			_jsii_.MemberMethod{JsiiMethod: "putOntapSource", GoMethod: "PutOntapSource"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetOntapSource", GoMethod: "ResetOntapSource"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleNetappBackup.GoogleNetappBackupOntapSource",
		reflect.TypeOf((*GoogleNetappBackupOntapSource)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.googleNetappBackup.GoogleNetappBackupOntapSourceOutputReference",
		reflect.TypeOf((*GoogleNetappBackupOntapSourceOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetSnapshotUuid", GoMethod: "ResetSnapshotUuid"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "snapshotUuid", GoGetter: "SnapshotUuid"},
			_jsii_.MemberProperty{JsiiProperty: "snapshotUuidInput", GoGetter: "SnapshotUuidInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
			_jsii_.MemberProperty{JsiiProperty: "volumeUuid", GoGetter: "VolumeUuid"},
			_jsii_.MemberProperty{JsiiProperty: "volumeUuidInput", GoGetter: "VolumeUuidInput"},
		},
		func() interface{} {
