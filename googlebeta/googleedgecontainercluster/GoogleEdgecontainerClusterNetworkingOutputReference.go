...
func (g *jsiiProxy_GoogleEdgecontainerClusterNetworkingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleEdgecontainerClusterNetworkingOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
