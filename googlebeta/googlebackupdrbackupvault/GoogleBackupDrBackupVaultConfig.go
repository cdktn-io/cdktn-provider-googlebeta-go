...
type GoogleBackupDrBackupVaultConfig struct {
	// Experimental.
	...
	EncryptionConfig *GoogleBackupDrBackupVaultEncryptionConfig `field:"optional" json:"encryptionConfig" yaml:"encryptionConfig"`
	...
	Timeouts *GoogleBackupDrBackupVaultTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}
