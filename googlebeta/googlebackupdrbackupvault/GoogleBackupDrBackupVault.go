...
func (j *jsiiProxy_GoogleBackupDrBackupVault) ForceUpdateAccessRestriction() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleBackupDrBackupVault) ForceUpdateAccessRestrictionInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.44.0/docs/resources/google_backup_dr_backup_vault google_backup_dr_backup_vault} Resource.
...
func (j *jsiiProxy_GoogleBackupDrBackupVault)SetForceUpdateAccessRestriction(val interface{}) {
...
func (g *jsiiProxy_GoogleBackupDrBackupVault) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleBackupDrBackupVault) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleBackupDrBackupVault) ResetForceUpdateAccessRestriction() {
	_jsii_.InvokeVoid(
		g,
		"resetForceUpdateAccessRestriction",
		nil, // no parameters
