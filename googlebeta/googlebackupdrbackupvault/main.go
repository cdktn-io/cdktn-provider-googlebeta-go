...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "forceUpdateAccessRestriction", GoGetter: "ForceUpdateAccessRestriction"},
			_jsii_.MemberProperty{JsiiProperty: "forceUpdateAccessRestrictionInput", GoGetter: "ForceUpdateAccessRestrictionInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetForceUpdateAccessRestriction", GoMethod: "ResetForceUpdateAccessRestriction"},
