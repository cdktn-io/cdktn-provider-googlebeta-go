...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTargetProxies", GoMethod: "ResetTargetProxies"},
			...
			_jsii_.MemberProperty{JsiiProperty: "targetProxies", GoGetter: "TargetProxies"},
			_jsii_.MemberProperty{JsiiProperty: "targetProxiesInput", GoGetter: "TargetProxiesInput"},
