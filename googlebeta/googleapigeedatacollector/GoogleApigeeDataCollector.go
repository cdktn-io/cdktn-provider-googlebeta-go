...
func (g *jsiiProxy_GoogleApigeeDataCollector) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleApigeeDataCollector) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
