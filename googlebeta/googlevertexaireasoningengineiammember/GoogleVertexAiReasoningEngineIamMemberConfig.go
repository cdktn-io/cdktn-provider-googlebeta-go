...
type GoogleVertexAiReasoningEngineIamMemberConfig struct {
	// Experimental.
	...
	Condition *GoogleVertexAiReasoningEngineIamMemberCondition `field:"optional" json:"condition" yaml:"condition"`
