...
func (g *jsiiProxy_GoogleLookerInstanceDenyMaintenancePeriodStartDateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleLookerInstanceDenyMaintenancePeriodStartDateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
