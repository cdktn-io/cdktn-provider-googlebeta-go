...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleComputeRegionSecurityPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
