...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicy) validatePutRulesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*GoogleComputeRegionSecurityPolicyRules; received %#v (a %T)", value, value)
		}
	}
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicy) validatePutUserDefinedFieldsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*GoogleComputeRegionSecurityPolicyUserDefinedFields; received %#v (a %T)", value, value)
		}
	}
