...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicy) validatePutRulesParameters(value interface{}) error {
	...
	case *[]*GoogleComputeRegionSecurityPolicyRules:
		value := value.(*[]*GoogleComputeRegionSecurityPolicyRules)
	...
	case []*GoogleComputeRegionSecurityPolicyRules:
		value_ := value.([]*GoogleComputeRegionSecurityPolicyRules)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleComputeRegionSecurityPolicyRules; received %#v (a %T)", value, value)
		}
	}
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicy) validatePutUserDefinedFieldsParameters(value interface{}) error {
	...
	case *[]*GoogleComputeRegionSecurityPolicyUserDefinedFields:
		value := value.(*[]*GoogleComputeRegionSecurityPolicyUserDefinedFields)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*GoogleComputeRegionSecurityPolicyUserDefinedFields:
		value_ := value.([]*GoogleComputeRegionSecurityPolicyUserDefinedFields)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleComputeRegionSecurityPolicyUserDefinedFields; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_GoogleComputeRegionSecurityPolicy) validateSetDeletionPolicyParameters(val *string) error {
	if val == nil {
