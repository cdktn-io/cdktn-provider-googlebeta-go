...
func (g *jsiiProxy_GoogleClouddeployTarget) validatePutAssociatedEntitiesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleClouddeployTargetAssociatedEntities; received %#v (a %T)", value, value)
		}
	}
...
func (g *jsiiProxy_GoogleClouddeployTarget) validatePutExecutionConfigsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleClouddeployTargetExecutionConfigs; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_GoogleClouddeployTarget) validateSetDeletionPolicyParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
