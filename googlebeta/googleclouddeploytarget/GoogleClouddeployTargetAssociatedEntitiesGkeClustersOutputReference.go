...
func (j *jsiiProxy_GoogleClouddeployTargetAssociatedEntitiesGkeClustersOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleClouddeployTargetAssociatedEntitiesGkeClustersOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) GoogleClouddeployTargetAssociatedEntitiesGkeClustersOutputReference {
	_init_.Initialize()
...
func NewGoogleClouddeployTargetAssociatedEntitiesGkeClustersOutputReference_Override(g GoogleClouddeployTargetAssociatedEntitiesGkeClustersOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleClouddeployTargetAssociatedEntitiesGkeClustersOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleClouddeployTargetAssociatedEntitiesGkeClustersOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleClouddeployTargetAssociatedEntitiesGkeClustersOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (g *jsiiProxy_GoogleClouddeployTargetAssociatedEntitiesGkeClustersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleClouddeployTargetAssociatedEntitiesGkeClustersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
