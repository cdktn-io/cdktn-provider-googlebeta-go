...
type GoogleClouddeployTargetExecutionConfigs struct {
	...
	DefaultPool *GoogleClouddeployTargetExecutionConfigsDefaultPool `field:"optional" json:"defaultPool" yaml:"defaultPool"`
	// Optional.
	//
	...
	PrivatePool *GoogleClouddeployTargetExecutionConfigsPrivatePool `field:"optional" json:"privatePool" yaml:"privatePool"`
