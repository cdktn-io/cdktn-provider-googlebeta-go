...
func (g *jsiiProxy_GoogleSpannerInstanceAutoscalingConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleSpannerInstanceAutoscalingConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
