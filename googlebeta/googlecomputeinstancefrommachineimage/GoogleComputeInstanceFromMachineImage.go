...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.44.0/docs/resources/google_compute_instance_from_machine_image google_compute_instance_from_machine_image}.
...
func (j *jsiiProxy_GoogleComputeInstanceFromMachineImage) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleComputeInstanceFromMachineImage) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleComputeInstanceFromMachineImage) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleComputeInstanceFromMachineImage) EffectiveLabels() cdktn.StringMap {
...
func (j *jsiiProxy_GoogleComputeInstanceFromMachineImage) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleComputeInstanceFromMachineImage) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleComputeInstanceFromMachineImage) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleComputeInstanceFromMachineImage) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleComputeInstanceFromMachineImage) TerraformLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.44.0/docs/resources/google_compute_instance_from_machine_image google_compute_instance_from_machine_image} Resource.
...
func (j *jsiiProxy_GoogleComputeInstanceFromMachineImage)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_GoogleComputeInstanceFromMachineImage)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleComputeInstanceFromMachineImage)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleComputeInstanceFromMachineImage)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a GoogleComputeInstanceFromMachineImage resource upon running "cdktn plan <stack-name>".
func GoogleComputeInstanceFromMachineImage_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleComputeInstanceFromMachineImage) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleComputeInstanceFromMachineImage) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleComputeInstanceFromMachineImage) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleComputeInstanceFromMachineImage) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleComputeInstanceFromMachineImage) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleComputeInstanceFromMachineImage) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleComputeInstanceFromMachineImage) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
