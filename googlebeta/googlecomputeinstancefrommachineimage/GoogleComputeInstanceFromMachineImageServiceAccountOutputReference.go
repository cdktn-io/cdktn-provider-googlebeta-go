...
func (g *jsiiProxy_GoogleComputeInstanceFromMachineImageServiceAccountOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleComputeInstanceFromMachineImageServiceAccountOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
