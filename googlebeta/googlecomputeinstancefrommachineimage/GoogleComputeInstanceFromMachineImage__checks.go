...
func (g *jsiiProxy_GoogleComputeInstanceFromMachineImage) validatePutGuestAcceleratorParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleComputeInstanceFromMachineImageGuestAccelerator; received %#v (a %T)", value, value)
		}
	}
...
func (g *jsiiProxy_GoogleComputeInstanceFromMachineImage) validatePutNetworkInterfaceParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleComputeInstanceFromMachineImageNetworkInterface; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_GoogleComputeInstanceFromMachineImage) validateSetDeletionPolicyParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
