...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.44.0/docs/resources/google_discovery_engine_target_site google_discovery_engine_target_site} Resource.
...
func (g *jsiiProxy_GoogleDiscoveryEngineTargetSite) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleDiscoveryEngineTargetSite) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleDiscoveryEngineTargetSite) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
