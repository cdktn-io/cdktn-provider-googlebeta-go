...
func (g *jsiiProxy_GoogleNetappVolumeTieringPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleNetappVolumeTieringPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
