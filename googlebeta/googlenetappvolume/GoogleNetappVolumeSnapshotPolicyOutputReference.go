...
func (g *jsiiProxy_GoogleNetappVolumeSnapshotPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleNetappVolumeSnapshotPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
