...
func (g *jsiiProxy_GoogleNetappVolumeSnapshotPolicyDailyScheduleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleNetappVolumeSnapshotPolicyDailyScheduleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
