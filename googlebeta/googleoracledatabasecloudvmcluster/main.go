...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleOracleDatabaseCloudVmCluster.GoogleOracleDatabaseCloudVmClusterIdentityConnector",
		reflect.TypeOf((*GoogleOracleDatabaseCloudVmClusterIdentityConnector)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.googleOracleDatabaseCloudVmCluster.GoogleOracleDatabaseCloudVmClusterIdentityConnectorList",
		reflect.TypeOf((*GoogleOracleDatabaseCloudVmClusterIdentityConnectorList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleOracleDatabaseCloudVmClusterIdentityConnectorOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
