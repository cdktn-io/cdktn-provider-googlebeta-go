...
func (j *jsiiProxy_GoogleIdentityPlatformConfig) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleIdentityPlatformConfig) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleIdentityPlatformConfig) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleIdentityPlatformConfig) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleIdentityPlatformConfig) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.1/docs/resources/google_identity_platform_config google_identity_platform_config} Resource.
...
func (j *jsiiProxy_GoogleIdentityPlatformConfig)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleIdentityPlatformConfig)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleIdentityPlatformConfig)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleIdentityPlatformConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleIdentityPlatformConfig) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleIdentityPlatformConfig) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleIdentityPlatformConfig) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleIdentityPlatformConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleIdentityPlatformConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleIdentityPlatformConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
