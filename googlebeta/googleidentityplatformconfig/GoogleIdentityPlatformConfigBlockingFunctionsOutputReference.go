...
func (g *jsiiProxy_GoogleIdentityPlatformConfigBlockingFunctionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleIdentityPlatformConfigBlockingFunctionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
