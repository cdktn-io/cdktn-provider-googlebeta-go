...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleTagsTagValueIamBinding.GoogleTagsTagValueIamBindingCondition",
		reflect.TypeOf((*GoogleTagsTagValueIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.googleTagsTagValueIamBinding.GoogleTagsTagValueIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleTagsTagValueIamBinding.GoogleTagsTagValueIamBindingConfig",
