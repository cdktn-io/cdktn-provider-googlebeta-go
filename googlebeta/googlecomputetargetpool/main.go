...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleComputeTargetPool.GoogleComputeTargetPoolConfig",
		reflect.TypeOf((*GoogleComputeTargetPoolConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleComputeTargetPool.GoogleComputeTargetPoolTimeouts",
