...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.43.0/docs/resources/google_compute_target_pool google_compute_target_pool}.
...
func (j *jsiiProxy_GoogleComputeTargetPool) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleComputeTargetPool) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.43.0/docs/resources/google_compute_target_pool google_compute_target_pool} Resource.
...
func (j *jsiiProxy_GoogleComputeTargetPool)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleComputeTargetPool) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleComputeTargetPool) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleComputeTargetPool) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleComputeTargetPool) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
