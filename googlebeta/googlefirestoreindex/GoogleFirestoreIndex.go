...
func (j *jsiiProxy_GoogleFirestoreIndex) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleFirestoreIndex) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleFirestoreIndex) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleFirestoreIndex) Provider() cdktn.TerraformProvider {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.1/docs/resources/google_firestore_index google_firestore_index} Resource.
...
func (j *jsiiProxy_GoogleFirestoreIndex)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleFirestoreIndex)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleFirestoreIndex)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleFirestoreIndex_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleFirestoreIndex) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleFirestoreIndex) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleFirestoreIndex) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleFirestoreIndex) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleFirestoreIndex) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleFirestoreIndex) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
