...
func (j *jsiiProxy_GoogleFirestoreIndexFieldsOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGoogleFirestoreIndexFieldsOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) GoogleFirestoreIndexFieldsOutputReference {
	_init_.Initialize()
...
func NewGoogleFirestoreIndexFieldsOutputReference_Override(g GoogleFirestoreIndexFieldsOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleFirestoreIndexFieldsOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleFirestoreIndexFieldsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleFirestoreIndexFieldsOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (g *jsiiProxy_GoogleFirestoreIndexFieldsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleFirestoreIndexFieldsOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
