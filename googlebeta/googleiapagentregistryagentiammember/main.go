...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleIapAgentRegistryAgentIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleIapAgentRegistryAgentIamMember.GoogleIapAgentRegistryAgentIamMemberCondition",
		reflect.TypeOf((*GoogleIapAgentRegistryAgentIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleIapAgentRegistryAgentIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleIapAgentRegistryAgentIamMember.GoogleIapAgentRegistryAgentIamMemberConfig",
		reflect.TypeOf((*GoogleIapAgentRegistryAgentIamMemberConfig)(nil)).Elem(),
	)
}
