...
func (j *jsiiProxy_GoogleDataflowJob) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleDataflowJob) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.37.0/docs/resources/google_dataflow_job google_dataflow_job} Resource.
...
func (j *jsiiProxy_GoogleDataflowJob)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleDataflowJob) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
