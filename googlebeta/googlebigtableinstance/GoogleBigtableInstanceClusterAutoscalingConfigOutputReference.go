...
func (g *jsiiProxy_GoogleBigtableInstanceClusterAutoscalingConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleBigtableInstanceClusterAutoscalingConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
