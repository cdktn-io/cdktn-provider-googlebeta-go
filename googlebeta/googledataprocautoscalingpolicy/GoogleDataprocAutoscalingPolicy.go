...
func (j *jsiiProxy_GoogleDataprocAutoscalingPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleDataprocAutoscalingPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleDataprocAutoscalingPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleDataprocAutoscalingPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleDataprocAutoscalingPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleDataprocAutoscalingPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleDataprocAutoscalingPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleDataprocAutoscalingPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleDataprocAutoscalingPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleDataprocAutoscalingPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleDataprocAutoscalingPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleDataprocAutoscalingPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleDataprocAutoscalingPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleDataprocAutoscalingPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleDataprocAutoscalingPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
