...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_gkeonprem_bare_metal_cluster google_gkeonprem_bare_metal_cluster}.
...
func (j *jsiiProxy_GoogleGkeonpremBareMetalCluster) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleGkeonpremBareMetalCluster) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_gkeonprem_bare_metal_cluster google_gkeonprem_bare_metal_cluster} Resource.
...
func (j *jsiiProxy_GoogleGkeonpremBareMetalCluster)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleGkeonpremBareMetalCluster) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleGkeonpremBareMetalCluster) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleGkeonpremBareMetalCluster) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleGkeonpremBareMetalCluster) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
