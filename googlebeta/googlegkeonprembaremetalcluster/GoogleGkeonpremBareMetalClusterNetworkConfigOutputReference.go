...
func (g *jsiiProxy_GoogleGkeonpremBareMetalClusterNetworkConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleGkeonpremBareMetalClusterNetworkConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
