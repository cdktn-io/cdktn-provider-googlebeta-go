...
func (g *jsiiProxy_GoogleComputeServiceAttachment) validatePutConsumerAcceptListsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleComputeServiceAttachmentConsumerAcceptLists; received %#v (a %T)", value, value)
		}
	}
