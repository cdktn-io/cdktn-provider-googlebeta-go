...
func (j *jsiiProxy_GoogleRedisClusterUserCreatedConnections) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleRedisClusterUserCreatedConnections) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleRedisClusterUserCreatedConnections)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleRedisClusterUserCreatedConnections) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleRedisClusterUserCreatedConnections) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleRedisClusterUserCreatedConnections) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleRedisClusterUserCreatedConnections) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
