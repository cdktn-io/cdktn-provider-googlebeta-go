...
func (g *jsiiProxy_GoogleCloudIdentityGroupMembership) validatePutRolesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleCloudIdentityGroupMembershipRoles; received %#v (a %T)", value, value)
		}
	}
