...
func (j *jsiiProxy_GoogleCloudIdentityGroupMembership) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleCloudIdentityGroupMembership) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleCloudIdentityGroupMembership)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleCloudIdentityGroupMembership) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleCloudIdentityGroupMembership) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleCloudIdentityGroupMembership) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleCloudIdentityGroupMembership) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
