...
func (j *jsiiProxy_GoogleDeveloperConnectInsightsConfigArtifactConfigsOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleDeveloperConnectInsightsConfigArtifactConfigsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) GoogleDeveloperConnectInsightsConfigArtifactConfigsOutputReference {
	_init_.Initialize()
...
func NewGoogleDeveloperConnectInsightsConfigArtifactConfigsOutputReference_Override(g GoogleDeveloperConnectInsightsConfigArtifactConfigsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleDeveloperConnectInsightsConfigArtifactConfigsOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleDeveloperConnectInsightsConfigArtifactConfigsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDeveloperConnectInsightsConfigArtifactConfigsOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (g *jsiiProxy_GoogleDeveloperConnectInsightsConfigArtifactConfigsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDeveloperConnectInsightsConfigArtifactConfigsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
