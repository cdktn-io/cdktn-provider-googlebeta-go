...
func (j *jsiiProxy_DataGoogleKmsCryptoKeyVersionsVersionsPublicKeyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleKmsCryptoKeyVersionsVersionsPublicKeyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleKmsCryptoKeyVersionsVersionsPublicKeyList {
	_init_.Initialize()
...
func NewDataGoogleKmsCryptoKeyVersionsVersionsPublicKeyList_Override(d DataGoogleKmsCryptoKeyVersionsVersionsPublicKeyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleKmsCryptoKeyVersionsVersionsPublicKeyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleKmsCryptoKeyVersionsVersionsPublicKeyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleKmsCryptoKeyVersionsVersionsPublicKeyList) Resolve(context cdktn.IResolveContext) interface{} {
