...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_DataGoogleCloudRunV2Job) Tags() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"tags",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.43.0/docs/data-sources/google_cloud_run_v2_job google_cloud_run_v2_job} Data Source.
