...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googlehealthcarehl7v2storeiammember/internal"
...
func (j *jsiiProxy_GoogleHealthcareHl7V2StoreIamMember) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleHealthcareHl7V2StoreIamMember) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleHealthcareHl7V2StoreIamMember) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleHealthcareHl7V2StoreIamMember) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleHealthcareHl7V2StoreIamMember) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.45.0/docs/resources/google_healthcare_hl7_v2_store_iam_member google_healthcare_hl7_v2_store_iam_member} Resource.
...
func (j *jsiiProxy_GoogleHealthcareHl7V2StoreIamMember)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleHealthcareHl7V2StoreIamMember)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleHealthcareHl7V2StoreIamMember)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleHealthcareHl7V2StoreIamMember_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleHealthcareHl7V2StoreIamMember) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleHealthcareHl7V2StoreIamMember) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleHealthcareHl7V2StoreIamMember) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleHealthcareHl7V2StoreIamMember) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleHealthcareHl7V2StoreIamMember) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleHealthcareHl7V2StoreIamMember) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
