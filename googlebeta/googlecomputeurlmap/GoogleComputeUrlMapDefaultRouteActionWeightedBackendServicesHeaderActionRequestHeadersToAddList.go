...
func (g *jsiiProxy_GoogleComputeUrlMapDefaultRouteActionWeightedBackendServicesHeaderActionRequestHeadersToAddList) Resolve(context cdktf.IResolveContext) interface{} {
