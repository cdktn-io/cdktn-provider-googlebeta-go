...
func (j *jsiiProxy_GoogleComputeUrlMap) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleComputeUrlMap) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleComputeUrlMap) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleComputeUrlMap) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleComputeUrlMap) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleComputeUrlMap)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleComputeUrlMap)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleComputeUrlMap)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleComputeUrlMap_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleComputeUrlMap) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleComputeUrlMap) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleComputeUrlMap) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleComputeUrlMap) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleComputeUrlMap) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleComputeUrlMap) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
