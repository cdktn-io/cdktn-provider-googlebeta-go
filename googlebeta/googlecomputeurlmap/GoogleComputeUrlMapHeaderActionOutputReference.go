...
func (g *jsiiProxy_GoogleComputeUrlMapHeaderActionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleComputeUrlMapHeaderActionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
