...
type GoogleComputeUrlMapDefaultRouteActionCachePolicyNegativeCachingPolicy struct {
	...
	Ttl *GoogleComputeUrlMapDefaultRouteActionCachePolicyNegativeCachingPolicyTtl `field:"optional" json:"ttl" yaml:"ttl"`
}
