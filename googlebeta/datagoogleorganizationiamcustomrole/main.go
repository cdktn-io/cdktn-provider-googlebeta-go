...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.dataGoogleOrganizationIamCustomRole.DataGoogleOrganizationIamCustomRole",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.dataGoogleOrganizationIamCustomRole.DataGoogleOrganizationIamCustomRoleConfig",
