...
func (g *jsiiProxy_GoogleDialogflowCxGenerativeSettingsGenerativeSafetySettingsBannedPhrasesList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
