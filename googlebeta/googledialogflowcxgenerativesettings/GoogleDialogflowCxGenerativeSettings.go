...
func (j *jsiiProxy_GoogleDialogflowCxGenerativeSettings) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleDialogflowCxGenerativeSettings) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleDialogflowCxGenerativeSettings) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleDialogflowCxGenerativeSettings) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleDialogflowCxGenerativeSettings) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleDialogflowCxGenerativeSettings)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleDialogflowCxGenerativeSettings)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleDialogflowCxGenerativeSettings)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleDialogflowCxGenerativeSettings_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleDialogflowCxGenerativeSettings) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleDialogflowCxGenerativeSettings) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleDialogflowCxGenerativeSettings) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleDialogflowCxGenerativeSettings) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleDialogflowCxGenerativeSettings) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleDialogflowCxGenerativeSettings) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
