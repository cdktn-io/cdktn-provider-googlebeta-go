...
func (j *jsiiProxy_GoogleCesAgentAfterAgentCallbacksList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGoogleCesAgentAfterAgentCallbacksList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleCesAgentAfterAgentCallbacksList {
	_init_.Initialize()
...
func NewGoogleCesAgentAfterAgentCallbacksList_Override(g GoogleCesAgentAfterAgentCallbacksList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleCesAgentAfterAgentCallbacksList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleCesAgentAfterAgentCallbacksList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleCesAgentAfterAgentCallbacksList) Resolve(context cdktn.IResolveContext) interface{} {
