...
func (j *jsiiProxy_GoogleCesAppVersionSnapshotToolsDataStoreToolModalityConfigsSummarizationConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGoogleCesAppVersionSnapshotToolsDataStoreToolModalityConfigsSummarizationConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleCesAppVersionSnapshotToolsDataStoreToolModalityConfigsSummarizationConfigList {
	_init_.Initialize()
...
func NewGoogleCesAppVersionSnapshotToolsDataStoreToolModalityConfigsSummarizationConfigList_Override(g GoogleCesAppVersionSnapshotToolsDataStoreToolModalityConfigsSummarizationConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleCesAppVersionSnapshotToolsDataStoreToolModalityConfigsSummarizationConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleCesAppVersionSnapshotToolsDataStoreToolModalityConfigsSummarizationConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleCesAppVersionSnapshotToolsDataStoreToolModalityConfigsSummarizationConfigList) Resolve(context cdktn.IResolveContext) interface{} {
