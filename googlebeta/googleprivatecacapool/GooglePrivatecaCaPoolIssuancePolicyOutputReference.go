...
func (g *jsiiProxy_GooglePrivatecaCaPoolIssuancePolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GooglePrivatecaCaPoolIssuancePolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
