...
func (j *jsiiProxy_GoogleKmsCryptoKeyVersionAttestationCertChainsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGoogleKmsCryptoKeyVersionAttestationCertChainsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleKmsCryptoKeyVersionAttestationCertChainsList {
	_init_.Initialize()
...
func NewGoogleKmsCryptoKeyVersionAttestationCertChainsList_Override(g GoogleKmsCryptoKeyVersionAttestationCertChainsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleKmsCryptoKeyVersionAttestationCertChainsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleKmsCryptoKeyVersionAttestationCertChainsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleKmsCryptoKeyVersionAttestationCertChainsList) Resolve(context cdktn.IResolveContext) interface{} {
