...
func (j *jsiiProxy_GoogleKmsCryptoKeyVersionAttestationExternalProtectionLevelOptionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGoogleKmsCryptoKeyVersionAttestationExternalProtectionLevelOptionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleKmsCryptoKeyVersionAttestationExternalProtectionLevelOptionsList {
	_init_.Initialize()
...
func NewGoogleKmsCryptoKeyVersionAttestationExternalProtectionLevelOptionsList_Override(g GoogleKmsCryptoKeyVersionAttestationExternalProtectionLevelOptionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleKmsCryptoKeyVersionAttestationExternalProtectionLevelOptionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleKmsCryptoKeyVersionAttestationExternalProtectionLevelOptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleKmsCryptoKeyVersionAttestationExternalProtectionLevelOptionsList) Resolve(context cdktn.IResolveContext) interface{} {
