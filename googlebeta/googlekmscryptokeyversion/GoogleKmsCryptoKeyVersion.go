...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googlekmscryptokeyversion/internal"
...
func (j *jsiiProxy_GoogleKmsCryptoKeyVersion) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleKmsCryptoKeyVersion) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleKmsCryptoKeyVersion) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleKmsCryptoKeyVersion) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleKmsCryptoKeyVersion) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.43.0/docs/resources/google_kms_crypto_key_version google_kms_crypto_key_version} Resource.
...
func (j *jsiiProxy_GoogleKmsCryptoKeyVersion)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleKmsCryptoKeyVersion)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleKmsCryptoKeyVersion)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleKmsCryptoKeyVersion_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleKmsCryptoKeyVersion) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleKmsCryptoKeyVersion) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleKmsCryptoKeyVersion) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleKmsCryptoKeyVersion) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleKmsCryptoKeyVersion) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleKmsCryptoKeyVersion) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
