...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.googleBigqueryDatapolicyv2DataPolicyIamBinding.GoogleBigqueryDatapolicyv2DataPolicyIamBinding",
		reflect.TypeOf((*GoogleBigqueryDatapolicyv2DataPolicyIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_GoogleBigqueryDatapolicyv2DataPolicyIamBinding{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnTerraformResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleBigqueryDatapolicyv2DataPolicyIamBinding.GoogleBigqueryDatapolicyv2DataPolicyIamBindingCondition",
		reflect.TypeOf((*GoogleBigqueryDatapolicyv2DataPolicyIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleBigqueryDatapolicyv2DataPolicyIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleBigqueryDatapolicyv2DataPolicyIamBinding.GoogleBigqueryDatapolicyv2DataPolicyIamBindingConfig",
		reflect.TypeOf((*GoogleBigqueryDatapolicyv2DataPolicyIamBindingConfig)(nil)).Elem(),
	)
}
