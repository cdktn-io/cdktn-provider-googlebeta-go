...
func (g *jsiiProxy_GoogleFolderAccessApprovalSettings) validatePutEnrolledServicesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleFolderAccessApprovalSettingsEnrolledServices; received %#v (a %T)", value, value)
		}
	}
