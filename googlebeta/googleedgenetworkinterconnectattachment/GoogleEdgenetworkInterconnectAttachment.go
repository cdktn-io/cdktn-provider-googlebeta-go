...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googleedgenetworkinterconnectattachment/internal"
...
func (j *jsiiProxy_GoogleEdgenetworkInterconnectAttachment) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleEdgenetworkInterconnectAttachment) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.1/docs/resources/google_edgenetwork_interconnect_attachment google_edgenetwork_interconnect_attachment} Resource.
...
func (j *jsiiProxy_GoogleEdgenetworkInterconnectAttachment)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleEdgenetworkInterconnectAttachment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleEdgenetworkInterconnectAttachment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleEdgenetworkInterconnectAttachment) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleEdgenetworkInterconnectAttachment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
