...
func (g *jsiiProxy_GoogleHypercomputeclusterClusterOrchestratorSlurmPartitionsList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_GoogleHypercomputeclusterClusterOrchestratorSlurmPartitionsList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewGoogleHypercomputeclusterClusterOrchestratorSlurmPartitionsListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
