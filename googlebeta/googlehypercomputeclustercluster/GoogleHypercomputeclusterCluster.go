...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.44.0/docs/resources/google_hypercomputecluster_cluster google_hypercomputecluster_cluster}.
...
func (j *jsiiProxy_GoogleHypercomputeclusterCluster) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleHypercomputeclusterCluster) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.44.0/docs/resources/google_hypercomputecluster_cluster google_hypercomputecluster_cluster} Resource.
...
func (j *jsiiProxy_GoogleHypercomputeclusterCluster)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleHypercomputeclusterCluster) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleHypercomputeclusterCluster) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleHypercomputeclusterCluster) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
