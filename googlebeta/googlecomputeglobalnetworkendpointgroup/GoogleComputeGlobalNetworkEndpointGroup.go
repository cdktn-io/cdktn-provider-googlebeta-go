...
func (g *jsiiProxy_GoogleComputeGlobalNetworkEndpointGroup) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleComputeGlobalNetworkEndpointGroup) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleComputeGlobalNetworkEndpointGroup) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
