...
func (g *jsiiProxy_GoogleCloudbuildTrigger) validatePutBitbucketServerTriggerConfigParameters(value *GoogleCloudbuildTriggerBitbucketServerTriggerConfig) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(value, func() string { return "parameter value" }); err != nil {
...
func (g *jsiiProxy_GoogleCloudbuildTrigger) validatePutRepositoryEventConfigParameters(value *GoogleCloudbuildTriggerRepositoryEventConfig) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(value, func() string { return "parameter value" }); err != nil {
...
func (j *jsiiProxy_GoogleCloudbuildTrigger) validateSetDeletionPolicyParameters(val *string) error {
	if val == nil {
