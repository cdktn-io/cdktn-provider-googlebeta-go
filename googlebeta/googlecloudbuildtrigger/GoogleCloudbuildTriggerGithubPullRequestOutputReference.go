...
func (g *jsiiProxy_GoogleCloudbuildTriggerGithubPullRequestOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleCloudbuildTriggerGithubPullRequestOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
