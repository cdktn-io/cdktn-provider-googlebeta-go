...
func (g *jsiiProxy_GoogleCloudbuildTriggerBuildSourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleCloudbuildTriggerBuildSourceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
