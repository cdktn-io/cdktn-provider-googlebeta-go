...
func (g *jsiiProxy_GoogleCloudbuildTriggerBuildArtifactsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleCloudbuildTriggerBuildArtifactsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
