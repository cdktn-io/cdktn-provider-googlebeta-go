...
func (g *jsiiProxy_GoogleCloudbuildTriggerGithubOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleCloudbuildTriggerGithubOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
