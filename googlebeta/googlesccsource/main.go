...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.googleSccSource.GoogleSccSource",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleSccSource.GoogleSccSourceConfig",
		reflect.TypeOf((*GoogleSccSourceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleSccSource.GoogleSccSourceTimeouts",
