...
type GoogleCesGuardrailLlmPromptSecurityCustomPolicy struct {
	...
	ModelSettings *GoogleCesGuardrailLlmPromptSecurityCustomPolicyModelSettings `field:"optional" json:"modelSettings" yaml:"modelSettings"`
}
