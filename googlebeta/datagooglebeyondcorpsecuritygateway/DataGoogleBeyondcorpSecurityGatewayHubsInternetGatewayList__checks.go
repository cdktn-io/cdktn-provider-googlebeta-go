...
func (d *jsiiProxy_DataGoogleBeyondcorpSecurityGatewayHubsInternetGatewayList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_DataGoogleBeyondcorpSecurityGatewayHubsInternetGatewayList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewDataGoogleBeyondcorpSecurityGatewayHubsInternetGatewayListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
