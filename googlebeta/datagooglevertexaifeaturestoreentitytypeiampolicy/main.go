...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataGoogleVertexAiFeaturestoreEntitytypeIamPolicy)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.dataGoogleVertexAiFeaturestoreEntitytypeIamPolicy.DataGoogleVertexAiFeaturestoreEntitytypeIamPolicyConfig",
		reflect.TypeOf((*DataGoogleVertexAiFeaturestoreEntitytypeIamPolicyConfig)(nil)).Elem(),
	)
}
