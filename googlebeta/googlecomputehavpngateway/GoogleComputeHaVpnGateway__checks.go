...
func (g *jsiiProxy_GoogleComputeHaVpnGateway) validatePutParamsParameters(value *GoogleComputeHaVpnGatewayParams) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
...
func (g *jsiiProxy_GoogleComputeHaVpnGateway) validatePutVpnInterfacesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleComputeHaVpnGatewayVpnInterfaces; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_GoogleComputeHaVpnGateway) validateSetDeletionPolicyParameters(val *string) error {
	if val == nil {
