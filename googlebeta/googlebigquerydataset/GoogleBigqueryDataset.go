...
func (j *jsiiProxy_GoogleBigqueryDataset) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleBigqueryDataset) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleBigqueryDataset) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleBigqueryDataset) EffectiveLabels() cdktn.StringMap {
...
func (j *jsiiProxy_GoogleBigqueryDataset) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleBigqueryDataset) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleBigqueryDataset) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleBigqueryDataset) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleBigqueryDataset) TerraformLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
func (j *jsiiProxy_GoogleBigqueryDataset)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_GoogleBigqueryDataset)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleBigqueryDataset)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleBigqueryDataset)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleBigqueryDataset_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleBigqueryDataset) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleBigqueryDataset) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleBigqueryDataset) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleBigqueryDataset) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleBigqueryDataset) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleBigqueryDataset) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleBigqueryDataset) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
