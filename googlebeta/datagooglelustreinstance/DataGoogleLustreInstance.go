...
func (j *jsiiProxy_DataGoogleLustreInstance) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.44.0/docs/data-sources/google_lustre_instance google_lustre_instance} Data Source.
