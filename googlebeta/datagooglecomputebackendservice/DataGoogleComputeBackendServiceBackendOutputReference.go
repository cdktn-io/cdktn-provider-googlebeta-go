...
func (j *jsiiProxy_DataGoogleComputeBackendServiceBackendOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleComputeBackendServiceBackendOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataGoogleComputeBackendServiceBackendOutputReference {
	_init_.Initialize()
...
func NewDataGoogleComputeBackendServiceBackendOutputReference_Override(d DataGoogleComputeBackendServiceBackendOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComputeBackendServiceBackendOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComputeBackendServiceBackendOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleComputeBackendServiceBackendOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataGoogleComputeBackendServiceBackendOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleComputeBackendServiceBackendOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
