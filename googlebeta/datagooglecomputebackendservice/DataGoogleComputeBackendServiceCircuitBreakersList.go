...
func (j *jsiiProxy_DataGoogleComputeBackendServiceCircuitBreakersList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleComputeBackendServiceCircuitBreakersList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleComputeBackendServiceCircuitBreakersList {
	_init_.Initialize()
...
func NewDataGoogleComputeBackendServiceCircuitBreakersList_Override(d DataGoogleComputeBackendServiceCircuitBreakersList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComputeBackendServiceCircuitBreakersList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComputeBackendServiceCircuitBreakersList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComputeBackendServiceCircuitBreakersList) Resolve(context cdktn.IResolveContext) interface{} {
