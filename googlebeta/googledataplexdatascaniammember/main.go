...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleDataplexDatascanIamMember.GoogleDataplexDatascanIamMemberCondition",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleDataplexDatascanIamMember.GoogleDataplexDatascanIamMemberConfig",
