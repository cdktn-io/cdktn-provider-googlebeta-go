...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v19/datagooglebeyondcorpappconnection/internal"
...
func (j *jsiiProxy_DataGoogleBeyondcorpAppConnectionGatewayList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleBeyondcorpAppConnectionGatewayList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleBeyondcorpAppConnectionGatewayList {
	_init_.Initialize()
...
func NewDataGoogleBeyondcorpAppConnectionGatewayList_Override(d DataGoogleBeyondcorpAppConnectionGatewayList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleBeyondcorpAppConnectionGatewayList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleBeyondcorpAppConnectionGatewayList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleBeyondcorpAppConnectionGatewayList) Resolve(context cdktn.IResolveContext) interface{} {
