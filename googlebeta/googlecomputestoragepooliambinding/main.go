...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleComputeStoragePoolIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleComputeStoragePoolIamBinding.GoogleComputeStoragePoolIamBindingCondition",
		reflect.TypeOf((*GoogleComputeStoragePoolIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.googleComputeStoragePoolIamBinding.GoogleComputeStoragePoolIamBindingConditionOutputReference",
		reflect.TypeOf((*GoogleComputeStoragePoolIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleComputeStoragePoolIamBinding.GoogleComputeStoragePoolIamBindingConfig",
		reflect.TypeOf((*GoogleComputeStoragePoolIamBindingConfig)(nil)).Elem(),
	)
}
