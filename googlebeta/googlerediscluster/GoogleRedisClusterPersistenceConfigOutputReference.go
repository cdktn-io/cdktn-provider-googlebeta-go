...
func (g *jsiiProxy_GoogleRedisClusterPersistenceConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleRedisClusterPersistenceConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
