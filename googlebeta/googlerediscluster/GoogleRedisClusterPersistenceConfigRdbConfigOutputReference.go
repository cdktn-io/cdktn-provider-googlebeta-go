...
func (g *jsiiProxy_GoogleRedisClusterPersistenceConfigRdbConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleRedisClusterPersistenceConfigRdbConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
