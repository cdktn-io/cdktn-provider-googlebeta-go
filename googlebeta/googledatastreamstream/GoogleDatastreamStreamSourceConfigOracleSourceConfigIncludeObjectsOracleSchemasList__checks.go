...
func (g *jsiiProxy_GoogleDatastreamStreamSourceConfigOracleSourceConfigIncludeObjectsOracleSchemasList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
