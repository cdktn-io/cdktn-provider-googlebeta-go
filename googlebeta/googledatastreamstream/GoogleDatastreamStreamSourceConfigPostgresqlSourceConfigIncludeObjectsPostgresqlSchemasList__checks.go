...
func (g *jsiiProxy_GoogleDatastreamStreamSourceConfigPostgresqlSourceConfigIncludeObjectsPostgresqlSchemasList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
