...
func (g *jsiiProxy_GoogleDatastreamStreamBackfillAllOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDatastreamStreamBackfillAllOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
