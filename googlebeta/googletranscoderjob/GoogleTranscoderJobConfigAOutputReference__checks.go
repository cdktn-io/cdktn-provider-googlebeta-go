...
func (g *jsiiProxy_GoogleTranscoderJobConfigAOutputReference) validatePutAdBreaksParameters(value interface{}) error {
	...
	case []*GoogleTranscoderJobConfigAdBreaks:
		value_ := value.([]*GoogleTranscoderJobConfigAdBreaks)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
...
func (g *jsiiProxy_GoogleTranscoderJobConfigAOutputReference) validatePutEditListParameters(value interface{}) error {
	...
	case []*GoogleTranscoderJobConfigEditListStruct:
		value_ := value.([]*GoogleTranscoderJobConfigEditListStruct)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
...
func (g *jsiiProxy_GoogleTranscoderJobConfigAOutputReference) validatePutElementaryStreamsParameters(value interface{}) error {
	...
	case []*GoogleTranscoderJobConfigElementaryStreams:
		value_ := value.([]*GoogleTranscoderJobConfigElementaryStreams)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
...
func (g *jsiiProxy_GoogleTranscoderJobConfigAOutputReference) validatePutEncryptionsParameters(value interface{}) error {
	...
	case []*GoogleTranscoderJobConfigEncryptions:
		value_ := value.([]*GoogleTranscoderJobConfigEncryptions)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
...
func (g *jsiiProxy_GoogleTranscoderJobConfigAOutputReference) validatePutInputsParameters(value interface{}) error {
	...
	case []*GoogleTranscoderJobConfigInputs:
		value_ := value.([]*GoogleTranscoderJobConfigInputs)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
...
func (g *jsiiProxy_GoogleTranscoderJobConfigAOutputReference) validatePutManifestsParameters(value interface{}) error {
	...
	case []*GoogleTranscoderJobConfigManifests:
		value_ := value.([]*GoogleTranscoderJobConfigManifests)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
...
func (g *jsiiProxy_GoogleTranscoderJobConfigAOutputReference) validatePutMuxStreamsParameters(value interface{}) error {
	...
	case []*GoogleTranscoderJobConfigMuxStreams:
		value_ := value.([]*GoogleTranscoderJobConfigMuxStreams)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
...
func (g *jsiiProxy_GoogleTranscoderJobConfigAOutputReference) validatePutOverlaysParameters(value interface{}) error {
	...
	case []*GoogleTranscoderJobConfigOverlays:
		value_ := value.([]*GoogleTranscoderJobConfigOverlays)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
...
func (g *jsiiProxy_GoogleTranscoderJobConfigAOutputReference) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
