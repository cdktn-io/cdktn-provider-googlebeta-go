...
func (g *jsiiProxy_GoogleTranscoderJobConfigElementaryStreamsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleTranscoderJobConfigElementaryStreamsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
