...
func (g *jsiiProxy_GoogleTranscoderJobConfigMuxStreamsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleTranscoderJobConfigMuxStreamsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
