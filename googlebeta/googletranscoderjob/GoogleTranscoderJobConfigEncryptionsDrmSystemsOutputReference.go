...
func (g *jsiiProxy_GoogleTranscoderJobConfigEncryptionsDrmSystemsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleTranscoderJobConfigEncryptionsDrmSystemsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
