...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.dataGoogleIamWorkloadIdentityPoolOpenidConfig.DataGoogleIamWorkloadIdentityPoolOpenidConfig",
		reflect.TypeOf((*DataGoogleIamWorkloadIdentityPoolOpenidConfig)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.dataGoogleIamWorkloadIdentityPoolOpenidConfig.DataGoogleIamWorkloadIdentityPoolOpenidConfigConfig",
		reflect.TypeOf((*DataGoogleIamWorkloadIdentityPoolOpenidConfigConfig)(nil)).Elem(),
	)
}
