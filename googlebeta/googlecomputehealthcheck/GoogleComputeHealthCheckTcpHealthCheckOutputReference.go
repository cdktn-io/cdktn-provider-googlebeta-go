...
func (g *jsiiProxy_GoogleComputeHealthCheckTcpHealthCheckOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleComputeHealthCheckTcpHealthCheckOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
