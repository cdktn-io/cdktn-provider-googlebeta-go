...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.googleLoggingOrganizationExclusion.GoogleLoggingOrganizationExclusion",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleLoggingOrganizationExclusion.GoogleLoggingOrganizationExclusionConfig",
