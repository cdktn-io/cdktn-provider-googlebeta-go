...
type GoogleSecretManagerRegionalSecretIamMemberConfig struct {
	// Experimental.
	...
	Condition *GoogleSecretManagerRegionalSecretIamMemberCondition `field:"optional" json:"condition" yaml:"condition"`
