...
func (j *jsiiProxy_GoogleProjectAccessApprovalSettings) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleProjectAccessApprovalSettings) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleProjectAccessApprovalSettings)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleProjectAccessApprovalSettings) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleProjectAccessApprovalSettings) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleProjectAccessApprovalSettings) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleProjectAccessApprovalSettings) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
