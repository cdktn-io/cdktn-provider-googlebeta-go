...
func (g *jsiiProxy_GoogleProjectAccessApprovalSettings) validatePutEnrolledServicesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleProjectAccessApprovalSettingsEnrolledServices; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_GoogleProjectAccessApprovalSettings) validateSetDeletionPolicyParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
