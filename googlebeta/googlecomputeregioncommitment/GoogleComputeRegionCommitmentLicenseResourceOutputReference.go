...
func (g *jsiiProxy_GoogleComputeRegionCommitmentLicenseResourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleComputeRegionCommitmentLicenseResourceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
