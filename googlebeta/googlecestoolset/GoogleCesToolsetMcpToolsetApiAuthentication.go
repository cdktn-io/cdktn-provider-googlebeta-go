...
type GoogleCesToolsetMcpToolsetApiAuthentication struct {
	...
	ApiKeyConfig *GoogleCesToolsetMcpToolsetApiAuthenticationApiKeyConfig `field:"optional" json:"apiKeyConfig" yaml:"apiKeyConfig"`
	...
	BearerTokenConfig *GoogleCesToolsetMcpToolsetApiAuthenticationBearerTokenConfig `field:"optional" json:"bearerTokenConfig" yaml:"bearerTokenConfig"`
	// oauth_config block.
	//
	...
	OauthConfig *GoogleCesToolsetMcpToolsetApiAuthenticationOauthConfig `field:"optional" json:"oauthConfig" yaml:"oauthConfig"`
	...
	ServiceAccountAuthConfig *GoogleCesToolsetMcpToolsetApiAuthenticationServiceAccountAuthConfig `field:"optional" json:"serviceAccountAuthConfig" yaml:"serviceAccountAuthConfig"`
	...
	ServiceAgentIdTokenAuthConfig *GoogleCesToolsetMcpToolsetApiAuthenticationServiceAgentIdTokenAuthConfig `field:"optional" json:"serviceAgentIdTokenAuthConfig" yaml:"serviceAgentIdTokenAuthConfig"`
}
