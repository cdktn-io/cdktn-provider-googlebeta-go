...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googlegkeonprembaremetalnodepool/internal"
...
func (j *jsiiProxy_GoogleGkeonpremBareMetalNodePool) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleGkeonpremBareMetalNodePool) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleGkeonpremBareMetalNodePool) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleGkeonpremBareMetalNodePool) EffectiveAnnotations() cdktn.StringMap {
...
func (j *jsiiProxy_GoogleGkeonpremBareMetalNodePool) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleGkeonpremBareMetalNodePool) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleGkeonpremBareMetalNodePool) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleGkeonpremBareMetalNodePool) Reconciling() cdktn.IResolvable {
...
func (j *jsiiProxy_GoogleGkeonpremBareMetalNodePool) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.43.0/docs/resources/google_gkeonprem_bare_metal_node_pool google_gkeonprem_bare_metal_node_pool} Resource.
func NewGoogleGkeonpremBareMetalNodePool(scope constructs.Construct, id *string, config *GoogleGkeonpremBareMetalNodePoolConfig) GoogleGkeonpremBareMetalNodePool {
	...
	_jsii_.Create(
		"@cdktn/provider-google-beta.googleGkeonpremBareMetalNodePool.GoogleGkeonpremBareMetalNodePool",
...
func (j *jsiiProxy_GoogleGkeonpremBareMetalNodePool)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_GoogleGkeonpremBareMetalNodePool)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleGkeonpremBareMetalNodePool)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleGkeonpremBareMetalNodePool)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleGkeonpremBareMetalNodePool_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleGkeonpremBareMetalNodePool) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleGkeonpremBareMetalNodePool) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleGkeonpremBareMetalNodePool) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleGkeonpremBareMetalNodePool) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleGkeonpremBareMetalNodePool) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleGkeonpremBareMetalNodePool) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleGkeonpremBareMetalNodePool) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
