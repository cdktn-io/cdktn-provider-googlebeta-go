...
func (j *jsiiProxy_GoogleSaasRuntimeUnitKind) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleSaasRuntimeUnitKind) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleSaasRuntimeUnitKind)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleSaasRuntimeUnitKind) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleSaasRuntimeUnitKind) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleSaasRuntimeUnitKind) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
