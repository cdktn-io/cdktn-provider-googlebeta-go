...
func (j *jsiiProxy_GoogleDataformRepositoryReleaseConfigRecentScheduledReleaseRecordsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGoogleDataformRepositoryReleaseConfigRecentScheduledReleaseRecordsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleDataformRepositoryReleaseConfigRecentScheduledReleaseRecordsList {
	_init_.Initialize()
...
func NewGoogleDataformRepositoryReleaseConfigRecentScheduledReleaseRecordsList_Override(g GoogleDataformRepositoryReleaseConfigRecentScheduledReleaseRecordsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleDataformRepositoryReleaseConfigRecentScheduledReleaseRecordsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleDataformRepositoryReleaseConfigRecentScheduledReleaseRecordsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleDataformRepositoryReleaseConfigRecentScheduledReleaseRecordsList) Resolve(context cdktn.IResolveContext) interface{} {
