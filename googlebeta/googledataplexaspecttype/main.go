...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dataClassification", GoGetter: "DataClassification"},
			_jsii_.MemberProperty{JsiiProperty: "dataClassificationInput", GoGetter: "DataClassificationInput"},
