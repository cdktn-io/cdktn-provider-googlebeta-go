...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.45.0/docs/resources/google_network_connectivity_policy_based_route google_network_connectivity_policy_based_route} Resource.
...
func (g *jsiiProxy_GoogleNetworkConnectivityPolicyBasedRoute) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleNetworkConnectivityPolicyBasedRoute) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleNetworkConnectivityPolicyBasedRoute) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
