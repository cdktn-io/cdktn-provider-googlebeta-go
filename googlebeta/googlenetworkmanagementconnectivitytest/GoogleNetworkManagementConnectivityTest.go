...
func (j *jsiiProxy_GoogleNetworkManagementConnectivityTest) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleNetworkManagementConnectivityTest) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.44.0/docs/resources/google_network_management_connectivity_test google_network_management_connectivity_test} Resource.
...
func (j *jsiiProxy_GoogleNetworkManagementConnectivityTest)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleNetworkManagementConnectivityTest) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleNetworkManagementConnectivityTest) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleNetworkManagementConnectivityTest) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleNetworkManagementConnectivityTest) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
