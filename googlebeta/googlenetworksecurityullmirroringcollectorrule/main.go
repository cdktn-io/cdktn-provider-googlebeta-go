...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "ullMirroringCollector", GoGetter: "UllMirroringCollector"},
			_jsii_.MemberProperty{JsiiProperty: "ullMirroringCollectorInput", GoGetter: "UllMirroringCollectorInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dstIpRanges", GoGetter: "DstIpRanges"},
			_jsii_.MemberProperty{JsiiProperty: "dstIpRangesInput", GoGetter: "DstIpRangesInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDstIpRanges", GoMethod: "ResetDstIpRanges"},
