...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googlediscoveryenginecmekconfig/internal"
...
func (j *jsiiProxy_GoogleDiscoveryEngineCmekConfig) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleDiscoveryEngineCmekConfig) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleDiscoveryEngineCmekConfig) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleDiscoveryEngineCmekConfig) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleDiscoveryEngineCmekConfig) IsDefault() cdktn.IResolvable {
...
func (j *jsiiProxy_GoogleDiscoveryEngineCmekConfig) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleDiscoveryEngineCmekConfig) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleDiscoveryEngineCmekConfig) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.1/docs/resources/google_discovery_engine_cmek_config google_discovery_engine_cmek_config} Resource.
func NewGoogleDiscoveryEngineCmekConfig(scope constructs.Construct, id *string, config *GoogleDiscoveryEngineCmekConfigConfig) GoogleDiscoveryEngineCmekConfig {
	...
	_jsii_.Create(
		"@cdktn/provider-google-beta.googleDiscoveryEngineCmekConfig.GoogleDiscoveryEngineCmekConfig",
...
func (j *jsiiProxy_GoogleDiscoveryEngineCmekConfig)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_GoogleDiscoveryEngineCmekConfig)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleDiscoveryEngineCmekConfig)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleDiscoveryEngineCmekConfig)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleDiscoveryEngineCmekConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleDiscoveryEngineCmekConfig) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleDiscoveryEngineCmekConfig) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleDiscoveryEngineCmekConfig) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleDiscoveryEngineCmekConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleDiscoveryEngineCmekConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleDiscoveryEngineCmekConfig) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleDiscoveryEngineCmekConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
