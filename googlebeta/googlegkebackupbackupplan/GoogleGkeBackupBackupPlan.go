...
func (j *jsiiProxy_GoogleGkeBackupBackupPlan) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleGkeBackupBackupPlan) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleGkeBackupBackupPlan) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleGkeBackupBackupPlan) EffectiveLabels() cdktn.StringMap {
...
func (j *jsiiProxy_GoogleGkeBackupBackupPlan) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleGkeBackupBackupPlan) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleGkeBackupBackupPlan) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleGkeBackupBackupPlan) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleGkeBackupBackupPlan) TerraformLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_gke_backup_backup_plan google_gke_backup_backup_plan} Resource.
...
func (j *jsiiProxy_GoogleGkeBackupBackupPlan)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_GoogleGkeBackupBackupPlan)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleGkeBackupBackupPlan)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleGkeBackupBackupPlan)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleGkeBackupBackupPlan_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleGkeBackupBackupPlan) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleGkeBackupBackupPlan) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleGkeBackupBackupPlan) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleGkeBackupBackupPlan) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleGkeBackupBackupPlan) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleGkeBackupBackupPlan) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleGkeBackupBackupPlan) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
