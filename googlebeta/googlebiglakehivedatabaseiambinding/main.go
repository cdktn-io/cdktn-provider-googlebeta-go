...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleBiglakeHiveDatabaseIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleBiglakeHiveDatabaseIamBinding.GoogleBiglakeHiveDatabaseIamBindingCondition",
		reflect.TypeOf((*GoogleBiglakeHiveDatabaseIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleBiglakeHiveDatabaseIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleBiglakeHiveDatabaseIamBinding.GoogleBiglakeHiveDatabaseIamBindingConfig",
		reflect.TypeOf((*GoogleBiglakeHiveDatabaseIamBindingConfig)(nil)).Elem(),
	)
}
