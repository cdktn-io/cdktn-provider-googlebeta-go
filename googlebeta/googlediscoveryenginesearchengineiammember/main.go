...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleDiscoveryEngineSearchEngineIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleDiscoveryEngineSearchEngineIamMember.GoogleDiscoveryEngineSearchEngineIamMemberCondition",
		reflect.TypeOf((*GoogleDiscoveryEngineSearchEngineIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleDiscoveryEngineSearchEngineIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleDiscoveryEngineSearchEngineIamMember.GoogleDiscoveryEngineSearchEngineIamMemberConfig",
		reflect.TypeOf((*GoogleDiscoveryEngineSearchEngineIamMemberConfig)(nil)).Elem(),
	)
}
