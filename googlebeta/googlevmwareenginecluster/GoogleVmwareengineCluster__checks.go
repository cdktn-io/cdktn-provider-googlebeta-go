...
func (g *jsiiProxy_GoogleVmwareengineCluster) validatePutDatastoreMountConfigParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleVmwareengineClusterDatastoreMountConfig; received %#v (a %T)", value, value)
		}
	}
...
func (g *jsiiProxy_GoogleVmwareengineCluster) validatePutNodeTypeConfigsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleVmwareengineClusterNodeTypeConfigs; received %#v (a %T)", value, value)
		}
	}
