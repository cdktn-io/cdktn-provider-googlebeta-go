...
func (g *jsiiProxy_GoogleVmwareengineClusterAutoscalingSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleVmwareengineClusterAutoscalingSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
