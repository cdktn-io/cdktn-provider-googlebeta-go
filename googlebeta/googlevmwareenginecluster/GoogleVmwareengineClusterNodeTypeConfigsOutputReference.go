...
func (g *jsiiProxy_GoogleVmwareengineClusterNodeTypeConfigsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleVmwareengineClusterNodeTypeConfigsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
