...
func (j *jsiiProxy_GoogleCloudbuildv2Connection) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleCloudbuildv2Connection) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleCloudbuildv2Connection)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleCloudbuildv2Connection) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleCloudbuildv2Connection) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleCloudbuildv2Connection) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleCloudbuildv2Connection) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
