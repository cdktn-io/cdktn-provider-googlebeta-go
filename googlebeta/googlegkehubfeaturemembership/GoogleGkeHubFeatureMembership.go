...
func (g *jsiiProxy_GoogleGkeHubFeatureMembership) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleGkeHubFeatureMembership) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
