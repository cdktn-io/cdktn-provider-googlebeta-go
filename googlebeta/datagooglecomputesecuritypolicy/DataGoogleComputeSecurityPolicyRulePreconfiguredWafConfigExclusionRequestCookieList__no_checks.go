...
func (d *jsiiProxy_DataGoogleComputeSecurityPolicyRulePreconfiguredWafConfigExclusionRequestCookieList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
