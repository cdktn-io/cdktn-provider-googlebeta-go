...
func (j *jsiiProxy_DataGoogleComputeRegionDisk) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_DataGoogleComputeRegionDisk) EraseWindowsVssSignature() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
