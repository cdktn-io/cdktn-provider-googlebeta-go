...
func (j *jsiiProxy_GoogleGeminiCodeToolsSettingEnabledToolConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGoogleGeminiCodeToolsSettingEnabledToolConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleGeminiCodeToolsSettingEnabledToolConfigList {
	_init_.Initialize()
...
func NewGoogleGeminiCodeToolsSettingEnabledToolConfigList_Override(g GoogleGeminiCodeToolsSettingEnabledToolConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleGeminiCodeToolsSettingEnabledToolConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleGeminiCodeToolsSettingEnabledToolConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleGeminiCodeToolsSettingEnabledToolConfigList) Resolve(context cdktn.IResolveContext) interface{} {
