...
func (g *jsiiProxy_GoogleMemorystoreInstance) validatePutDesiredAutoCreatedEndpointsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleMemorystoreInstanceDesiredAutoCreatedEndpoints; received %#v (a %T)", value, value)
		}
	}
...
func (g *jsiiProxy_GoogleMemorystoreInstance) validatePutDesiredPscAutoConnectionsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleMemorystoreInstanceDesiredPscAutoConnections; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_GoogleMemorystoreInstance) validateSetDeletionPolicyParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
