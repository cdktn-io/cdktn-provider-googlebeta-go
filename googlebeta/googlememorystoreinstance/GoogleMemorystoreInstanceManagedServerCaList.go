...
func (j *jsiiProxy_GoogleMemorystoreInstanceManagedServerCaList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleMemorystoreInstanceManagedServerCaList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleMemorystoreInstanceManagedServerCaList {
	_init_.Initialize()
...
func NewGoogleMemorystoreInstanceManagedServerCaList_Override(g GoogleMemorystoreInstanceManagedServerCaList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleMemorystoreInstanceManagedServerCaList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleMemorystoreInstanceManagedServerCaList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleMemorystoreInstanceManagedServerCaList) Resolve(context cdktf.IResolveContext) interface{} {
