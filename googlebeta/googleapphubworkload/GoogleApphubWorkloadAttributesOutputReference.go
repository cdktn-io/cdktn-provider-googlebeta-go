...
func (g *jsiiProxy_GoogleApphubWorkloadAttributesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleApphubWorkloadAttributesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
