...
type GoogleParameterManagerRegionalParameterConfig struct {
	// Experimental.
	...
	Timeouts *GoogleParameterManagerRegionalParameterTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}
