...
func (g *jsiiProxy_GoogleApihubPluginInstanceAuthConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleApihubPluginInstanceAuthConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
