...
type GoogleNetworkConnectivityRegionalEndpointConfig struct {
	// Experimental.
	...
	Timeouts *GoogleNetworkConnectivityRegionalEndpointTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}
