...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.dataGoogleComputeInstance.DataGoogleComputeInstanceNetworkInterfaceAliasIpv6Range",
		reflect.TypeOf((*DataGoogleComputeInstanceNetworkInterfaceAliasIpv6Range)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.dataGoogleComputeInstance.DataGoogleComputeInstanceNetworkInterfaceAliasIpv6RangeList",
		reflect.TypeOf((*DataGoogleComputeInstanceNetworkInterfaceAliasIpv6RangeList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
		...
		func() interface{} {
			j := jsiiProxy_DataGoogleComputeInstanceNetworkInterfaceAliasIpv6RangeList{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexList)
			return &j
		},
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataGoogleComputeInstanceNetworkInterfaceAliasIpv6RangeOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.dataGoogleComputeInstance.DataGoogleComputeInstanceWorkloadIdentityConfig",
		reflect.TypeOf((*DataGoogleComputeInstanceWorkloadIdentityConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.dataGoogleComputeInstance.DataGoogleComputeInstanceWorkloadIdentityConfigList",
	...
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.dataGoogleComputeInstance.DataGoogleComputeInstanceWorkloadIdentityConfigOutputReference",
