...
func (g *jsiiProxy_GoogleGkeonpremBareMetalAdminClusterStorageOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleGkeonpremBareMetalAdminClusterStorageOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
