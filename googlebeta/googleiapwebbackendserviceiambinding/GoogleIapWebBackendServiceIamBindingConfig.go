...
type GoogleIapWebBackendServiceIamBindingConfig struct {
	// Experimental.
	...
	Condition *GoogleIapWebBackendServiceIamBindingCondition `field:"optional" json:"condition" yaml:"condition"`
