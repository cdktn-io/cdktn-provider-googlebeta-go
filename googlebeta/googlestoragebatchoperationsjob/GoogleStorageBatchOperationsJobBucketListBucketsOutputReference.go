...
func (g *jsiiProxy_GoogleStorageBatchOperationsJobBucketListBucketsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleStorageBatchOperationsJobBucketListBucketsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
