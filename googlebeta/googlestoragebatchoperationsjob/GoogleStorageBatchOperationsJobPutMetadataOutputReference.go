...
func (g *jsiiProxy_GoogleStorageBatchOperationsJobPutMetadataOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleStorageBatchOperationsJobPutMetadataOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
