...
func (j *jsiiProxy_GoogleVertexAiIndexEndpointDeployedIndex) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleVertexAiIndexEndpointDeployedIndex) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleVertexAiIndexEndpointDeployedIndex)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleVertexAiIndexEndpointDeployedIndex) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleVertexAiIndexEndpointDeployedIndex) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleVertexAiIndexEndpointDeployedIndex) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
