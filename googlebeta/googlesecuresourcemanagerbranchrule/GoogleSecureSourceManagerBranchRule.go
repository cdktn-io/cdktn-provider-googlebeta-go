...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googlesecuresourcemanagerbranchrule/internal"
...
func (g *jsiiProxy_GoogleSecureSourceManagerBranchRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleSecureSourceManagerBranchRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
