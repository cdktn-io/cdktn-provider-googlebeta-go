...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.googleKmsKeyRingIamMember.GoogleKmsKeyRingIamMember",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleKmsKeyRingIamMember.GoogleKmsKeyRingIamMemberCondition",
		reflect.TypeOf((*GoogleKmsKeyRingIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.googleKmsKeyRingIamMember.GoogleKmsKeyRingIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleKmsKeyRingIamMember.GoogleKmsKeyRingIamMemberConfig",
