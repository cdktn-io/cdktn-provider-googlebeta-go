...
func (j *jsiiProxy_DataGoogleContainerClusterNodePoolNodeConfigLinuxNodeConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleContainerClusterNodePoolNodeConfigLinuxNodeConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleContainerClusterNodePoolNodeConfigLinuxNodeConfigList {
	_init_.Initialize()
...
func NewDataGoogleContainerClusterNodePoolNodeConfigLinuxNodeConfigList_Override(d DataGoogleContainerClusterNodePoolNodeConfigLinuxNodeConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleContainerClusterNodePoolNodeConfigLinuxNodeConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleContainerClusterNodePoolNodeConfigLinuxNodeConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleContainerClusterNodePoolNodeConfigLinuxNodeConfigList) Resolve(context cdktn.IResolveContext) interface{} {
