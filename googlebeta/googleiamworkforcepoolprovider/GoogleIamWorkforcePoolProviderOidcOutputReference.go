...
func (g *jsiiProxy_GoogleIamWorkforcePoolProviderOidcOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleIamWorkforcePoolProviderOidcOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
