...
func (j *jsiiProxy_GoogleGeminiRepositoryGroupIamBinding) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleGeminiRepositoryGroupIamBinding) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleGeminiRepositoryGroupIamBinding) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleGeminiRepositoryGroupIamBinding) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleGeminiRepositoryGroupIamBinding) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_gemini_repository_group_iam_binding google_gemini_repository_group_iam_binding} Resource.
...
func (j *jsiiProxy_GoogleGeminiRepositoryGroupIamBinding)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleGeminiRepositoryGroupIamBinding)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleGeminiRepositoryGroupIamBinding)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleGeminiRepositoryGroupIamBinding_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleGeminiRepositoryGroupIamBinding) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleGeminiRepositoryGroupIamBinding) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleGeminiRepositoryGroupIamBinding) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleGeminiRepositoryGroupIamBinding) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleGeminiRepositoryGroupIamBinding) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleGeminiRepositoryGroupIamBinding) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
