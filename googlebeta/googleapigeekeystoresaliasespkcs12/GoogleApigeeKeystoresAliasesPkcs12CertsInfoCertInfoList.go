...
func (j *jsiiProxy_GoogleApigeeKeystoresAliasesPkcs12CertsInfoCertInfoList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGoogleApigeeKeystoresAliasesPkcs12CertsInfoCertInfoList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleApigeeKeystoresAliasesPkcs12CertsInfoCertInfoList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-google-beta.googleApigeeKeystoresAliasesPkcs12.GoogleApigeeKeystoresAliasesPkcs12CertsInfoCertInfoList",
...
func NewGoogleApigeeKeystoresAliasesPkcs12CertsInfoCertInfoList_Override(g GoogleApigeeKeystoresAliasesPkcs12CertsInfoCertInfoList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleApigeeKeystoresAliasesPkcs12CertsInfoCertInfoList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleApigeeKeystoresAliasesPkcs12CertsInfoCertInfoList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleApigeeKeystoresAliasesPkcs12CertsInfoCertInfoList) Resolve(context cdktn.IResolveContext) interface{} {
