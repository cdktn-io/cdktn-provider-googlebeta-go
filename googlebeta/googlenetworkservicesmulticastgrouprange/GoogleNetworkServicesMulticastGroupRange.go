...
func (j *jsiiProxy_GoogleNetworkServicesMulticastGroupRange) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleNetworkServicesMulticastGroupRange) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.45.0/docs/resources/google_network_services_multicast_group_range google_network_services_multicast_group_range} Resource.
...
func (j *jsiiProxy_GoogleNetworkServicesMulticastGroupRange)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleNetworkServicesMulticastGroupRange) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleNetworkServicesMulticastGroupRange) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleNetworkServicesMulticastGroupRange) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
