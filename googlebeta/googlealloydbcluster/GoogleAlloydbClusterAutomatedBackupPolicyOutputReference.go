...
func (g *jsiiProxy_GoogleAlloydbClusterAutomatedBackupPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleAlloydbClusterAutomatedBackupPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
