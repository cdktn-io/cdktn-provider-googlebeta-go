...
func (j *jsiiProxy_GoogleClouddeployDeliveryPipelineConditionList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGoogleClouddeployDeliveryPipelineConditionList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleClouddeployDeliveryPipelineConditionList {
	_init_.Initialize()
...
func NewGoogleClouddeployDeliveryPipelineConditionList_Override(g GoogleClouddeployDeliveryPipelineConditionList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleClouddeployDeliveryPipelineConditionList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleClouddeployDeliveryPipelineConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleClouddeployDeliveryPipelineConditionList) Resolve(context cdktn.IResolveContext) interface{} {
