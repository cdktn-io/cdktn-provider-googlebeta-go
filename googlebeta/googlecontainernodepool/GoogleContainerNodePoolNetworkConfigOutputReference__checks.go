...
func (g *jsiiProxy_GoogleContainerNodePoolNetworkConfigOutputReference) validatePutAdditionalNodeNetworkConfigsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleContainerNodePoolNetworkConfigAdditionalNodeNetworkConfigs; received %#v (a %T)", value, value)
		}
	}
...
func (g *jsiiProxy_GoogleContainerNodePoolNetworkConfigOutputReference) validatePutAdditionalPodNetworkConfigsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleContainerNodePoolNetworkConfigAdditionalPodNetworkConfigs; received %#v (a %T)", value, value)
		}
	}
