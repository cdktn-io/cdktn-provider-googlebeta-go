...
func (g *jsiiProxy_GoogleContainerNodePoolUpgradeSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleContainerNodePoolUpgradeSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
