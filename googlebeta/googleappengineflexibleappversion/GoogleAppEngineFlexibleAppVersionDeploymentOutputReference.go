...
func (g *jsiiProxy_GoogleAppEngineFlexibleAppVersionDeploymentOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleAppEngineFlexibleAppVersionDeploymentOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
