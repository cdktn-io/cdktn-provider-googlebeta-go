...
func (g *jsiiProxy_GoogleAppEngineFlexibleAppVersionLivenessCheckOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleAppEngineFlexibleAppVersionLivenessCheckOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
