...
func (g *jsiiProxy_GoogleAppEngineFlexibleAppVersionHandlersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleAppEngineFlexibleAppVersionHandlersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
