...
func (g *jsiiProxy_GoogleAppEngineFlexibleAppVersionNetworkOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleAppEngineFlexibleAppVersionNetworkOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
