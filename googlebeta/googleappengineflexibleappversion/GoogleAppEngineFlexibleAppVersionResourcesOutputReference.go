...
func (g *jsiiProxy_GoogleAppEngineFlexibleAppVersionResourcesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleAppEngineFlexibleAppVersionResourcesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
