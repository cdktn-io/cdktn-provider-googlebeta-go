...
type GoogleChronicleFeedDetailsWorkspaceUsersSettingsAuthentication struct {
	// claims block.
	//
	...
	Claims *GoogleChronicleFeedDetailsWorkspaceUsersSettingsAuthenticationClaims `field:"optional" json:"claims" yaml:"claims"`
	...
	RsCredentials *GoogleChronicleFeedDetailsWorkspaceUsersSettingsAuthenticationRsCredentials `field:"optional" json:"rsCredentials" yaml:"rsCredentials"`
