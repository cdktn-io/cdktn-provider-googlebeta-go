...
type GoogleChronicleFeedDetailsOktaSettings struct {
	...
	Authentication *GoogleChronicleFeedDetailsOktaSettingsAuthentication `field:"optional" json:"authentication" yaml:"authentication"`
	// API Hostname.
	//
