...
type GoogleChronicleFeedDetailsMimecastMailSettings struct {
	...
	Authentication *GoogleChronicleFeedDetailsMimecastMailSettingsAuthentication `field:"optional" json:"authentication" yaml:"authentication"`
	// API Hostname.
	//
