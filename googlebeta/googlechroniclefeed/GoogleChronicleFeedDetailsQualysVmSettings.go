...
type GoogleChronicleFeedDetailsQualysVmSettings struct {
	...
	Authentication *GoogleChronicleFeedDetailsQualysVmSettingsAuthentication `field:"optional" json:"authentication" yaml:"authentication"`
	// API Hostname.
	//
