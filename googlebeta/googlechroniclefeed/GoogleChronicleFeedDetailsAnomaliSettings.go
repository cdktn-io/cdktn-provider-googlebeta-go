...
type GoogleChronicleFeedDetailsAnomaliSettings struct {
	...
	Authentication *GoogleChronicleFeedDetailsAnomaliSettingsAuthentication `field:"optional" json:"authentication" yaml:"authentication"`
}
