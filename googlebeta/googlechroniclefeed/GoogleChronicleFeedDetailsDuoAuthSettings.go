...
type GoogleChronicleFeedDetailsDuoAuthSettings struct {
	...
	Authentication *GoogleChronicleFeedDetailsDuoAuthSettingsAuthentication `field:"optional" json:"authentication" yaml:"authentication"`
	// API Hostname.
	//
