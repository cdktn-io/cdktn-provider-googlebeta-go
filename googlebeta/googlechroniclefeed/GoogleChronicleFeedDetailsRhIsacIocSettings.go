...
type GoogleChronicleFeedDetailsRhIsacIocSettings struct {
	...
	Authentication *GoogleChronicleFeedDetailsRhIsacIocSettingsAuthentication `field:"optional" json:"authentication" yaml:"authentication"`
}
