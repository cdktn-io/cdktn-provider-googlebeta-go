...
type GoogleChronicleFeedDetailsAzureMdmIntuneSettings struct {
	// API Auth Endpoint.
	//
	...
	Authentication *GoogleChronicleFeedDetailsAzureMdmIntuneSettingsAuthentication `field:"optional" json:"authentication" yaml:"authentication"`
	// API Hostname.
	//
