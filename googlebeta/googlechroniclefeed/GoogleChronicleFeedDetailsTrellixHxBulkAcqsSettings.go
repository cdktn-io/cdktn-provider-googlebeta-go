...
type GoogleChronicleFeedDetailsTrellixHxBulkAcqsSettings struct {
	...
	Authentication *GoogleChronicleFeedDetailsTrellixHxBulkAcqsSettingsAuthentication `field:"optional" json:"authentication" yaml:"authentication"`
}
