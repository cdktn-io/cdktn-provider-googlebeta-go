...
type GoogleChronicleFeedDetailsWorkspaceMobileSettings struct {
	...
	Authentication *GoogleChronicleFeedDetailsWorkspaceMobileSettingsAuthentication `field:"optional" json:"authentication" yaml:"authentication"`
	// Customer ID.
	//
