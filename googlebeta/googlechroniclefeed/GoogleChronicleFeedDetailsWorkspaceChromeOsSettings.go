...
type GoogleChronicleFeedDetailsWorkspaceChromeOsSettings struct {
	...
	Authentication *GoogleChronicleFeedDetailsWorkspaceChromeOsSettingsAuthentication `field:"optional" json:"authentication" yaml:"authentication"`
	// Customer ID.
	//
