...
type GoogleChronicleFeedDetailsMicrosoftGraphAlertSettings struct {
	// API Auth Endpoint.
	//
	...
	Authentication *GoogleChronicleFeedDetailsMicrosoftGraphAlertSettingsAuthentication `field:"optional" json:"authentication" yaml:"authentication"`
	// API Hostname.
	//
