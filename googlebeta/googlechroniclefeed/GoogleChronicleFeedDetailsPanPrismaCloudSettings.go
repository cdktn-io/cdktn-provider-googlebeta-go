...
type GoogleChronicleFeedDetailsPanPrismaCloudSettings struct {
	...
	Authentication *GoogleChronicleFeedDetailsPanPrismaCloudSettingsAuthentication `field:"optional" json:"authentication" yaml:"authentication"`
	// API Hostname.
	//
