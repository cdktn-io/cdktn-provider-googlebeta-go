...
type GoogleChronicleFeedDetailsImpervaWafSettings struct {
	...
	Authentication *GoogleChronicleFeedDetailsImpervaWafSettingsAuthentication `field:"optional" json:"authentication" yaml:"authentication"`
}
