...
type GoogleChronicleFeedDetailsWorkspacePrivilegesSettings struct {
	...
	Authentication *GoogleChronicleFeedDetailsWorkspacePrivilegesSettingsAuthentication `field:"optional" json:"authentication" yaml:"authentication"`
	// Customer ID.
	//
