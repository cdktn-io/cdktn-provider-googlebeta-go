...
func (j *jsiiProxy_GoogleStorageAnywhereCache) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleStorageAnywhereCache) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleStorageAnywhereCache) IngestOnWrite() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"ingestOnWrite",
...
func (j *jsiiProxy_GoogleStorageAnywhereCache) IngestOnWriteInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"ingestOnWriteInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.44.0/docs/resources/google_storage_anywhere_cache google_storage_anywhere_cache} Resource.
...
func (j *jsiiProxy_GoogleStorageAnywhereCache)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_GoogleStorageAnywhereCache)SetIngestOnWrite(val interface{}) {
...
func (g *jsiiProxy_GoogleStorageAnywhereCache) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleStorageAnywhereCache) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleStorageAnywhereCache) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleStorageAnywhereCache) ResetIngestOnWrite() {
	_jsii_.InvokeVoid(
		g,
		"resetIngestOnWrite",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleStorageAnywhereCache) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
