...
func (g *jsiiProxy_GoogleFirebaseHostingVersionConfigRewritesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleFirebaseHostingVersionConfigRewritesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
