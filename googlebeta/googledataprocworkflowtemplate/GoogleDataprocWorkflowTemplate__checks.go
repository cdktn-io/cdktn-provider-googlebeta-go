...
func (g *jsiiProxy_GoogleDataprocWorkflowTemplate) validatePutJobsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleDataprocWorkflowTemplateJobs; received %#v (a %T)", value, value)
		}
	}
...
func (g *jsiiProxy_GoogleDataprocWorkflowTemplate) validatePutParametersParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleDataprocWorkflowTemplateParameters; received %#v (a %T)", value, value)
		}
	}
