...
func (j *jsiiProxy_DataGoogleMemorystoreInstance) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.44.0/docs/data-sources/google_memorystore_instance google_memorystore_instance} Data Source.
