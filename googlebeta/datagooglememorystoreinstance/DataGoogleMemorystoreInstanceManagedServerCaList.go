...
func (j *jsiiProxy_DataGoogleMemorystoreInstanceManagedServerCaList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleMemorystoreInstanceManagedServerCaList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleMemorystoreInstanceManagedServerCaList {
	_init_.Initialize()
...
func NewDataGoogleMemorystoreInstanceManagedServerCaList_Override(d DataGoogleMemorystoreInstanceManagedServerCaList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleMemorystoreInstanceManagedServerCaList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleMemorystoreInstanceManagedServerCaList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleMemorystoreInstanceManagedServerCaList) Resolve(context cdktn.IResolveContext) interface{} {
