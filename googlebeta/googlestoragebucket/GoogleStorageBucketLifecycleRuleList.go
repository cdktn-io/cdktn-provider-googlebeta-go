...
func (j *jsiiProxy_GoogleStorageBucketLifecycleRuleList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGoogleStorageBucketLifecycleRuleList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleStorageBucketLifecycleRuleList {
	_init_.Initialize()
...
func NewGoogleStorageBucketLifecycleRuleList_Override(g GoogleStorageBucketLifecycleRuleList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleStorageBucketLifecycleRuleList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleStorageBucketLifecycleRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleStorageBucketLifecycleRuleList) Resolve(context cdktn.IResolveContext) interface{} {
