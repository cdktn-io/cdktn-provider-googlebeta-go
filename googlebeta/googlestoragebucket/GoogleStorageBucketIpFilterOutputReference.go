...
func (g *jsiiProxy_GoogleStorageBucketIpFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleStorageBucketIpFilterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
