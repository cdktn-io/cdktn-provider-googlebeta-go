...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSizeAboveBytes", GoMethod: "ResetSizeAboveBytes"},
			_jsii_.MemberMethod{JsiiMethod: "resetSizeBelowBytes", GoMethod: "ResetSizeBelowBytes"},
			...
			_jsii_.MemberProperty{JsiiProperty: "sizeAboveBytesInput", GoGetter: "SizeAboveBytesInput"},
			_jsii_.MemberProperty{JsiiProperty: "sizeBelowBytes", GoGetter: "SizeBelowBytes"},
			_jsii_.MemberProperty{JsiiProperty: "sizeBelowBytesInput", GoGetter: "SizeBelowBytesInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
