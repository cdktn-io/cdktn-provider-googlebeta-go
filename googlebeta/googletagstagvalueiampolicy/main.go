...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.googleTagsTagValueIamPolicy.GoogleTagsTagValueIamPolicy",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleTagsTagValueIamPolicy.GoogleTagsTagValueIamPolicyConfig",
