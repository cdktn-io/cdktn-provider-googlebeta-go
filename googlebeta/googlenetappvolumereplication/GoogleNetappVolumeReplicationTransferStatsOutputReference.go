...
func (g *jsiiProxy_GoogleNetappVolumeReplicationTransferStatsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleNetappVolumeReplicationTransferStatsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
