...
func (g *jsiiProxy_GoogleNetappVolumeReplicationTransferStatsList) validateGetParameters(index *float64) error {
	return nil
}

func (g *jsiiProxy_GoogleNetappVolumeReplicationTransferStatsList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}

func (j *jsiiProxy_GoogleNetappVolumeReplicationTransferStatsList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_GoogleNetappVolumeReplicationTransferStatsList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
