...
type GoogleAccessContextManagerServicePerimeterDryRunIngressPolicyConfig struct {
	// Experimental.
	...
	IngressFrom *GoogleAccessContextManagerServicePerimeterDryRunIngressPolicyIngressFrom `field:"optional" json:"ingressFrom" yaml:"ingressFrom"`
	// ingress_to block.
	//
	...
	IngressTo *GoogleAccessContextManagerServicePerimeterDryRunIngressPolicyIngressTo `field:"optional" json:"ingressTo" yaml:"ingressTo"`
	// timeouts block.
	//
	...
	Timeouts *GoogleAccessContextManagerServicePerimeterDryRunIngressPolicyTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
