...
type GoogleAccessContextManagerServicePerimeterDryRunIngressPolicyIngressFromSources struct {
	...
	PscEndpoint *GoogleAccessContextManagerServicePerimeterDryRunIngressPolicyIngressFromSourcesPscEndpoint `field:"optional" json:"pscEndpoint" yaml:"pscEndpoint"`
