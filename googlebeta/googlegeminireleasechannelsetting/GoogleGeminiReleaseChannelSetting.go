...
func (j *jsiiProxy_GoogleGeminiReleaseChannelSetting) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleGeminiReleaseChannelSetting) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleGeminiReleaseChannelSetting)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleGeminiReleaseChannelSetting) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
