...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googleloggingprojectsink/internal"
...
func (j *jsiiProxy_GoogleLoggingProjectSink) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleLoggingProjectSink) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleLoggingProjectSink) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleLoggingProjectSink) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleLoggingProjectSink) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleLoggingProjectSink) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleLoggingProjectSink) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_logging_project_sink google_logging_project_sink} Resource.
...
func (j *jsiiProxy_GoogleLoggingProjectSink)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_GoogleLoggingProjectSink)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleLoggingProjectSink)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleLoggingProjectSink)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleLoggingProjectSink_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleLoggingProjectSink) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleLoggingProjectSink) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleLoggingProjectSink) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleLoggingProjectSink) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleLoggingProjectSink) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleLoggingProjectSink) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleLoggingProjectSink) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
