...
func (g *jsiiProxy_GoogleNetworkSecuritySecurityProfileThreatPreventionProfileAntivirusOverridesList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
