...
func (g *jsiiProxy_GoogleNetworkSecuritySecurityProfileThreatPreventionProfileThreatOverridesList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
