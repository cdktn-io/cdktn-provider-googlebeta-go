...
func (g *jsiiProxy_GoogleNetworkSecuritySecurityProfile) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleNetworkSecuritySecurityProfile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
