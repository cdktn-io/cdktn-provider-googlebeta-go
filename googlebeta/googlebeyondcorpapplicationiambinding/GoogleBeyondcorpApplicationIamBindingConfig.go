...
type GoogleBeyondcorpApplicationIamBindingConfig struct {
	// Experimental.
	...
	Condition *GoogleBeyondcorpApplicationIamBindingCondition `field:"optional" json:"condition" yaml:"condition"`
