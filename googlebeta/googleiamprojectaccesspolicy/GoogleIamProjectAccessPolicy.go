...
func (g *jsiiProxy_GoogleIamProjectAccessPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleIamProjectAccessPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
