...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "rrsets", GoGetter: "Rrsets"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.dataGoogleDnsRecordSets.DataGoogleDnsRecordSetsConfig",
		reflect.TypeOf((*DataGoogleDnsRecordSetsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.dataGoogleDnsRecordSets.DataGoogleDnsRecordSetsRrsets",
		reflect.TypeOf((*DataGoogleDnsRecordSetsRrsets)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.dataGoogleDnsRecordSets.DataGoogleDnsRecordSetsRrsetsList",
	...
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.dataGoogleDnsRecordSets.DataGoogleDnsRecordSetsRrsetsOutputReference",
