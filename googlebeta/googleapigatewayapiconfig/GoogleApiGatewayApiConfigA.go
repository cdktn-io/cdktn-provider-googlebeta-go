...
func (j *jsiiProxy_GoogleApiGatewayApiConfigA) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleApiGatewayApiConfigA) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleApiGatewayApiConfigA)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleApiGatewayApiConfigA) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
