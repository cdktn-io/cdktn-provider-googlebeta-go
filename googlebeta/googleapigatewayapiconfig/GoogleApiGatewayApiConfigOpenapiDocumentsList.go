...
func (j *jsiiProxy_GoogleApiGatewayApiConfigOpenapiDocumentsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGoogleApiGatewayApiConfigOpenapiDocumentsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleApiGatewayApiConfigOpenapiDocumentsList {
	_init_.Initialize()
...
func NewGoogleApiGatewayApiConfigOpenapiDocumentsList_Override(g GoogleApiGatewayApiConfigOpenapiDocumentsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleApiGatewayApiConfigOpenapiDocumentsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleApiGatewayApiConfigOpenapiDocumentsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleApiGatewayApiConfigOpenapiDocumentsList) Resolve(context cdktn.IResolveContext) interface{} {
