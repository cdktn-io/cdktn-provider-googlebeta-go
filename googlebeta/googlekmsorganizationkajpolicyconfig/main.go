...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "defaultKeyAccessJustificationPolicy", GoGetter: "DefaultKeyAccessJustificationPolicy"},
			_jsii_.MemberProperty{JsiiProperty: "defaultKeyAccessJustificationPolicyInput", GoGetter: "DefaultKeyAccessJustificationPolicyInput"},
