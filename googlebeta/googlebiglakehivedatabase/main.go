...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleBiglakeHiveDatabase)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleBiglakeHiveDatabase.GoogleBiglakeHiveDatabaseConfig",
		reflect.TypeOf((*GoogleBiglakeHiveDatabaseConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleBiglakeHiveDatabase.GoogleBiglakeHiveDatabaseTimeouts",
		reflect.TypeOf((*GoogleBiglakeHiveDatabaseTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.googleBiglakeHiveDatabase.GoogleBiglakeHiveDatabaseTimeoutsOutputReference",
		reflect.TypeOf((*GoogleBiglakeHiveDatabaseTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
