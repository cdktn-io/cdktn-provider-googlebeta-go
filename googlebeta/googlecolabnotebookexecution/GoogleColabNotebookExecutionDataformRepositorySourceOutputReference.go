...
func (g *jsiiProxy_GoogleColabNotebookExecutionDataformRepositorySourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleColabNotebookExecutionDataformRepositorySourceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
