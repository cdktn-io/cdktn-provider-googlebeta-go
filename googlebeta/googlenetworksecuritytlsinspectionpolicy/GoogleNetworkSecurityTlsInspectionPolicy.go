...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googlenetworksecuritytlsinspectionpolicy/internal"
...
func (j *jsiiProxy_GoogleNetworkSecurityTlsInspectionPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleNetworkSecurityTlsInspectionPolicy) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleNetworkSecurityTlsInspectionPolicy) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleNetworkSecurityTlsInspectionPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleNetworkSecurityTlsInspectionPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleNetworkSecurityTlsInspectionPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleNetworkSecurityTlsInspectionPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.44.0/docs/resources/google_network_security_tls_inspection_policy google_network_security_tls_inspection_policy} Resource.
...
func (j *jsiiProxy_GoogleNetworkSecurityTlsInspectionPolicy)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_GoogleNetworkSecurityTlsInspectionPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleNetworkSecurityTlsInspectionPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleNetworkSecurityTlsInspectionPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleNetworkSecurityTlsInspectionPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleNetworkSecurityTlsInspectionPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleNetworkSecurityTlsInspectionPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleNetworkSecurityTlsInspectionPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleNetworkSecurityTlsInspectionPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleNetworkSecurityTlsInspectionPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleNetworkSecurityTlsInspectionPolicy) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleNetworkSecurityTlsInspectionPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
