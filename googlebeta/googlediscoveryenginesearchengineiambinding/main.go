...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleDiscoveryEngineSearchEngineIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleDiscoveryEngineSearchEngineIamBinding.GoogleDiscoveryEngineSearchEngineIamBindingCondition",
		reflect.TypeOf((*GoogleDiscoveryEngineSearchEngineIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleDiscoveryEngineSearchEngineIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleDiscoveryEngineSearchEngineIamBinding.GoogleDiscoveryEngineSearchEngineIamBindingConfig",
		reflect.TypeOf((*GoogleDiscoveryEngineSearchEngineIamBindingConfig)(nil)).Elem(),
	)
}
