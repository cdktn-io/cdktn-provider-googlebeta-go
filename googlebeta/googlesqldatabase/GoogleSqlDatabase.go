...
func (g *jsiiProxy_GoogleSqlDatabase) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleSqlDatabase) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
