...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "sourceInstantSnapshotGroup", GoGetter: "SourceInstantSnapshotGroup"},
			_jsii_.MemberProperty{JsiiProperty: "sourceInstantSnapshotGroupId", GoGetter: "SourceInstantSnapshotGroupId"},
