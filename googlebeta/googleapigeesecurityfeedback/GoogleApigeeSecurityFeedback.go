...
func (j *jsiiProxy_GoogleApigeeSecurityFeedback) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleApigeeSecurityFeedback) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_apigee_security_feedback google_apigee_security_feedback} Resource.
...
func (j *jsiiProxy_GoogleApigeeSecurityFeedback)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleApigeeSecurityFeedback) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleApigeeSecurityFeedback) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleApigeeSecurityFeedback) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
