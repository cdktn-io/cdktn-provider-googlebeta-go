...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.35.0/docs/data-sources/google_compute_reservation_block google_compute_reservation_block} Data Source.
func NewDataGoogleComputeReservationBlock(scope constructs.Construct, id *string, config *DataGoogleComputeReservationBlockConfig) DataGoogleComputeReservationBlock {
	...
	_jsii_.Create(
		"@cdktn/provider-google-beta.dataGoogleComputeReservationBlock.DataGoogleComputeReservationBlock",
