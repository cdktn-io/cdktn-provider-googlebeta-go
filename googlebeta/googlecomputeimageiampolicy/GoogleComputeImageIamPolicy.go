...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googlecomputeimageiampolicy/internal"
...
func (j *jsiiProxy_GoogleComputeImageIamPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleComputeImageIamPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleComputeImageIamPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleComputeImageIamPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleComputeImageIamPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleComputeImageIamPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleComputeImageIamPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleComputeImageIamPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleComputeImageIamPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleComputeImageIamPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleComputeImageIamPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleComputeImageIamPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleComputeImageIamPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleComputeImageIamPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleComputeImageIamPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
