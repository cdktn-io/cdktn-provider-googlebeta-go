...
func (g *jsiiProxy_GoogleBigqueryJobCopyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleBigqueryJobCopyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
