...
func (g *jsiiProxy_GoogleBigqueryJob) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleBigqueryJob) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
