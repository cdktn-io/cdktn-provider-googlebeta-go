...
func (j *jsiiProxy_GoogleBackupDrRestoreWorkload) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleBackupDrRestoreWorkload) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleBackupDrRestoreWorkload) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleBackupDrRestoreWorkload) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleBackupDrRestoreWorkload) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleBackupDrRestoreWorkload)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleBackupDrRestoreWorkload)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleBackupDrRestoreWorkload)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleBackupDrRestoreWorkload_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleBackupDrRestoreWorkload) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleBackupDrRestoreWorkload) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleBackupDrRestoreWorkload) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleBackupDrRestoreWorkload) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleBackupDrRestoreWorkload) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleBackupDrRestoreWorkload) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
