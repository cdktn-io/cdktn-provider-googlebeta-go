...
func (g *jsiiProxy_GoogleDataplexZoneDiscoverySpecCsvOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDataplexZoneDiscoverySpecCsvOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
