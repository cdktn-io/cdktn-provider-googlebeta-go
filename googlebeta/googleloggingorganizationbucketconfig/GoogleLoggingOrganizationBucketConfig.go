...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googleloggingorganizationbucketconfig/internal"
...
func (j *jsiiProxy_GoogleLoggingOrganizationBucketConfig) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleLoggingOrganizationBucketConfig) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_logging_organization_bucket_config google_logging_organization_bucket_config} Resource.
...
func (j *jsiiProxy_GoogleLoggingOrganizationBucketConfig)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleLoggingOrganizationBucketConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleLoggingOrganizationBucketConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleLoggingOrganizationBucketConfig) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleLoggingOrganizationBucketConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
