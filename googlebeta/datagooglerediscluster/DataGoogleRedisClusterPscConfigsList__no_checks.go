...
func (d *jsiiProxy_DataGoogleRedisClusterPscConfigsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (d *jsiiProxy_DataGoogleRedisClusterPscConfigsList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataGoogleRedisClusterPscConfigsList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataGoogleRedisClusterPscConfigsList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
