...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "errorBudget", GoGetter: "ErrorBudget"},
			_jsii_.MemberProperty{JsiiProperty: "errorBudgetInput", GoGetter: "ErrorBudgetInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRolloutOrchestrationStrategy", GoMethod: "ResetRolloutOrchestrationStrategy"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberMethod{JsiiMethod: "resetUnitFilter", GoMethod: "ResetUnitFilter"},
			_jsii_.MemberMethod{JsiiMethod: "resetUpdateUnitKindStrategy", GoMethod: "ResetUpdateUnitKindStrategy"},
			_jsii_.MemberProperty{JsiiProperty: "rolloutKindId", GoGetter: "RolloutKindId"},
			_jsii_.MemberProperty{JsiiProperty: "rolloutKindIdInput", GoGetter: "RolloutKindIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "rolloutOrchestrationStrategy", GoGetter: "RolloutOrchestrationStrategy"},
			_jsii_.MemberProperty{JsiiProperty: "rolloutOrchestrationStrategyInput", GoGetter: "RolloutOrchestrationStrategyInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "unitFilter", GoGetter: "UnitFilter"},
			_jsii_.MemberProperty{JsiiProperty: "unitFilterInput", GoGetter: "UnitFilterInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "allowedCountInput", GoGetter: "AllowedCountInput"},
			_jsii_.MemberProperty{JsiiProperty: "allowedPercentage", GoGetter: "AllowedPercentage"},
			_jsii_.MemberProperty{JsiiProperty: "allowedPercentageInput", GoGetter: "AllowedPercentageInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetAllowedCount", GoMethod: "ResetAllowedCount"},
			_jsii_.MemberMethod{JsiiMethod: "resetAllowedPercentage", GoMethod: "ResetAllowedPercentage"},
