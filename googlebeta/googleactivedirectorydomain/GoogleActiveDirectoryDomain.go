...
func (j *jsiiProxy_GoogleActiveDirectoryDomain) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleActiveDirectoryDomain) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_active_directory_domain google_active_directory_domain} Resource.
...
func (j *jsiiProxy_GoogleActiveDirectoryDomain)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleActiveDirectoryDomain) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleActiveDirectoryDomain) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleActiveDirectoryDomain) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleActiveDirectoryDomain) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
