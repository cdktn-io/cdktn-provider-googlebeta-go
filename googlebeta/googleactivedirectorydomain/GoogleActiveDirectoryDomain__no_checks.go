...
func (g *jsiiProxy_GoogleActiveDirectoryDomain) validateMoveToIdParameters(id *string) error {
	return nil
}
...
func (j *jsiiProxy_GoogleActiveDirectoryDomain) validateSetDeletionPolicyParameters(val *string) error {
	return nil
}
