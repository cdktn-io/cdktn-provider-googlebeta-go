...
func (g *jsiiProxy_GoogleNotebooksInstance) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleNotebooksInstance) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleNotebooksInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
