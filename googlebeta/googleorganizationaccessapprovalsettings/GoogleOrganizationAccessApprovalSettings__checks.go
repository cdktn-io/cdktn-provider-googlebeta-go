...
func (g *jsiiProxy_GoogleOrganizationAccessApprovalSettings) validatePutEnrolledServicesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleOrganizationAccessApprovalSettingsEnrolledServices; received %#v (a %T)", value, value)
		}
	}
