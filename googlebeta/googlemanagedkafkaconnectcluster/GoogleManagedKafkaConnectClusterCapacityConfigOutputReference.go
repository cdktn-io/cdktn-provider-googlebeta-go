...
func (g *jsiiProxy_GoogleManagedKafkaConnectClusterCapacityConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleManagedKafkaConnectClusterCapacityConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
