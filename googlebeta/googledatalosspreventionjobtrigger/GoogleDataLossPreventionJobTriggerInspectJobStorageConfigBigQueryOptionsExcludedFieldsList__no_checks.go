...
func (g *jsiiProxy_GoogleDataLossPreventionJobTriggerInspectJobStorageConfigBigQueryOptionsExcludedFieldsList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
