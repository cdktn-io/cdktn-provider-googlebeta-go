...
func (g *jsiiProxy_GoogleDataLossPreventionJobTriggerInspectJobActionsOutputReference) validatePutPublishSummaryToCsccParameters(value *GoogleDataLossPreventionJobTriggerInspectJobActionsPublishSummaryToCscc) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(value, func() string { return "parameter value" }); err != nil {
...
func (j *jsiiProxy_GoogleDataLossPreventionJobTriggerInspectJobActionsOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *GoogleDataLossPreventionJobTriggerInspectJobActions; received %#v (a %T)", val, val)
		}
	}
