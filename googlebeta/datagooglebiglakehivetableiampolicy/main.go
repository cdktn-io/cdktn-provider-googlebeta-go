...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataGoogleBiglakeHiveTableIamPolicy)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.dataGoogleBiglakeHiveTableIamPolicy.DataGoogleBiglakeHiveTableIamPolicyConfig",
		reflect.TypeOf((*DataGoogleBiglakeHiveTableIamPolicyConfig)(nil)).Elem(),
	)
}
