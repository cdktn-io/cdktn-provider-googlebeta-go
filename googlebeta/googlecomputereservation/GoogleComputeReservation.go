...
type GoogleComputeReservation interface {
	...
	ParamsInput() *GoogleComputeReservationParams
	Project() *string
	...
	PutParams(value *GoogleComputeReservationParams)
...
func (j *jsiiProxy_GoogleComputeReservation) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleComputeReservation) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleComputeReservation) Params() GoogleComputeReservationParamsOutputReference {
	var returns GoogleComputeReservationParamsOutputReference
	_jsii_.Get(
		j,
		"params",
		&returns,
...
func (j *jsiiProxy_GoogleComputeReservation) ParamsInput() *GoogleComputeReservationParams {
...
func (j *jsiiProxy_GoogleComputeReservation) SatisfiesPzs() cdktn.IResolvable {
...
func (j *jsiiProxy_GoogleComputeReservation)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleComputeReservation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleComputeReservation) PutParams(value *GoogleComputeReservationParams) {
...
func (g *jsiiProxy_GoogleComputeReservation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleComputeReservation) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleComputeReservation) ResetParams() {
	_jsii_.InvokeVoid(
		g,
		"resetParams",
		nil, // no parameters
