...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleProjectIamBinding.GoogleProjectIamBindingCondition",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleProjectIamBinding.GoogleProjectIamBindingConfig",
