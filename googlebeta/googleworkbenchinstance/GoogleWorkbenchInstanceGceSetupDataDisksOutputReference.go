...
func (g *jsiiProxy_GoogleWorkbenchInstanceGceSetupDataDisksOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleWorkbenchInstanceGceSetupDataDisksOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
