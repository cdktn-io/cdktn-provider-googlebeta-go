...
func (g *jsiiProxy_GoogleWorkbenchInstanceGceSetupBootDiskOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleWorkbenchInstanceGceSetupBootDiskOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
