...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.dataGoogleArtifactRegistryPackages.DataGoogleArtifactRegistryPackagesConfig",
		reflect.TypeOf((*DataGoogleArtifactRegistryPackagesConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.dataGoogleArtifactRegistryPackages.DataGoogleArtifactRegistryPackagesPackages",
		reflect.TypeOf((*DataGoogleArtifactRegistryPackagesPackages)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.dataGoogleArtifactRegistryPackages.DataGoogleArtifactRegistryPackagesPackagesList",
