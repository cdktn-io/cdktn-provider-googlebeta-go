...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v19/datagoogleartifactregistrypackages/internal"
...
func (j *jsiiProxy_DataGoogleArtifactRegistryPackages) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryPackages) Filter() *string {
	var returns *string
	_jsii_.Get(
		j,
		"filter",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryPackages) FilterInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"filterInput",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryPackages) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryPackages) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryPackages) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryPackages) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryPackages) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryPackages) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryPackages) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleArtifactRegistryPackages) Packages() DataGoogleArtifactRegistryPackagesPackagesList {
	var returns DataGoogleArtifactRegistryPackagesPackagesList
	_jsii_.Get(
		j,
		"packages",
		&returns,
...
func (j *jsiiProxy_DataGoogleArtifactRegistryPackages) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryPackages) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryPackages) RepositoryId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"repositoryId",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryPackages) RepositoryIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"repositoryIdInput",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryPackages) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.32.0/docs/data-sources/google_artifact_registry_packages google_artifact_registry_packages} Data Source.
func NewDataGoogleArtifactRegistryPackages(scope constructs.Construct, id *string, config *DataGoogleArtifactRegistryPackagesConfig) DataGoogleArtifactRegistryPackages {
	...
	if err := validateNewDataGoogleArtifactRegistryPackagesParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataGoogleArtifactRegistryPackages{}

	_jsii_.Create(
		"@cdktn/provider-google-beta.dataGoogleArtifactRegistryPackages.DataGoogleArtifactRegistryPackages",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.32.0/docs/data-sources/google_artifact_registry_packages google_artifact_registry_packages} Data Source.
func NewDataGoogleArtifactRegistryPackages_Override(d DataGoogleArtifactRegistryPackages, scope constructs.Construct, id *string, config *DataGoogleArtifactRegistryPackagesConfig) {
	_init_.Initialize()
...
func DataGoogleArtifactRegistryPackages_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktn/provider-google-beta.dataGoogleArtifactRegistryPackages.DataGoogleArtifactRegistryPackages",
...
func (d *jsiiProxy_DataGoogleArtifactRegistryPackages) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryPackages) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryPackages) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryPackages) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryPackages) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryPackages) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryPackages) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryPackages) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryPackages) ResetFilter() {
	_jsii_.InvokeVoid(
		d,
		"resetFilter",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleArtifactRegistryPackages) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleArtifactRegistryPackages) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleArtifactRegistryPackages) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleArtifactRegistryPackages) ToString() *string {
	var returns *string
