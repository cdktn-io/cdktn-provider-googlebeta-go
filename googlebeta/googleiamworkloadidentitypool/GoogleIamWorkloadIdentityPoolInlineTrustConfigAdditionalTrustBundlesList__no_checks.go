...
func (g *jsiiProxy_GoogleIamWorkloadIdentityPoolInlineTrustConfigAdditionalTrustBundlesList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
