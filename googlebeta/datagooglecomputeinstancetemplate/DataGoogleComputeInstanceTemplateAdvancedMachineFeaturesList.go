...
func (j *jsiiProxy_DataGoogleComputeInstanceTemplateAdvancedMachineFeaturesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleComputeInstanceTemplateAdvancedMachineFeaturesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleComputeInstanceTemplateAdvancedMachineFeaturesList {
	_init_.Initialize()
...
func NewDataGoogleComputeInstanceTemplateAdvancedMachineFeaturesList_Override(d DataGoogleComputeInstanceTemplateAdvancedMachineFeaturesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComputeInstanceTemplateAdvancedMachineFeaturesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComputeInstanceTemplateAdvancedMachineFeaturesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComputeInstanceTemplateAdvancedMachineFeaturesList) Resolve(context cdktn.IResolveContext) interface{} {
