...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.dataGoogleComputeInstanceTemplate.DataGoogleComputeInstanceTemplateNetworkInterfaceAliasIpv6Range",
		reflect.TypeOf((*DataGoogleComputeInstanceTemplateNetworkInterfaceAliasIpv6Range)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.dataGoogleComputeInstanceTemplate.DataGoogleComputeInstanceTemplateNetworkInterfaceAliasIpv6RangeList",
		reflect.TypeOf((*DataGoogleComputeInstanceTemplateNetworkInterfaceAliasIpv6RangeList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
		...
		func() interface{} {
			j := jsiiProxy_DataGoogleComputeInstanceTemplateNetworkInterfaceAliasIpv6RangeList{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexList)
			return &j
		},
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataGoogleComputeInstanceTemplateNetworkInterfaceAliasIpv6RangeOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.dataGoogleComputeInstanceTemplate.DataGoogleComputeInstanceTemplateWorkloadIdentityConfig",
		reflect.TypeOf((*DataGoogleComputeInstanceTemplateWorkloadIdentityConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.dataGoogleComputeInstanceTemplate.DataGoogleComputeInstanceTemplateWorkloadIdentityConfigList",
	...
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.dataGoogleComputeInstanceTemplate.DataGoogleComputeInstanceTemplateWorkloadIdentityConfigOutputReference",
