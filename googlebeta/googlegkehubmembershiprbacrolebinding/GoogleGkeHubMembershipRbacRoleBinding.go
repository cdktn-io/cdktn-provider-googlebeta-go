...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googlegkehubmembershiprbacrolebinding/internal"
...
func (j *jsiiProxy_GoogleGkeHubMembershipRbacRoleBinding) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleGkeHubMembershipRbacRoleBinding) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleGkeHubMembershipRbacRoleBinding) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleGkeHubMembershipRbacRoleBinding) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleGkeHubMembershipRbacRoleBinding) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleGkeHubMembershipRbacRoleBinding) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleGkeHubMembershipRbacRoleBinding) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.43.0/docs/resources/google_gke_hub_membership_rbac_role_binding google_gke_hub_membership_rbac_role_binding} Resource.
...
func (j *jsiiProxy_GoogleGkeHubMembershipRbacRoleBinding)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_GoogleGkeHubMembershipRbacRoleBinding)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleGkeHubMembershipRbacRoleBinding)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleGkeHubMembershipRbacRoleBinding)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleGkeHubMembershipRbacRoleBinding_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleGkeHubMembershipRbacRoleBinding) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleGkeHubMembershipRbacRoleBinding) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleGkeHubMembershipRbacRoleBinding) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleGkeHubMembershipRbacRoleBinding) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleGkeHubMembershipRbacRoleBinding) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleGkeHubMembershipRbacRoleBinding) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleGkeHubMembershipRbacRoleBinding) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
