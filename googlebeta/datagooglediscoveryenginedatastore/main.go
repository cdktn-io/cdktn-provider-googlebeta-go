...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "aclEnabled", GoGetter: "AclEnabled"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "enableGetProcessedDocument", GoGetter: "EnableGetProcessedDocument"},
			_jsii_.MemberProperty{JsiiProperty: "enableImageAnnotation", GoGetter: "EnableImageAnnotation"},
			_jsii_.MemberProperty{JsiiProperty: "enableLlmLayoutParsing", GoGetter: "EnableLlmLayoutParsing"},
