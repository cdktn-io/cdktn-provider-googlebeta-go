...
func (j *jsiiProxy_GoogleSccV2OrganizationSccBigQueryExports) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleSccV2OrganizationSccBigQueryExports) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleSccV2OrganizationSccBigQueryExports)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleSccV2OrganizationSccBigQueryExports) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
