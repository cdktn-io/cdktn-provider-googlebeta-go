...
func (j *jsiiProxy_GoogleDataprocGdcSparkApplication) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleDataprocGdcSparkApplication) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_dataproc_gdc_spark_application google_dataproc_gdc_spark_application} Resource.
...
func (j *jsiiProxy_GoogleDataprocGdcSparkApplication)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleDataprocGdcSparkApplication) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
