...
func (g *jsiiProxy_GoogleIamWorkloadIdentityPoolProviderOidcOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleIamWorkloadIdentityPoolProviderOidcOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
