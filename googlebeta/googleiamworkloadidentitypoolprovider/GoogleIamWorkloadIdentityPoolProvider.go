...
func (j *jsiiProxy_GoogleIamWorkloadIdentityPoolProvider) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleIamWorkloadIdentityPoolProvider) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_iam_workload_identity_pool_provider google_iam_workload_identity_pool_provider} Resource.
...
func (j *jsiiProxy_GoogleIamWorkloadIdentityPoolProvider)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleIamWorkloadIdentityPoolProvider) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
