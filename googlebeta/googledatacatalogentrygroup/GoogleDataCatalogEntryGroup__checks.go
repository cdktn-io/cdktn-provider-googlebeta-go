...
func (j *jsiiProxy_GoogleDataCatalogEntryGroup) validateSetCountParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
...
func (j *jsiiProxy_GoogleDataCatalogEntryGroup) validateSetDeletionPolicyParameters(val *string) error {
	if val == nil {
