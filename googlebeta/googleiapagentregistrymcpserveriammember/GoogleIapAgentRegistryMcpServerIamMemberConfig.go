...
type GoogleIapAgentRegistryMcpServerIamMemberConfig struct {
	// Experimental.
	...
	Condition *GoogleIapAgentRegistryMcpServerIamMemberCondition `field:"optional" json:"condition" yaml:"condition"`
