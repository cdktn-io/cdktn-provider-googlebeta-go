...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleIapAgentRegistryMcpServerIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleIapAgentRegistryMcpServerIamMember.GoogleIapAgentRegistryMcpServerIamMemberCondition",
		reflect.TypeOf((*GoogleIapAgentRegistryMcpServerIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.googleIapAgentRegistryMcpServerIamMember.GoogleIapAgentRegistryMcpServerIamMemberConditionOutputReference",
		reflect.TypeOf((*GoogleIapAgentRegistryMcpServerIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_GoogleIapAgentRegistryMcpServerIamMemberConditionOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexObject)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleIapAgentRegistryMcpServerIamMember.GoogleIapAgentRegistryMcpServerIamMemberConfig",
		reflect.TypeOf((*GoogleIapAgentRegistryMcpServerIamMemberConfig)(nil)).Elem(),
	)
}
