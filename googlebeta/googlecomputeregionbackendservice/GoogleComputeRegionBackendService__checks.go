...
func (g *jsiiProxy_GoogleComputeRegionBackendService) validatePutBackendParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleComputeRegionBackendServiceBackend; received %#v (a %T)", value, value)
		}
	}
...
func (g *jsiiProxy_GoogleComputeRegionBackendService) validatePutCustomMetricsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleComputeRegionBackendServiceCustomMetrics; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_GoogleComputeRegionBackendService) validateSetDeletionPolicyParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
