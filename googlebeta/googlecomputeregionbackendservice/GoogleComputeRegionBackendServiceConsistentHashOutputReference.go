...
func (g *jsiiProxy_GoogleComputeRegionBackendServiceConsistentHashOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleComputeRegionBackendServiceConsistentHashOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
