...
func (g *jsiiProxy_GoogleComputeRegionBackendServiceCircuitBreakersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleComputeRegionBackendServiceCircuitBreakersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
