...
func (g *jsiiProxy_GoogleStorageInsightsReportConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleStorageInsightsReportConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
