...
func (g *jsiiProxy_GoogleStorageInsightsReportConfigCsvOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleStorageInsightsReportConfigCsvOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
