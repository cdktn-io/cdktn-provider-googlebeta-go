...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleProjectIamMember.GoogleProjectIamMemberCondition",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleProjectIamMember.GoogleProjectIamMemberConfig",
