...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleIapAgentRegistryAgentIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleIapAgentRegistryAgentIamBinding.GoogleIapAgentRegistryAgentIamBindingCondition",
		reflect.TypeOf((*GoogleIapAgentRegistryAgentIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleIapAgentRegistryAgentIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleIapAgentRegistryAgentIamBinding.GoogleIapAgentRegistryAgentIamBindingConfig",
		reflect.TypeOf((*GoogleIapAgentRegistryAgentIamBindingConfig)(nil)).Elem(),
	)
}
