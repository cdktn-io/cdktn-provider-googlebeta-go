...
func (g *jsiiProxy_GoogleGkeonpremVmwareNodePoolConfigVsphereConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleGkeonpremVmwareNodePoolConfigVsphereConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
