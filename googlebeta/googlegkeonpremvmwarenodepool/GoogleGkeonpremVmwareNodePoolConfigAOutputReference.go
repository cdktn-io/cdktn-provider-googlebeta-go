...
func (g *jsiiProxy_GoogleGkeonpremVmwareNodePoolConfigAOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleGkeonpremVmwareNodePoolConfigAOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
