...
func (j *jsiiProxy_GoogleCloudRunV2WorkerPool) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleCloudRunV2WorkerPool) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleCloudRunV2WorkerPool)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleCloudRunV2WorkerPool) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleCloudRunV2WorkerPool) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleCloudRunV2WorkerPool) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleCloudRunV2WorkerPool) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
