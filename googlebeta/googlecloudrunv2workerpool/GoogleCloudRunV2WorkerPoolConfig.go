...
type GoogleCloudRunV2WorkerPoolConfig struct {
	// Experimental.
	...
	Template *GoogleCloudRunV2WorkerPoolTemplate `field:"required" json:"template" yaml:"template"`
	...
	BinaryAuthorization *GoogleCloudRunV2WorkerPoolBinaryAuthorization `field:"optional" json:"binaryAuthorization" yaml:"binaryAuthorization"`
	...
	Scaling *GoogleCloudRunV2WorkerPoolScaling `field:"optional" json:"scaling" yaml:"scaling"`
	// timeouts block.
	//
	...
	Timeouts *GoogleCloudRunV2WorkerPoolTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}
