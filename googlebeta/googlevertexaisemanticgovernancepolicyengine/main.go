...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleVertexAiSemanticGovernancePolicyEngine)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*GoogleVertexAiSemanticGovernancePolicyEngineTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleVertexAiSemanticGovernancePolicyEngineTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
