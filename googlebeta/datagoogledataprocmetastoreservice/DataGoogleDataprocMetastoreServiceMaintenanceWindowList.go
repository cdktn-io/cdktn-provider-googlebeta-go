...
func (j *jsiiProxy_DataGoogleDataprocMetastoreServiceMaintenanceWindowList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleDataprocMetastoreServiceMaintenanceWindowList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleDataprocMetastoreServiceMaintenanceWindowList {
	_init_.Initialize()
...
func NewDataGoogleDataprocMetastoreServiceMaintenanceWindowList_Override(d DataGoogleDataprocMetastoreServiceMaintenanceWindowList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleDataprocMetastoreServiceMaintenanceWindowList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleDataprocMetastoreServiceMaintenanceWindowList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleDataprocMetastoreServiceMaintenanceWindowList) Resolve(context cdktn.IResolveContext) interface{} {
