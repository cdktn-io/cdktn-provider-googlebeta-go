...
func (j *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleComputeBackendServiceSignedUrlKey) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
