...
func (g *jsiiProxy_GoogleApigeeAddonsConfigAddonsConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleApigeeAddonsConfigAddonsConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
