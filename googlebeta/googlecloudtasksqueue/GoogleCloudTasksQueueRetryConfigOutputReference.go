...
func (g *jsiiProxy_GoogleCloudTasksQueueRetryConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleCloudTasksQueueRetryConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
