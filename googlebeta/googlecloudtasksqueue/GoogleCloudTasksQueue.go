...
func (j *jsiiProxy_GoogleCloudTasksQueue) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleCloudTasksQueue) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.44.0/docs/resources/google_cloud_tasks_queue google_cloud_tasks_queue} Resource.
...
func (j *jsiiProxy_GoogleCloudTasksQueue)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleCloudTasksQueue) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleCloudTasksQueue) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleCloudTasksQueue) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
