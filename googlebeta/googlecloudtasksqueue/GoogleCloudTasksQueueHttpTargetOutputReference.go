...
func (g *jsiiProxy_GoogleCloudTasksQueueHttpTargetOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleCloudTasksQueueHttpTargetOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
