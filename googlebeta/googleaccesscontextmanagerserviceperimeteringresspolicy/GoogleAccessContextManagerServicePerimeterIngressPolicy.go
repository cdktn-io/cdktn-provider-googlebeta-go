...
func (j *jsiiProxy_GoogleAccessContextManagerServicePerimeterIngressPolicy) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleAccessContextManagerServicePerimeterIngressPolicy) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_access_context_manager_service_perimeter_ingress_policy google_access_context_manager_service_perimeter_ingress_policy} Resource.
...
func (j *jsiiProxy_GoogleAccessContextManagerServicePerimeterIngressPolicy)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleAccessContextManagerServicePerimeterIngressPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleAccessContextManagerServicePerimeterIngressPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleAccessContextManagerServicePerimeterIngressPolicy) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
