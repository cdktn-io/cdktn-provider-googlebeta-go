...
func (j *jsiiProxy_GoogleApigeeOrganization) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleApigeeOrganization) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.45.0/docs/resources/google_apigee_organization google_apigee_organization} Resource.
...
func (j *jsiiProxy_GoogleApigeeOrganization)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleApigeeOrganization) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleApigeeOrganization) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleApigeeOrganization) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleApigeeOrganization) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
