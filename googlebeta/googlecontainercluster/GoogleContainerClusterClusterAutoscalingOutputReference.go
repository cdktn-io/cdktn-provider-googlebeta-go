...
func (g *jsiiProxy_GoogleContainerClusterClusterAutoscalingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleContainerClusterClusterAutoscalingOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
