...
func (g *jsiiProxy_GoogleContainerClusterNodePoolNodeConfigBootDiskOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleContainerClusterNodePoolNodeConfigBootDiskOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
