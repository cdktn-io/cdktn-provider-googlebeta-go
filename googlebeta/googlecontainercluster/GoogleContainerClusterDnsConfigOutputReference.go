...
func (g *jsiiProxy_GoogleContainerClusterDnsConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleContainerClusterDnsConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
