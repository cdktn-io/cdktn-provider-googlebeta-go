...
func (g *jsiiProxy_GoogleContainerClusterIpAllocationPolicyAdditionalIpRangesConfigList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_GoogleContainerClusterIpAllocationPolicyAdditionalIpRangesConfigList) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *[]*GoogleContainerClusterIpAllocationPolicyAdditionalIpRangesConfig; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_GoogleContainerClusterIpAllocationPolicyAdditionalIpRangesConfigList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewGoogleContainerClusterIpAllocationPolicyAdditionalIpRangesConfigListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
