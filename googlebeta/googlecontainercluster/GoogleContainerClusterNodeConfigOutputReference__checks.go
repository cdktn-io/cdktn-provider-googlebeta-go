...
func (g *jsiiProxy_GoogleContainerClusterNodeConfigOutputReference) validatePutBootDiskParameters(value *GoogleContainerClusterNodeConfigBootDisk) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(value, func() string { return "parameter value" }); err != nil {
...
func (g *jsiiProxy_GoogleContainerClusterNodeConfigOutputReference) validatePutNodeImageConfigParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*GoogleContainerClusterNodeConfigNodeImageConfig:
		value := value.(*[]*GoogleContainerClusterNodeConfigNodeImageConfig)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*GoogleContainerClusterNodeConfigNodeImageConfig:
		value_ := value.([]*GoogleContainerClusterNodeConfigNodeImageConfig)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleContainerClusterNodeConfigNodeImageConfig; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_GoogleContainerClusterNodeConfigOutputReference) validateSetGpudirectStrategyParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
