...
func (g *jsiiProxy_GoogleContainerClusterMaintenancePolicyRecurringWindowOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleContainerClusterMaintenancePolicyRecurringWindowOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
