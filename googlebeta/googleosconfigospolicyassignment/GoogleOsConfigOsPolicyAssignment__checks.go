...
func (g *jsiiProxy_GoogleOsConfigOsPolicyAssignment) validatePutOsPoliciesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleOsConfigOsPolicyAssignmentOsPolicies; received %#v (a %T)", value, value)
		}
	}
