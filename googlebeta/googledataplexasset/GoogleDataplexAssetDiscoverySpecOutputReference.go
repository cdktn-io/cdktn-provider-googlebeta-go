...
func (g *jsiiProxy_GoogleDataplexAssetDiscoverySpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDataplexAssetDiscoverySpecOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
