...
func (g *jsiiProxy_GoogleSpannerBackupScheduleEncryptionConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleSpannerBackupScheduleEncryptionConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
