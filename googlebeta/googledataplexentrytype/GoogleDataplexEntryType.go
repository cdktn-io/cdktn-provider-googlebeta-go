...
func (j *jsiiProxy_GoogleDataplexEntryType) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleDataplexEntryType) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleDataplexEntryType) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleDataplexEntryType) EffectiveLabels() cdktn.StringMap {
...
func (j *jsiiProxy_GoogleDataplexEntryType) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleDataplexEntryType) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleDataplexEntryType) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleDataplexEntryType) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleDataplexEntryType) TerraformLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
func (j *jsiiProxy_GoogleDataplexEntryType)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_GoogleDataplexEntryType)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleDataplexEntryType)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleDataplexEntryType)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleDataplexEntryType_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleDataplexEntryType) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleDataplexEntryType) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleDataplexEntryType) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleDataplexEntryType) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleDataplexEntryType) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleDataplexEntryType) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleDataplexEntryType) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
