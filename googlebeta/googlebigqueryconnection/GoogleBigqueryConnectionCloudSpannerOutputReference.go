...
func (g *jsiiProxy_GoogleBigqueryConnectionCloudSpannerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleBigqueryConnectionCloudSpannerOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
