...
func (j *jsiiProxy_GoogleSccV2OrganizationMuteConfig) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleSccV2OrganizationMuteConfig) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleSccV2OrganizationMuteConfig) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleSccV2OrganizationMuteConfig) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleSccV2OrganizationMuteConfig) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleSccV2OrganizationMuteConfig) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleSccV2OrganizationMuteConfig) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleSccV2OrganizationMuteConfig)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_GoogleSccV2OrganizationMuteConfig)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleSccV2OrganizationMuteConfig)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleSccV2OrganizationMuteConfig)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleSccV2OrganizationMuteConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleSccV2OrganizationMuteConfig) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleSccV2OrganizationMuteConfig) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleSccV2OrganizationMuteConfig) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleSccV2OrganizationMuteConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleSccV2OrganizationMuteConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleSccV2OrganizationMuteConfig) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleSccV2OrganizationMuteConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
