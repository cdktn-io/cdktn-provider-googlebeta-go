...
func (j *jsiiProxy_GoogleDialogflowCxGenerator) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleDialogflowCxGenerator) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleDialogflowCxGenerator)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleDialogflowCxGenerator) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleDialogflowCxGenerator) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleDialogflowCxGenerator) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleDialogflowCxGenerator) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
