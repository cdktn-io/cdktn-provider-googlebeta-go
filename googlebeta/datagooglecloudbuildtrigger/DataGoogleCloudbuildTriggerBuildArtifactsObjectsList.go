...
func (j *jsiiProxy_DataGoogleCloudbuildTriggerBuildArtifactsObjectsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleCloudbuildTriggerBuildArtifactsObjectsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleCloudbuildTriggerBuildArtifactsObjectsList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-google-beta.dataGoogleCloudbuildTrigger.DataGoogleCloudbuildTriggerBuildArtifactsObjectsList",
...
func NewDataGoogleCloudbuildTriggerBuildArtifactsObjectsList_Override(d DataGoogleCloudbuildTriggerBuildArtifactsObjectsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleCloudbuildTriggerBuildArtifactsObjectsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleCloudbuildTriggerBuildArtifactsObjectsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleCloudbuildTriggerBuildArtifactsObjectsList) Resolve(context cdktn.IResolveContext) interface{} {
