...
func (j *jsiiProxy_GoogleApigeeSharedflow) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleApigeeSharedflow) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleApigeeSharedflow)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleApigeeSharedflow) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleApigeeSharedflow) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleApigeeSharedflow) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleApigeeSharedflow) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
