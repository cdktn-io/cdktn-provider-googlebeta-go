...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.dataGoogleServiceAccountKey.DataGoogleServiceAccountKey",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.dataGoogleServiceAccountKey.DataGoogleServiceAccountKeyConfig",
