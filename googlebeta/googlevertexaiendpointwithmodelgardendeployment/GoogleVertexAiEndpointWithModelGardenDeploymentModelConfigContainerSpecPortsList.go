...
func (j *jsiiProxy_GoogleVertexAiEndpointWithModelGardenDeploymentModelConfigContainerSpecPortsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleVertexAiEndpointWithModelGardenDeploymentModelConfigContainerSpecPortsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleVertexAiEndpointWithModelGardenDeploymentModelConfigContainerSpecPortsList {
	_init_.Initialize()
...
func NewGoogleVertexAiEndpointWithModelGardenDeploymentModelConfigContainerSpecPortsList_Override(g GoogleVertexAiEndpointWithModelGardenDeploymentModelConfigContainerSpecPortsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleVertexAiEndpointWithModelGardenDeploymentModelConfigContainerSpecPortsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleVertexAiEndpointWithModelGardenDeploymentModelConfigContainerSpecPortsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleVertexAiEndpointWithModelGardenDeploymentModelConfigContainerSpecPortsList) Resolve(context cdktf.IResolveContext) interface{} {
