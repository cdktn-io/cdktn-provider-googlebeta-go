...
func (g *jsiiProxy_GoogleVertexAiEndpointWithModelGardenDeploymentModelConfigContainerSpecPortsList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
