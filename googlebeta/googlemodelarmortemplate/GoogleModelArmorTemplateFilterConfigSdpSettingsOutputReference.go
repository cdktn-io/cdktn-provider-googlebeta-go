...
func (g *jsiiProxy_GoogleModelArmorTemplateFilterConfigSdpSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleModelArmorTemplateFilterConfigSdpSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
