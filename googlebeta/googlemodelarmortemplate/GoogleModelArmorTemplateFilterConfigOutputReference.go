...
func (g *jsiiProxy_GoogleModelArmorTemplateFilterConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleModelArmorTemplateFilterConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
