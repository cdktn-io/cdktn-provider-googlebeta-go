...
func (g *jsiiProxy_GoogleFirebaseAppHostingBuildSourceCodebaseOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleFirebaseAppHostingBuildSourceCodebaseOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
