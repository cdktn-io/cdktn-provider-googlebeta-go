...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googlecontactcenterinsightsautolabelingrule/internal"
...
func (j *jsiiProxy_GoogleContactCenterInsightsAutoLabelingRule) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleContactCenterInsightsAutoLabelingRule) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.43.0/docs/resources/google_contact_center_insights_auto_labeling_rule google_contact_center_insights_auto_labeling_rule} Resource.
...
func (j *jsiiProxy_GoogleContactCenterInsightsAutoLabelingRule)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleContactCenterInsightsAutoLabelingRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleContactCenterInsightsAutoLabelingRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleContactCenterInsightsAutoLabelingRule) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
