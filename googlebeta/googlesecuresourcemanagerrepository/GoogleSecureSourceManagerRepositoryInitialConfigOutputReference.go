...
func (g *jsiiProxy_GoogleSecureSourceManagerRepositoryInitialConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleSecureSourceManagerRepositoryInitialConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
