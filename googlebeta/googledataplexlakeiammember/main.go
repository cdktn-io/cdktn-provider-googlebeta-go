...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleDataplexLakeIamMember.GoogleDataplexLakeIamMemberCondition",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleDataplexLakeIamMember.GoogleDataplexLakeIamMemberConfig",
