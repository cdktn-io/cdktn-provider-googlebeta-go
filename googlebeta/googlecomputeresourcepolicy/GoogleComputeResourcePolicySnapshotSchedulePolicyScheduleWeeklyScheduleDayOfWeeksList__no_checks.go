...
func (g *jsiiProxy_GoogleComputeResourcePolicySnapshotSchedulePolicyScheduleWeeklyScheduleDayOfWeeksList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
