...
func (j *jsiiProxy_GoogleSccFolderSccBigQueryExport) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleSccFolderSccBigQueryExport) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleSccFolderSccBigQueryExport)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleSccFolderSccBigQueryExport) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleSccFolderSccBigQueryExport) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleSccFolderSccBigQueryExport) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleSccFolderSccBigQueryExport) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
