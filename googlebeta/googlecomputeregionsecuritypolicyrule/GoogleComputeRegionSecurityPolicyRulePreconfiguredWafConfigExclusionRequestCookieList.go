...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicyRulePreconfiguredWafConfigExclusionRequestCookieList) Resolve(context cdktf.IResolveContext) interface{} {
