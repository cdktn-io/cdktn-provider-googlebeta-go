...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicyRuleNetworkMatchOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleComputeRegionSecurityPolicyRuleNetworkMatchOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
