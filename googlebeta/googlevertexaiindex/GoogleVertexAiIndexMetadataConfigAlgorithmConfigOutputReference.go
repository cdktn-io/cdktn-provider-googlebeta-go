...
func (g *jsiiProxy_GoogleVertexAiIndexMetadataConfigAlgorithmConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleVertexAiIndexMetadataConfigAlgorithmConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
