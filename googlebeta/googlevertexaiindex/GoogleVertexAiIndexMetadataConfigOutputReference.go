...
func (g *jsiiProxy_GoogleVertexAiIndexMetadataConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleVertexAiIndexMetadataConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
