...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.dataGoogleOracleDatabaseOdbSubnet.DataGoogleOracleDatabaseOdbSubnet",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.dataGoogleOracleDatabaseOdbSubnet.DataGoogleOracleDatabaseOdbSubnetConfig",
