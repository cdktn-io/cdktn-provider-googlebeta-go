...
func (j *jsiiProxy_DataGoogleComputeRegionInstanceGroupManagerStatusAllInstancesConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleComputeRegionInstanceGroupManagerStatusAllInstancesConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleComputeRegionInstanceGroupManagerStatusAllInstancesConfigList {
	_init_.Initialize()
...
func NewDataGoogleComputeRegionInstanceGroupManagerStatusAllInstancesConfigList_Override(d DataGoogleComputeRegionInstanceGroupManagerStatusAllInstancesConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComputeRegionInstanceGroupManagerStatusAllInstancesConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComputeRegionInstanceGroupManagerStatusAllInstancesConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComputeRegionInstanceGroupManagerStatusAllInstancesConfigList) Resolve(context cdktn.IResolveContext) interface{} {
