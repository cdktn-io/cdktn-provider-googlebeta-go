...
func (j *jsiiProxy_DataGoogleComputeRegionInstanceGroupManager) Params() DataGoogleComputeRegionInstanceGroupManagerParamsList {
	var returns DataGoogleComputeRegionInstanceGroupManagerParamsList
	_jsii_.Get(
		j,
		"params",
		&returns,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.32.0/docs/data-sources/google_compute_region_instance_group_manager google_compute_region_instance_group_manager} Data Source.
