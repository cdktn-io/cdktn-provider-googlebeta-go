...
func (g *jsiiProxy_GoogleMonitoringUptimeCheckConfig) validatePutContentMatchersParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleMonitoringUptimeCheckConfigContentMatchers; received %#v (a %T)", value, value)
		}
	}
