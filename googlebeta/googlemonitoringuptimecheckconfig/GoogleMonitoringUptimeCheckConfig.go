...
func (j *jsiiProxy_GoogleMonitoringUptimeCheckConfig) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleMonitoringUptimeCheckConfig) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.44.0/docs/resources/google_monitoring_uptime_check_config google_monitoring_uptime_check_config} Resource.
...
func (j *jsiiProxy_GoogleMonitoringUptimeCheckConfig)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleMonitoringUptimeCheckConfig) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
