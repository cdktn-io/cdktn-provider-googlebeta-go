...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleSccSourceIamBinding.GoogleSccSourceIamBindingCondition",
		reflect.TypeOf((*GoogleSccSourceIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.googleSccSourceIamBinding.GoogleSccSourceIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleSccSourceIamBinding.GoogleSccSourceIamBindingConfig",
