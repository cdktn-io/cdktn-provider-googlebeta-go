...
func (g *jsiiProxy_GoogleBigtableAuthorizedViewSubsetViewOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleBigtableAuthorizedViewSubsetViewOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
