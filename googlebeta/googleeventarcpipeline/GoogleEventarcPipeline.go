...
func (j *jsiiProxy_GoogleEventarcPipeline) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleEventarcPipeline) EffectiveAnnotations() cdktn.StringMap {
...
func (j *jsiiProxy_GoogleEventarcPipeline) EffectiveLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"effectiveLabels",
...
func (j *jsiiProxy_GoogleEventarcPipeline) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleEventarcPipeline) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleEventarcPipeline) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleEventarcPipeline) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleEventarcPipeline) TerraformLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.45.0/docs/resources/google_eventarc_pipeline google_eventarc_pipeline} Resource.
...
func (j *jsiiProxy_GoogleEventarcPipeline)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleEventarcPipeline)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleEventarcPipeline)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleEventarcPipeline_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleEventarcPipeline) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleEventarcPipeline) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleEventarcPipeline) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleEventarcPipeline) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleEventarcPipeline) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleEventarcPipeline) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
