...
func (g *jsiiProxy_GoogleEventarcPipelineInputPayloadFormatOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleEventarcPipelineInputPayloadFormatOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
