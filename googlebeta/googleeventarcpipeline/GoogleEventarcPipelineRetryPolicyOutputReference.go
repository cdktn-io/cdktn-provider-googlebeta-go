...
func (g *jsiiProxy_GoogleEventarcPipelineRetryPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleEventarcPipelineRetryPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
