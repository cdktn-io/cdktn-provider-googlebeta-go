...
func (g *jsiiProxy_GoogleEventarcPipelineDestinationsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleEventarcPipelineDestinationsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
