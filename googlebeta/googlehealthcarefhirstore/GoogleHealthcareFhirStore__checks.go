...
func (g *jsiiProxy_GoogleHealthcareFhirStore) validatePutNotificationConfigsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleHealthcareFhirStoreNotificationConfigs; received %#v (a %T)", value, value)
		}
	}
...
func (g *jsiiProxy_GoogleHealthcareFhirStore) validatePutStreamConfigsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleHealthcareFhirStoreStreamConfigs; received %#v (a %T)", value, value)
		}
	}
