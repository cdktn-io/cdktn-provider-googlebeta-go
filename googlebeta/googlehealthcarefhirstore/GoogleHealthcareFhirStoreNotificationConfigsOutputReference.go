...
func (g *jsiiProxy_GoogleHealthcareFhirStoreNotificationConfigsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleHealthcareFhirStoreNotificationConfigsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
