...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleSqlProvisionScript)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleSqlProvisionScript.GoogleSqlProvisionScriptConfig",
		reflect.TypeOf((*GoogleSqlProvisionScriptConfig)(nil)).Elem(),
	)
}
