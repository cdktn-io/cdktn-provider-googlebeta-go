...
func (g *jsiiProxy_GoogleComputeWireGroupWirePropertiesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleComputeWireGroupWirePropertiesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
