...
func (g *jsiiProxy_GoogleDataplexTaskTriggerSpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDataplexTaskTriggerSpecOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
