...
func (g *jsiiProxy_GoogleDataplexTaskSparkInfrastructureSpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDataplexTaskSparkInfrastructureSpecOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
