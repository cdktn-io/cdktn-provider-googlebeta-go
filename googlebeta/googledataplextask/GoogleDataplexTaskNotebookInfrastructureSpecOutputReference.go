...
func (g *jsiiProxy_GoogleDataplexTaskNotebookInfrastructureSpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDataplexTaskNotebookInfrastructureSpecOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
