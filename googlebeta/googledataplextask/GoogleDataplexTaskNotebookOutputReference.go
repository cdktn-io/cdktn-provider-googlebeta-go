...
func (g *jsiiProxy_GoogleDataplexTaskNotebookOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDataplexTaskNotebookOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
