...
func (j *jsiiProxy_GoogleComputeGlobalForwardingRule) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleComputeGlobalForwardingRule) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.43.0/docs/resources/google_compute_global_forwarding_rule google_compute_global_forwarding_rule} Resource.
...
func (j *jsiiProxy_GoogleComputeGlobalForwardingRule)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleComputeGlobalForwardingRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleComputeGlobalForwardingRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleComputeGlobalForwardingRule) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
