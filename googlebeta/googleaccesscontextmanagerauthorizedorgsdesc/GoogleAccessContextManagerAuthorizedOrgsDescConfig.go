...
type GoogleAccessContextManagerAuthorizedOrgsDescConfig struct {
	// Experimental.
	...
	Timeouts *GoogleAccessContextManagerAuthorizedOrgsDescTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}
