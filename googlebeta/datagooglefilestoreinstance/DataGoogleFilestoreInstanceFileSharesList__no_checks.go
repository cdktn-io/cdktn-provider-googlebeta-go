...
func (d *jsiiProxy_DataGoogleFilestoreInstanceFileSharesList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (d *jsiiProxy_DataGoogleFilestoreInstanceFileSharesList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataGoogleFilestoreInstanceFileSharesList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataGoogleFilestoreInstanceFileSharesList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
