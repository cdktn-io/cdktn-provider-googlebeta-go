...
func (j *jsiiProxy_DataGoogleFilestoreInstance) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.45.0/docs/data-sources/google_filestore_instance google_filestore_instance} Data Source.
