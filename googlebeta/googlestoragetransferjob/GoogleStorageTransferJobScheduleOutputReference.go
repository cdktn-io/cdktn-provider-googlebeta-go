...
func (g *jsiiProxy_GoogleStorageTransferJobScheduleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleStorageTransferJobScheduleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
