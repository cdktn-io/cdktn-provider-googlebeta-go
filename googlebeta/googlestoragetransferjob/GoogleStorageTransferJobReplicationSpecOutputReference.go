...
func (g *jsiiProxy_GoogleStorageTransferJobReplicationSpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleStorageTransferJobReplicationSpecOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
