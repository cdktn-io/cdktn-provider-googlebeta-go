...
func (g *jsiiProxy_GoogleStorageTransferJobTransferSpecObjectConditionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleStorageTransferJobTransferSpecObjectConditionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
