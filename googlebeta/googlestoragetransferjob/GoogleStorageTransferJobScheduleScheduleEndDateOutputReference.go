...
func (g *jsiiProxy_GoogleStorageTransferJobScheduleScheduleEndDateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleStorageTransferJobScheduleScheduleEndDateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
