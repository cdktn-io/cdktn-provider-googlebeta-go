...
type GoogleStorageTransferJobTransferSpec struct {
	...
	AwsS3CompatibleDataSource *GoogleStorageTransferJobTransferSpecAwsS3CompatibleDataSource `field:"optional" json:"awsS3CompatibleDataSource" yaml:"awsS3CompatibleDataSource"`
	...
	TransferManifest *GoogleStorageTransferJobTransferSpecTransferManifest `field:"optional" json:"transferManifest" yaml:"transferManifest"`
