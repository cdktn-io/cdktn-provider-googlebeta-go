...
func (g *jsiiProxy_GoogleNetworkServicesGrpcRouteRulesActionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleNetworkServicesGrpcRouteRulesActionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
