...
func (g *jsiiProxy_GoogleNetworkServicesGrpcRouteRulesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleNetworkServicesGrpcRouteRulesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
