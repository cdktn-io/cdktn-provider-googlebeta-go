...
func (j *jsiiProxy_GoogleRecaptchaEnterpriseKey) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleRecaptchaEnterpriseKey) EffectiveLabels() cdktn.StringMap {
...
func (j *jsiiProxy_GoogleRecaptchaEnterpriseKey) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleRecaptchaEnterpriseKey) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleRecaptchaEnterpriseKey) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleRecaptchaEnterpriseKey) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleRecaptchaEnterpriseKey) TerraformLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.1/docs/resources/google_recaptcha_enterprise_key google_recaptcha_enterprise_key} Resource.
...
func (j *jsiiProxy_GoogleRecaptchaEnterpriseKey)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleRecaptchaEnterpriseKey)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleRecaptchaEnterpriseKey)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleRecaptchaEnterpriseKey_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleRecaptchaEnterpriseKey) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleRecaptchaEnterpriseKey) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleRecaptchaEnterpriseKey) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleRecaptchaEnterpriseKey) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleRecaptchaEnterpriseKey) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleRecaptchaEnterpriseKey) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
