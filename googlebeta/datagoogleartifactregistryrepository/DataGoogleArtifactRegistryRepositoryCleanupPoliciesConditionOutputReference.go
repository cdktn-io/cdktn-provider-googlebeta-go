...
func (j *jsiiProxy_DataGoogleArtifactRegistryRepositoryCleanupPoliciesConditionOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleArtifactRegistryRepositoryCleanupPoliciesConditionOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataGoogleArtifactRegistryRepositoryCleanupPoliciesConditionOutputReference {
	_init_.Initialize()
...
func NewDataGoogleArtifactRegistryRepositoryCleanupPoliciesConditionOutputReference_Override(d DataGoogleArtifactRegistryRepositoryCleanupPoliciesConditionOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleArtifactRegistryRepositoryCleanupPoliciesConditionOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryRepositoryCleanupPoliciesConditionOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryRepositoryCleanupPoliciesConditionOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataGoogleArtifactRegistryRepositoryCleanupPoliciesConditionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryRepositoryCleanupPoliciesConditionOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
