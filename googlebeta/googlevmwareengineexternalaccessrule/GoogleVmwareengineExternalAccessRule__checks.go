...
func (g *jsiiProxy_GoogleVmwareengineExternalAccessRule) validatePutDestinationIpRangesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleVmwareengineExternalAccessRuleDestinationIpRanges; received %#v (a %T)", value, value)
		}
	}
...
func (g *jsiiProxy_GoogleVmwareengineExternalAccessRule) validatePutSourceIpRangesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleVmwareengineExternalAccessRuleSourceIpRanges; received %#v (a %T)", value, value)
		}
	}
