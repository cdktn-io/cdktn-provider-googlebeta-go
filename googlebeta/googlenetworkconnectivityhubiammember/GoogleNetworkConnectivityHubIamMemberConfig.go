...
type GoogleNetworkConnectivityHubIamMemberConfig struct {
	// Experimental.
	...
	Condition *GoogleNetworkConnectivityHubIamMemberCondition `field:"optional" json:"condition" yaml:"condition"`
