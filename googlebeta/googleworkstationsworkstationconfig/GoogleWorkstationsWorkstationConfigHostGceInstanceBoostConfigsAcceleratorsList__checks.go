...
func (g *jsiiProxy_GoogleWorkstationsWorkstationConfigHostGceInstanceBoostConfigsAcceleratorsList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
