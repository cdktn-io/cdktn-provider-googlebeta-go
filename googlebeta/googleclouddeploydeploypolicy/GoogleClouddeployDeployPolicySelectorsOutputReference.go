...
func (g *jsiiProxy_GoogleClouddeployDeployPolicySelectorsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleClouddeployDeployPolicySelectorsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
