...
func (j *jsiiProxy_DataGoogleComposerEnvironmentConfigWebServerNetworkAccessControlList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleComposerEnvironmentConfigWebServerNetworkAccessControlList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleComposerEnvironmentConfigWebServerNetworkAccessControlList {
	_init_.Initialize()
...
func NewDataGoogleComposerEnvironmentConfigWebServerNetworkAccessControlList_Override(d DataGoogleComposerEnvironmentConfigWebServerNetworkAccessControlList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComposerEnvironmentConfigWebServerNetworkAccessControlList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComposerEnvironmentConfigWebServerNetworkAccessControlList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComposerEnvironmentConfigWebServerNetworkAccessControlList) Resolve(context cdktn.IResolveContext) interface{} {
