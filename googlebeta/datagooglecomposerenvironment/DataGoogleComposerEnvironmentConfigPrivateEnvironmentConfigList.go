...
func (j *jsiiProxy_DataGoogleComposerEnvironmentConfigPrivateEnvironmentConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleComposerEnvironmentConfigPrivateEnvironmentConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleComposerEnvironmentConfigPrivateEnvironmentConfigList {
	_init_.Initialize()
...
func NewDataGoogleComposerEnvironmentConfigPrivateEnvironmentConfigList_Override(d DataGoogleComposerEnvironmentConfigPrivateEnvironmentConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComposerEnvironmentConfigPrivateEnvironmentConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComposerEnvironmentConfigPrivateEnvironmentConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComposerEnvironmentConfigPrivateEnvironmentConfigList) Resolve(context cdktn.IResolveContext) interface{} {
