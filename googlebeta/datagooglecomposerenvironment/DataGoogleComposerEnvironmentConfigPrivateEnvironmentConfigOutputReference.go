...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v17/datagooglecomposerenvironment/internal"
...
type DataGoogleComposerEnvironmentConfigPrivateEnvironmentConfigOutputReference interface {
	...
	EnablePrivateEndpoint() cdktn.IResolvable
	EnablePrivatelyUsedPublicIps() cdktn.IResolvable
	// Experimental.
	Fqn() *string
...
func (j *jsiiProxy_DataGoogleComposerEnvironmentConfigPrivateEnvironmentConfigOutputReference) EnablePrivateEndpoint() cdktn.IResolvable {
...
func (j *jsiiProxy_DataGoogleComposerEnvironmentConfigPrivateEnvironmentConfigOutputReference) EnablePrivatelyUsedPublicIps() cdktn.IResolvable {
	var returns cdktn.IResolvable
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleComposerEnvironmentConfigPrivateEnvironmentConfigOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleComposerEnvironmentConfigPrivateEnvironmentConfigOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataGoogleComposerEnvironmentConfigPrivateEnvironmentConfigOutputReference {
	_init_.Initialize()
...
func NewDataGoogleComposerEnvironmentConfigPrivateEnvironmentConfigOutputReference_Override(d DataGoogleComposerEnvironmentConfigPrivateEnvironmentConfigOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComposerEnvironmentConfigPrivateEnvironmentConfigOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComposerEnvironmentConfigPrivateEnvironmentConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleComposerEnvironmentConfigPrivateEnvironmentConfigOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataGoogleComposerEnvironmentConfigPrivateEnvironmentConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleComposerEnvironmentConfigPrivateEnvironmentConfigOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
