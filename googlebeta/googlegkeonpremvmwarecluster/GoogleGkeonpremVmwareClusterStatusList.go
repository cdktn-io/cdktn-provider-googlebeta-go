...
func (j *jsiiProxy_GoogleGkeonpremVmwareClusterStatusList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGoogleGkeonpremVmwareClusterStatusList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleGkeonpremVmwareClusterStatusList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-google-beta.googleGkeonpremVmwareCluster.GoogleGkeonpremVmwareClusterStatusList",
...
func NewGoogleGkeonpremVmwareClusterStatusList_Override(g GoogleGkeonpremVmwareClusterStatusList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleGkeonpremVmwareClusterStatusList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleGkeonpremVmwareClusterStatusList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleGkeonpremVmwareClusterStatusList) Resolve(context cdktn.IResolveContext) interface{} {
