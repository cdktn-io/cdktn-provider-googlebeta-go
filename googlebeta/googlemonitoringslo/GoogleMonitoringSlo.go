...
func (g *jsiiProxy_GoogleMonitoringSlo) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleMonitoringSlo) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
