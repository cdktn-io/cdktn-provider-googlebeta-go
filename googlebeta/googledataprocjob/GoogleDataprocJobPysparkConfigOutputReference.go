...
func (g *jsiiProxy_GoogleDataprocJobPysparkConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDataprocJobPysparkConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
