...
func (g *jsiiProxy_GoogleDataprocJobSparkConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDataprocJobSparkConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
