...
func (g *jsiiProxy_GoogleDataprocJobHiveConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDataprocJobHiveConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
