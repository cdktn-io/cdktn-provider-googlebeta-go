...
func (g *jsiiProxy_GooglePrivatecaCertificateAuthorityConfigX509ConfigKeyUsageUnknownExtendedKeyUsagesList) Resolve(context cdktf.IResolveContext) interface{} {
