...
func (j *jsiiProxy_GooglePrivatecaCertificateAuthority) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GooglePrivatecaCertificateAuthority) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_privateca_certificate_authority google_privateca_certificate_authority} Resource.
...
func (j *jsiiProxy_GooglePrivatecaCertificateAuthority)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GooglePrivatecaCertificateAuthority) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GooglePrivatecaCertificateAuthority) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GooglePrivatecaCertificateAuthority) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GooglePrivatecaCertificateAuthority) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
