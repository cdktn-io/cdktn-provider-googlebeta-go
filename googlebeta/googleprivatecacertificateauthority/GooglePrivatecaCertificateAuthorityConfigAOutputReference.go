...
func (g *jsiiProxy_GooglePrivatecaCertificateAuthorityConfigAOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GooglePrivatecaCertificateAuthorityConfigAOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
