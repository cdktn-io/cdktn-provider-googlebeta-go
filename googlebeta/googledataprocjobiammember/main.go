...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleDataprocJobIamMember.GoogleDataprocJobIamMemberCondition",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleDataprocJobIamMember.GoogleDataprocJobIamMemberConfig",
