...
func (g *jsiiProxy_GoogleAssuredWorkloadsWorkload) validatePutResourceSettingsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleAssuredWorkloadsWorkloadResourceSettings; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_GoogleAssuredWorkloadsWorkload) validateSetDeletionPolicyParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
