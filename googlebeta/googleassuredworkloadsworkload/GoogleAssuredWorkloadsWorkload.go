...
func (j *jsiiProxy_GoogleAssuredWorkloadsWorkload) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleAssuredWorkloadsWorkload) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleAssuredWorkloadsWorkload)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleAssuredWorkloadsWorkload) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleAssuredWorkloadsWorkload) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleAssuredWorkloadsWorkload) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
