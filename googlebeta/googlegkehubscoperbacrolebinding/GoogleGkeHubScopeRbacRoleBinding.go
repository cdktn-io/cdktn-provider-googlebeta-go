...
func (j *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleGkeHubScopeRbacRoleBinding) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
