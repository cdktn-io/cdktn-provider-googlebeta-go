...
func (g *jsiiProxy_GoogleGkeHubScopeRbacRoleBindingRoleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleGkeHubScopeRbacRoleBindingRoleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
