...
func (g *jsiiProxy_GoogleComputeNetworkFirewallPolicyPacketMirroringRuleTargetSecureTagsList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
