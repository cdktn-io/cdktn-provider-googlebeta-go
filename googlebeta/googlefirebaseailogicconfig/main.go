...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "generativeLanguageConfig", GoGetter: "GenerativeLanguageConfig"},
			_jsii_.MemberProperty{JsiiProperty: "generativeLanguageConfigInput", GoGetter: "GenerativeLanguageConfigInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putGenerativeLanguageConfig", GoMethod: "PutGenerativeLanguageConfig"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTrafficFilter", GoMethod: "ResetTrafficFilter"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetTemplateOnly", GoMethod: "ResetTemplateOnly"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "templateOnly", GoGetter: "TemplateOnly"},
			_jsii_.MemberProperty{JsiiProperty: "templateOnlyInput", GoGetter: "TemplateOnlyInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
