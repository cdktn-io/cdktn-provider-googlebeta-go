...
func (g *jsiiProxy_GoogleApigeeApiProductOperationGroupOperationConfigsOutputReference) validatePutAttributesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleApigeeApiProductOperationGroupOperationConfigsAttributes; received %#v (a %T)", value, value)
		}
	}
...
func (g *jsiiProxy_GoogleApigeeApiProductOperationGroupOperationConfigsOutputReference) validatePutOperationsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleApigeeApiProductOperationGroupOperationConfigsOperations; received %#v (a %T)", value, value)
		}
	}
...
func (g *jsiiProxy_GoogleApigeeApiProductOperationGroupOperationConfigsOutputReference) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_GoogleApigeeApiProductOperationGroupOperationConfigsOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *GoogleApigeeApiProductOperationGroupOperationConfigs; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_GoogleApigeeApiProductOperationGroupOperationConfigsOutputReference) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewGoogleApigeeApiProductOperationGroupOperationConfigsOutputReferenceParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) error {
