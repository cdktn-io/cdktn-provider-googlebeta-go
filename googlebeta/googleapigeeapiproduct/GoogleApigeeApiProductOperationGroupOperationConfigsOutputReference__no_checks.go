...
func (g *jsiiProxy_GoogleApigeeApiProductOperationGroupOperationConfigsOutputReference) validateInterpolationForAttributeParameters(terraformAttribute *string) error {
	return nil
}
...
func (g *jsiiProxy_GoogleApigeeApiProductOperationGroupOperationConfigsOutputReference) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
