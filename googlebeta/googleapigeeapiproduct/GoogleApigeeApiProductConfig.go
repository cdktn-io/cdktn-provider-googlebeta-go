...
type GoogleApigeeApiProductConfig struct {
	// Experimental.
	...
	GraphqlOperationGroup *GoogleApigeeApiProductGraphqlOperationGroup `field:"optional" json:"graphqlOperationGroup" yaml:"graphqlOperationGroup"`
	...
	GrpcOperationGroup *GoogleApigeeApiProductGrpcOperationGroup `field:"optional" json:"grpcOperationGroup" yaml:"grpcOperationGroup"`
	...
	OperationGroup *GoogleApigeeApiProductOperationGroup `field:"optional" json:"operationGroup" yaml:"operationGroup"`
	...
	Timeouts *GoogleApigeeApiProductTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}
