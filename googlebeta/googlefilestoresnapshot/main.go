...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleFilestoreSnapshot.GoogleFilestoreSnapshotConfig",
		reflect.TypeOf((*GoogleFilestoreSnapshotConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleFilestoreSnapshot.GoogleFilestoreSnapshotTimeouts",
		reflect.TypeOf((*GoogleFilestoreSnapshotTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.googleFilestoreSnapshot.GoogleFilestoreSnapshotTimeoutsOutputReference",
