...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleComputeDiskIamMember.GoogleComputeDiskIamMemberCondition",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleComputeDiskIamMember.GoogleComputeDiskIamMemberConfig",
