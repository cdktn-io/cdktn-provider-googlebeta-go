...
func (d *jsiiProxy_DataGoogleArtifactRegistryTagsTagsList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryTagsTagsList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_DataGoogleArtifactRegistryTagsTagsList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_DataGoogleArtifactRegistryTagsTagsList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
