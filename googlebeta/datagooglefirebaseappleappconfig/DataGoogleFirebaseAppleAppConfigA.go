...
func (d *jsiiProxy_DataGoogleFirebaseAppleAppConfigA) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataGoogleFirebaseAppleAppConfigA) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
