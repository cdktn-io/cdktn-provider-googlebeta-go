...
func (j *jsiiProxy_GoogleIamOrganizationsPolicyBinding) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleIamOrganizationsPolicyBinding) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.45.0/docs/resources/google_iam_organizations_policy_binding google_iam_organizations_policy_binding} Resource.
...
func (j *jsiiProxy_GoogleIamOrganizationsPolicyBinding)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleIamOrganizationsPolicyBinding) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleIamOrganizationsPolicyBinding) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleIamOrganizationsPolicyBinding) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleIamOrganizationsPolicyBinding) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
