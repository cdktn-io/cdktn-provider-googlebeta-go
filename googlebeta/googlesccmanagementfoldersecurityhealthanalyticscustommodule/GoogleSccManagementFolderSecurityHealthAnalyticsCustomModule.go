...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googlesccmanagementfoldersecurityhealthanalyticscustommodule/internal"
...
func (j *jsiiProxy_GoogleSccManagementFolderSecurityHealthAnalyticsCustomModule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleSccManagementFolderSecurityHealthAnalyticsCustomModule) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleSccManagementFolderSecurityHealthAnalyticsCustomModule) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleSccManagementFolderSecurityHealthAnalyticsCustomModule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleSccManagementFolderSecurityHealthAnalyticsCustomModule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleSccManagementFolderSecurityHealthAnalyticsCustomModule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleSccManagementFolderSecurityHealthAnalyticsCustomModule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.1/docs/resources/google_scc_management_folder_security_health_analytics_custom_module google_scc_management_folder_security_health_analytics_custom_module} Resource.
...
func (j *jsiiProxy_GoogleSccManagementFolderSecurityHealthAnalyticsCustomModule)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_GoogleSccManagementFolderSecurityHealthAnalyticsCustomModule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleSccManagementFolderSecurityHealthAnalyticsCustomModule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleSccManagementFolderSecurityHealthAnalyticsCustomModule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleSccManagementFolderSecurityHealthAnalyticsCustomModule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleSccManagementFolderSecurityHealthAnalyticsCustomModule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleSccManagementFolderSecurityHealthAnalyticsCustomModule) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleSccManagementFolderSecurityHealthAnalyticsCustomModule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleSccManagementFolderSecurityHealthAnalyticsCustomModule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleSccManagementFolderSecurityHealthAnalyticsCustomModule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleSccManagementFolderSecurityHealthAnalyticsCustomModule) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleSccManagementFolderSecurityHealthAnalyticsCustomModule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
