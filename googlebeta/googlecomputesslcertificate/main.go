...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleComputeSslCertificate.GoogleComputeSslCertificateConfig",
		reflect.TypeOf((*GoogleComputeSslCertificateConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleComputeSslCertificate.GoogleComputeSslCertificateTimeouts",
