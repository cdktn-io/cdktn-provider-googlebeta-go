...
func (j *jsiiProxy_GoogleComputeSecurityPolicyRuleA) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleComputeSecurityPolicyRuleA) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleComputeSecurityPolicyRuleA)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleComputeSecurityPolicyRuleA) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleComputeSecurityPolicyRuleA) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleComputeSecurityPolicyRuleA) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleComputeSecurityPolicyRuleA) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
