...
func (j *jsiiProxy_GoogleBeyondcorpSecurityGatewayApplicationUpstreamsExternalEndpointsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGoogleBeyondcorpSecurityGatewayApplicationUpstreamsExternalEndpointsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleBeyondcorpSecurityGatewayApplicationUpstreamsExternalEndpointsList {
	_init_.Initialize()
...
func NewGoogleBeyondcorpSecurityGatewayApplicationUpstreamsExternalEndpointsList_Override(g GoogleBeyondcorpSecurityGatewayApplicationUpstreamsExternalEndpointsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleBeyondcorpSecurityGatewayApplicationUpstreamsExternalEndpointsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleBeyondcorpSecurityGatewayApplicationUpstreamsExternalEndpointsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleBeyondcorpSecurityGatewayApplicationUpstreamsExternalEndpointsList) Resolve(context cdktn.IResolveContext) interface{} {
