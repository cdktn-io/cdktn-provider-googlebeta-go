...
type GoogleApigeeEnvironmentConfig struct {
	...
	ClientIpResolutionConfig *GoogleApigeeEnvironmentClientIpResolutionConfig `field:"optional" json:"clientIpResolutionConfig" yaml:"clientIpResolutionConfig"`
	// Optional.
	//
	...
	Properties *GoogleApigeeEnvironmentProperties `field:"optional" json:"properties" yaml:"properties"`
	// timeouts block.
	//
