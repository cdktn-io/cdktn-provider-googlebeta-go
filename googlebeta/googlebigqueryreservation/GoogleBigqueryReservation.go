...
func (j *jsiiProxy_GoogleBigqueryReservation) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleBigqueryReservation) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleBigqueryReservation) EffectiveLabels() cdktn.StringMap {
...
func (j *jsiiProxy_GoogleBigqueryReservation) Labels() *map[string]*string {
...
func (j *jsiiProxy_GoogleBigqueryReservation) LabelsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"labelsInput",
...
func (j *jsiiProxy_GoogleBigqueryReservation) TerraformLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
func (j *jsiiProxy_GoogleBigqueryReservation)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_GoogleBigqueryReservation)SetLabels(val *map[string]*string) {
...
func (g *jsiiProxy_GoogleBigqueryReservation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleBigqueryReservation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleBigqueryReservation) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleBigqueryReservation) ResetLabels() {
	_jsii_.InvokeVoid(
		g,
		"resetLabels",
		nil, // no parameters
