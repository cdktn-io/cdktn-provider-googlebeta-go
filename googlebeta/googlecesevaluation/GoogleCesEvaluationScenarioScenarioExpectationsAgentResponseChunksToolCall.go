...
type GoogleCesEvaluationScenarioScenarioExpectationsAgentResponseChunksToolCall struct {
	...
	ToolsetTool *GoogleCesEvaluationScenarioScenarioExpectationsAgentResponseChunksToolCallToolsetTool `field:"optional" json:"toolsetTool" yaml:"toolsetTool"`
}
