...
type GoogleCesEvaluationGoldenTurnsStepsExpectationToolResponse struct {
	...
	ToolsetTool *GoogleCesEvaluationGoldenTurnsStepsExpectationToolResponseToolsetTool `field:"optional" json:"toolsetTool" yaml:"toolsetTool"`
}
