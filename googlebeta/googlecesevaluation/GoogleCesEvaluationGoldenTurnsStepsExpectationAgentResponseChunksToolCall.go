...
type GoogleCesEvaluationGoldenTurnsStepsExpectationAgentResponseChunksToolCall struct {
	...
	ToolsetTool *GoogleCesEvaluationGoldenTurnsStepsExpectationAgentResponseChunksToolCallToolsetTool `field:"optional" json:"toolsetTool" yaml:"toolsetTool"`
}
