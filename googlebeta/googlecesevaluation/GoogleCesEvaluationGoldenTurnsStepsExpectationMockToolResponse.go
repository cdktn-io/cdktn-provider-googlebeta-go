...
type GoogleCesEvaluationGoldenTurnsStepsExpectationMockToolResponse struct {
	...
	ToolsetTool *GoogleCesEvaluationGoldenTurnsStepsExpectationMockToolResponseToolsetTool `field:"optional" json:"toolsetTool" yaml:"toolsetTool"`
}
