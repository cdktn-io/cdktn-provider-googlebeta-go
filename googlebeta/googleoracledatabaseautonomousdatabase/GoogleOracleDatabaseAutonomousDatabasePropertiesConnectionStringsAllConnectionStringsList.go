...
func (g *jsiiProxy_GoogleOracleDatabaseAutonomousDatabasePropertiesConnectionStringsAllConnectionStringsList) Resolve(context cdktf.IResolveContext) interface{} {
