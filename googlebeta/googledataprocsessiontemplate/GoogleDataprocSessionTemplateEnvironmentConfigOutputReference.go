...
func (g *jsiiProxy_GoogleDataprocSessionTemplateEnvironmentConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDataprocSessionTemplateEnvironmentConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
