...
type GoogleFirebaseAppCheckResourcePolicyConfig struct {
	// Experimental.
	...
	Timeouts *GoogleFirebaseAppCheckResourcePolicyTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}
