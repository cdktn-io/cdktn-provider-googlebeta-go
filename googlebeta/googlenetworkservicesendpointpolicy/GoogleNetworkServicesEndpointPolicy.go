...
func (g *jsiiProxy_GoogleNetworkServicesEndpointPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleNetworkServicesEndpointPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleNetworkServicesEndpointPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
