...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dataExchange", GoGetter: "DataExchange"},
			...
			_jsii_.MemberProperty{JsiiProperty: "dataExchangeLocation", GoGetter: "DataExchangeLocation"},
			_jsii_.MemberProperty{JsiiProperty: "dataExchangeLocationInput", GoGetter: "DataExchangeLocationInput"},
			_jsii_.MemberProperty{JsiiProperty: "dataExchangeProject", GoGetter: "DataExchangeProject"},
			_jsii_.MemberProperty{JsiiProperty: "dataExchangeProjectInput", GoGetter: "DataExchangeProjectInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRefreshPolicy", GoMethod: "ResetRefreshPolicy"},
			_jsii_.MemberMethod{JsiiMethod: "resetSubscriberContact", GoMethod: "ResetSubscriberContact"},
			...
			_jsii_.MemberProperty{JsiiProperty: "subscriberContactInput", GoGetter: "SubscriberContactInput"},
