...
func (j *jsiiProxy_GoogleBigqueryAnalyticsHubDataExchangeSubscription) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleBigqueryAnalyticsHubDataExchangeSubscription) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleBigqueryAnalyticsHubDataExchangeSubscription)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleBigqueryAnalyticsHubDataExchangeSubscription) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleBigqueryAnalyticsHubDataExchangeSubscription) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleBigqueryAnalyticsHubDataExchangeSubscription) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
