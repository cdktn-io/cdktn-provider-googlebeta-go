...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataGoogleComputeRegionTargetHttpsProxy)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.dataGoogleComputeRegionTargetHttpsProxy.DataGoogleComputeRegionTargetHttpsProxyConfig",
		reflect.TypeOf((*DataGoogleComputeRegionTargetHttpsProxyConfig)(nil)).Elem(),
	)
}
