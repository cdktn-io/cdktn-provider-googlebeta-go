...
func (g *jsiiProxy_GoogleNetworkServicesEdgeCacheOriginTimeoutOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleNetworkServicesEdgeCacheOriginTimeoutOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
