...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleEndpointsServiceConsumersIamPolicy)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleEndpointsServiceConsumersIamPolicy.GoogleEndpointsServiceConsumersIamPolicyConfig",
		reflect.TypeOf((*GoogleEndpointsServiceConsumersIamPolicyConfig)(nil)).Elem(),
	)
}
