...
func (j *jsiiProxy_GoogleBeyondcorpAppGatewayAllocatedConnectionsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGoogleBeyondcorpAppGatewayAllocatedConnectionsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleBeyondcorpAppGatewayAllocatedConnectionsList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-google-beta.googleBeyondcorpAppGateway.GoogleBeyondcorpAppGatewayAllocatedConnectionsList",
...
func NewGoogleBeyondcorpAppGatewayAllocatedConnectionsList_Override(g GoogleBeyondcorpAppGatewayAllocatedConnectionsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleBeyondcorpAppGatewayAllocatedConnectionsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleBeyondcorpAppGatewayAllocatedConnectionsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleBeyondcorpAppGatewayAllocatedConnectionsList) Resolve(context cdktn.IResolveContext) interface{} {
