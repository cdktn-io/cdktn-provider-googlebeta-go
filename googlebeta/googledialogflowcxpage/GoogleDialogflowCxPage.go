...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_dialogflow_cx_page google_dialogflow_cx_page}.
...
func (j *jsiiProxy_GoogleDialogflowCxPage) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleDialogflowCxPage) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleDialogflowCxPage) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleDialogflowCxPage) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleDialogflowCxPage) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleDialogflowCxPage) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleDialogflowCxPage) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_dialogflow_cx_page google_dialogflow_cx_page} Resource.
...
func (j *jsiiProxy_GoogleDialogflowCxPage)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_GoogleDialogflowCxPage)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleDialogflowCxPage)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleDialogflowCxPage)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTN code for importing a GoogleDialogflowCxPage resource upon running "cdktn plan <stack-name>".
func GoogleDialogflowCxPage_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleDialogflowCxPage) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleDialogflowCxPage) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleDialogflowCxPage) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleDialogflowCxPage) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleDialogflowCxPage) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleDialogflowCxPage) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleDialogflowCxPage) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
