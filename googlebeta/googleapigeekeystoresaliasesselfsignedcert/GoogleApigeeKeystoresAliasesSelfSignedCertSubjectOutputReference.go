...
func (g *jsiiProxy_GoogleApigeeKeystoresAliasesSelfSignedCertSubjectOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleApigeeKeystoresAliasesSelfSignedCertSubjectOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
