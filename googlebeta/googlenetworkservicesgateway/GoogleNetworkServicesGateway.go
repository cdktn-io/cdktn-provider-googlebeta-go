...
func (j *jsiiProxy_GoogleNetworkServicesGateway) AllowGlobalAccess() interface{} {
...
func (j *jsiiProxy_GoogleNetworkServicesGateway) AllowGlobalAccessInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleNetworkServicesGateway) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleNetworkServicesGateway) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.45.0/docs/resources/google_network_services_gateway google_network_services_gateway} Resource.
...
func (j *jsiiProxy_GoogleNetworkServicesGateway)SetAllowGlobalAccess(val interface{}) {
...
func (j *jsiiProxy_GoogleNetworkServicesGateway)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleNetworkServicesGateway) ResetAllowGlobalAccess() {
	_jsii_.InvokeVoid(
		g,
		"resetAllowGlobalAccess",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleNetworkServicesGateway) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
