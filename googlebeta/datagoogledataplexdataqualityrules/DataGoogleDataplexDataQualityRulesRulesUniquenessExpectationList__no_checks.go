...
func (d *jsiiProxy_DataGoogleDataplexDataQualityRulesRulesUniquenessExpectationList) validateResolveParameters(context cdktn.IResolveContext) error {
	return nil
}
...
func (j *jsiiProxy_DataGoogleDataplexDataQualityRulesRulesUniquenessExpectationList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	return nil
}
...
func validateNewDataGoogleDataplexDataQualityRulesRulesUniquenessExpectationListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
	return nil
}
