...
func (j *jsiiProxy_GoogleGkeBackupBackupPlanIamBinding) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleGkeBackupBackupPlanIamBinding) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleGkeBackupBackupPlanIamBinding) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleGkeBackupBackupPlanIamBinding) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleGkeBackupBackupPlanIamBinding) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func NewGoogleGkeBackupBackupPlanIamBinding(scope constructs.Construct, id *string, config *GoogleGkeBackupBackupPlanIamBindingConfig) GoogleGkeBackupBackupPlanIamBinding {
	...
	_jsii_.Create(
		"@cdktn/provider-google-beta.googleGkeBackupBackupPlanIamBinding.GoogleGkeBackupBackupPlanIamBinding",
...
func (j *jsiiProxy_GoogleGkeBackupBackupPlanIamBinding)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleGkeBackupBackupPlanIamBinding)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleGkeBackupBackupPlanIamBinding)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleGkeBackupBackupPlanIamBinding_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleGkeBackupBackupPlanIamBinding) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleGkeBackupBackupPlanIamBinding) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleGkeBackupBackupPlanIamBinding) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleGkeBackupBackupPlanIamBinding) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleGkeBackupBackupPlanIamBinding) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleGkeBackupBackupPlanIamBinding) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
