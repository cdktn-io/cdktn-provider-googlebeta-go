...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.googleServiceAccountIamPolicy.GoogleServiceAccountIamPolicy",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleServiceAccountIamPolicy.GoogleServiceAccountIamPolicyConfig",
