...
func (j *jsiiProxy_GoogleBackupDrManagementServerManagementUriList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGoogleBackupDrManagementServerManagementUriList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleBackupDrManagementServerManagementUriList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-google-beta.googleBackupDrManagementServer.GoogleBackupDrManagementServerManagementUriList",
...
func NewGoogleBackupDrManagementServerManagementUriList_Override(g GoogleBackupDrManagementServerManagementUriList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleBackupDrManagementServerManagementUriList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleBackupDrManagementServerManagementUriList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleBackupDrManagementServerManagementUriList) Resolve(context cdktn.IResolveContext) interface{} {
