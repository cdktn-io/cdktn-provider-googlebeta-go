...
func (g *jsiiProxy_GoogleBackupDrManagementServer) validateMarkWriteOnlyAttributeParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
...
func (g *jsiiProxy_GoogleBackupDrManagementServer) validatePutNetworksParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleBackupDrManagementServerNetworks; received %#v (a %T)", value, value)
		}
	}
...
func (g *jsiiProxy_GoogleBackupDrManagementServer) validateRegisterProviderFeatureUsageParameters(feature cdktn.ProviderFeature) error {
	if feature == "" {
...
func (j *jsiiProxy_GoogleBackupDrManagementServer) validateSetDeletionPolicyParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_GoogleBackupDrManagementServer) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
