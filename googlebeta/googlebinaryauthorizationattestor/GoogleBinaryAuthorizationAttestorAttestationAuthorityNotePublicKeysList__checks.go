...
func (g *jsiiProxy_GoogleBinaryAuthorizationAttestorAttestationAuthorityNotePublicKeysList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
