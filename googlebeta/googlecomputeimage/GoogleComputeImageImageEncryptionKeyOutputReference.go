...
func (g *jsiiProxy_GoogleComputeImageImageEncryptionKeyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleComputeImageImageEncryptionKeyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
