...
func (g *jsiiProxy_GoogleComputeImageShieldedInstanceInitialStateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleComputeImageShieldedInstanceInitialStateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
