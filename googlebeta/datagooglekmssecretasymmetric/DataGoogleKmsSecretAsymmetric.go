...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v18/datagooglekmssecretasymmetric/internal"
...
func NewDataGoogleKmsSecretAsymmetric(scope constructs.Construct, id *string, config *DataGoogleKmsSecretAsymmetricConfig) DataGoogleKmsSecretAsymmetric {
	...
	_jsii_.Create(
		"@cdktn/provider-google-beta.dataGoogleKmsSecretAsymmetric.DataGoogleKmsSecretAsymmetric",
