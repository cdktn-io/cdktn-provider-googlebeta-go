...
func (g *jsiiProxy_GoogleColabRuntimeTemplateSoftwareConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleColabRuntimeTemplateSoftwareConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
