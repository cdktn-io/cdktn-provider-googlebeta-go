...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "customerPolicy", GoGetter: "CustomerPolicy"},
			_jsii_.MemberProperty{JsiiProperty: "customerPolicyInput", GoGetter: "CustomerPolicyInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putCustomerPolicy", GoMethod: "PutCustomerPolicy"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "getStringAttribute", GoMethod: "GetStringAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getStringMapAttribute", GoMethod: "GetStringMapAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "ignoreDiacritics", GoGetter: "IgnoreDiacritics"},
			_jsii_.MemberProperty{JsiiProperty: "ignoreDiacriticsInput", GoGetter: "IgnoreDiacriticsInput"},
			_jsii_.MemberProperty{JsiiProperty: "internalValue", GoGetter: "InternalValue"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIgnoreDiacritics", GoMethod: "ResetIgnoreDiacritics"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "modelArmorConfig", GoGetter: "ModelArmorConfig"},
			_jsii_.MemberProperty{JsiiProperty: "modelArmorConfigInput", GoGetter: "ModelArmorConfigInput"},
			_jsii_.MemberMethod{JsiiMethod: "putBannedPhrases", GoMethod: "PutBannedPhrases"},
			_jsii_.MemberMethod{JsiiMethod: "putModelArmorConfig", GoMethod: "PutModelArmorConfig"},
			_jsii_.MemberMethod{JsiiMethod: "resetBannedPhrases", GoMethod: "ResetBannedPhrases"},
			_jsii_.MemberMethod{JsiiMethod: "resetModelArmorConfig", GoMethod: "ResetModelArmorConfig"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "defaultLanguage", GoGetter: "DefaultLanguage"},
			_jsii_.MemberProperty{JsiiProperty: "defaultLanguageInput", GoGetter: "DefaultLanguageInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "putSystemInstruction", GoMethod: "PutSystemInstruction"},
			_jsii_.MemberMethod{JsiiMethod: "resetDefaultLanguage", GoMethod: "ResetDefaultLanguage"},
			_jsii_.MemberMethod{JsiiMethod: "resetSystemInstruction", GoMethod: "ResetSystemInstruction"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "systemInstruction", GoGetter: "SystemInstruction"},
			_jsii_.MemberProperty{JsiiProperty: "systemInstructionInput", GoGetter: "SystemInstructionInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetAdditionalSystemInstruction", GoMethod: "ResetAdditionalSystemInstruction"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
