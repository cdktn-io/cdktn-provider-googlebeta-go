...
func (g *jsiiProxy_GoogleDiscoveryEngineAssistantCustomerPolicyBannedPhrasesList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (g *jsiiProxy_GoogleDiscoveryEngineAssistantCustomerPolicyBannedPhrasesList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_GoogleDiscoveryEngineAssistantCustomerPolicyBannedPhrasesList) validateSetInternalValueParameters(val interface{}) error {
	switch val.(type) {
...
func (j *jsiiProxy_GoogleDiscoveryEngineAssistantCustomerPolicyBannedPhrasesList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_GoogleDiscoveryEngineAssistantCustomerPolicyBannedPhrasesList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
