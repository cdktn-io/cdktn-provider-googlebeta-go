...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleIapAgentRegistryEndpointIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleIapAgentRegistryEndpointIamMember.GoogleIapAgentRegistryEndpointIamMemberCondition",
		reflect.TypeOf((*GoogleIapAgentRegistryEndpointIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleIapAgentRegistryEndpointIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleIapAgentRegistryEndpointIamMember.GoogleIapAgentRegistryEndpointIamMemberConfig",
		reflect.TypeOf((*GoogleIapAgentRegistryEndpointIamMemberConfig)(nil)).Elem(),
	)
}
