...
func (j *jsiiProxy_GoogleBeyondcorpSecurityGateway) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleBeyondcorpSecurityGateway) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleBeyondcorpSecurityGateway)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleBeyondcorpSecurityGateway) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleBeyondcorpSecurityGateway) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleBeyondcorpSecurityGateway) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
