...
func (g *jsiiProxy_GoogleGkeonpremVmwareAdminClusterNetworkConfigStaticIpConfigIpBlocksList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
