...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "multicastGroupConsumerActivations", GoGetter: "MulticastGroupConsumerActivations"},
			_jsii_.MemberProperty{JsiiProperty: "multicastGroupRange", GoGetter: "MulticastGroupRange"},
			_jsii_.MemberProperty{JsiiProperty: "multicastGroupRangeActivationId", GoGetter: "MulticastGroupRangeActivationId"},
			_jsii_.MemberProperty{JsiiProperty: "multicastGroupRangeActivationIdInput", GoGetter: "MulticastGroupRangeActivationIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "multicastGroupRangeInput", GoGetter: "MulticastGroupRangeInput"},
