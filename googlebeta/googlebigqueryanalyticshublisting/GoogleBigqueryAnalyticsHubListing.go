...
func (j *jsiiProxy_GoogleBigqueryAnalyticsHubListing) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleBigqueryAnalyticsHubListing) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleBigqueryAnalyticsHubListing)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleBigqueryAnalyticsHubListing) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleBigqueryAnalyticsHubListing) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleBigqueryAnalyticsHubListing) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
