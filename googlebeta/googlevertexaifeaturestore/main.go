...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "onlineStorageTtlDays", GoGetter: "OnlineStorageTtlDays"},
			_jsii_.MemberProperty{JsiiProperty: "onlineStorageTtlDaysInput", GoGetter: "OnlineStorageTtlDaysInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetOnlineStorageTtlDays", GoMethod: "ResetOnlineStorageTtlDays"},
