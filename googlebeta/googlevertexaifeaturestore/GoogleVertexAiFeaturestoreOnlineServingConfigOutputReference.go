...
func (g *jsiiProxy_GoogleVertexAiFeaturestoreOnlineServingConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleVertexAiFeaturestoreOnlineServingConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
