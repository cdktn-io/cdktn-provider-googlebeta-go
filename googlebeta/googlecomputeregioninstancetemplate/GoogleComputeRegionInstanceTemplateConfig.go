...
type GoogleComputeRegionInstanceTemplateConfig struct {
	...
	WorkloadIdentityConfig *GoogleComputeRegionInstanceTemplateWorkloadIdentityConfig `field:"optional" json:"workloadIdentityConfig" yaml:"workloadIdentityConfig"`
}
