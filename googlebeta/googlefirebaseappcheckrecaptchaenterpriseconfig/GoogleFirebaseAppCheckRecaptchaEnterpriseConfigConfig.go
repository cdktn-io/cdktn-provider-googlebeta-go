...
type GoogleFirebaseAppCheckRecaptchaEnterpriseConfigConfig struct {
	// Experimental.
	...
	Timeouts *GoogleFirebaseAppCheckRecaptchaEnterpriseConfigTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
