...
func (g *jsiiProxy_GooglePubsubSubscriptionBigqueryConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GooglePubsubSubscriptionBigqueryConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
