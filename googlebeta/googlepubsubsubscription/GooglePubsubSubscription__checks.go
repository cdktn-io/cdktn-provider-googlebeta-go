...
func (g *jsiiProxy_GooglePubsubSubscription) validatePutMessageTransformsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GooglePubsubSubscriptionMessageTransforms; received %#v (a %T)", value, value)
		}
	}
