...
func (g *jsiiProxy_GooglePubsubSubscriptionDeadLetterPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GooglePubsubSubscriptionDeadLetterPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
