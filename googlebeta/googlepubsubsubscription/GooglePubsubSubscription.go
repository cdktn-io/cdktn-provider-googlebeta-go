...
func (g *jsiiProxy_GooglePubsubSubscription) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GooglePubsubSubscription) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
