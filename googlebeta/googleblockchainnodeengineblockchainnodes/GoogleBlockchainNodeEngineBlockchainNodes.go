...
func (g *jsiiProxy_GoogleBlockchainNodeEngineBlockchainNodes) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleBlockchainNodeEngineBlockchainNodes) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleBlockchainNodeEngineBlockchainNodes) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
