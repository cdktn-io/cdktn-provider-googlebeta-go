...
func (g *jsiiProxy_GoogleStorageBucketObjectCustomerEncryptionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleStorageBucketObjectCustomerEncryptionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
