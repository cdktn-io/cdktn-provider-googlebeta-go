...
func (g *jsiiProxy_GoogleDnsRecordSetRoutingPolicyPrimaryBackupOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDnsRecordSetRoutingPolicyPrimaryBackupOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
