...
func (g *jsiiProxy_GoogleDnsRecordSetRoutingPolicyWrrOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDnsRecordSetRoutingPolicyWrrOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
