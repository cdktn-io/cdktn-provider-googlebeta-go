...
func (j *jsiiProxy_GoogleComputeInstanceGroupManager) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleComputeInstanceGroupManager) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleComputeInstanceGroupManager)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleComputeInstanceGroupManager) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleComputeInstanceGroupManager) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleComputeInstanceGroupManager) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleComputeInstanceGroupManager) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
