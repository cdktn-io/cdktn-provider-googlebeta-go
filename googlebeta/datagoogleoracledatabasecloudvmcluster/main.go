...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.dataGoogleOracleDatabaseCloudVmCluster.DataGoogleOracleDatabaseCloudVmClusterIdentityConnector",
		reflect.TypeOf((*DataGoogleOracleDatabaseCloudVmClusterIdentityConnector)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataGoogleOracleDatabaseCloudVmClusterIdentityConnectorList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.dataGoogleOracleDatabaseCloudVmCluster.DataGoogleOracleDatabaseCloudVmClusterIdentityConnectorOutputReference",
		reflect.TypeOf((*DataGoogleOracleDatabaseCloudVmClusterIdentityConnectorOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
