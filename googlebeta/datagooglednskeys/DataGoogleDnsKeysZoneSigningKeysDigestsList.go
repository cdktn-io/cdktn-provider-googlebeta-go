...
func (j *jsiiProxy_DataGoogleDnsKeysZoneSigningKeysDigestsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleDnsKeysZoneSigningKeysDigestsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleDnsKeysZoneSigningKeysDigestsList {
	_init_.Initialize()
...
func NewDataGoogleDnsKeysZoneSigningKeysDigestsList_Override(d DataGoogleDnsKeysZoneSigningKeysDigestsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleDnsKeysZoneSigningKeysDigestsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleDnsKeysZoneSigningKeysDigestsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleDnsKeysZoneSigningKeysDigestsList) Resolve(context cdktn.IResolveContext) interface{} {
