...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googlecomputeglobaladdress/internal"
...
func (j *jsiiProxy_GoogleComputeGlobalAddress) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleComputeGlobalAddress) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleComputeGlobalAddress)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleComputeGlobalAddress) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleComputeGlobalAddress) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleComputeGlobalAddress) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleComputeGlobalAddress) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
