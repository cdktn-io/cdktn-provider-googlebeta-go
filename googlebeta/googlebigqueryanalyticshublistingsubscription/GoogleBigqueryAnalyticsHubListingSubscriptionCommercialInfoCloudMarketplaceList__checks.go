...
func (g *jsiiProxy_GoogleBigqueryAnalyticsHubListingSubscriptionCommercialInfoCloudMarketplaceList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
