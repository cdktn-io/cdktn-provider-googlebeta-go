...
func (g *jsiiProxy_GoogleCloudSchedulerJobHttpTargetOidcTokenOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleCloudSchedulerJobHttpTargetOidcTokenOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
