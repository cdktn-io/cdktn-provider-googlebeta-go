...
func (g *jsiiProxy_GoogleCloudSchedulerJobAppEngineHttpTargetOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleCloudSchedulerJobAppEngineHttpTargetOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
