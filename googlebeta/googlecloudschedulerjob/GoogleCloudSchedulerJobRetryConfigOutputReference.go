...
func (g *jsiiProxy_GoogleCloudSchedulerJobRetryConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleCloudSchedulerJobRetryConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
