...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.44.0/docs/resources/google_compute_instance_from_template google_compute_instance_from_template}.
type GoogleComputeInstanceFromTemplate interface {
	...
	WorkloadIdentityConfig() GoogleComputeInstanceFromTemplateWorkloadIdentityConfigOutputReference
	WorkloadIdentityConfigInput() *GoogleComputeInstanceFromTemplateWorkloadIdentityConfig
	Zone() *string
	SetZone(val *string)
	ZoneInput() *string
	...
	PutWorkloadIdentityConfig(value *GoogleComputeInstanceFromTemplateWorkloadIdentityConfig)
...
func (j *jsiiProxy_GoogleComputeInstanceFromTemplate) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleComputeInstanceFromTemplate) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleComputeInstanceFromTemplate) WorkloadIdentityConfig() GoogleComputeInstanceFromTemplateWorkloadIdentityConfigOutputReference {
	var returns GoogleComputeInstanceFromTemplateWorkloadIdentityConfigOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleComputeInstanceFromTemplate) WorkloadIdentityConfigInput() *GoogleComputeInstanceFromTemplateWorkloadIdentityConfig {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.44.0/docs/resources/google_compute_instance_from_template google_compute_instance_from_template} Resource.
...
func (j *jsiiProxy_GoogleComputeInstanceFromTemplate)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleComputeInstanceFromTemplate) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleComputeInstanceFromTemplate) PutWorkloadIdentityConfig(value *GoogleComputeInstanceFromTemplateWorkloadIdentityConfig) {
...
func (g *jsiiProxy_GoogleComputeInstanceFromTemplate) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleComputeInstanceFromTemplate) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleComputeInstanceFromTemplate) ResetWorkloadIdentityConfig() {
	_jsii_.InvokeVoid(
		g,
		"resetWorkloadIdentityConfig",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleComputeInstanceFromTemplate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
