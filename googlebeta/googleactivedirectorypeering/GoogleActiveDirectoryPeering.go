...
func (j *jsiiProxy_GoogleActiveDirectoryPeering) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleActiveDirectoryPeering) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleActiveDirectoryPeering)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleActiveDirectoryPeering) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleActiveDirectoryPeering) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleActiveDirectoryPeering) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleActiveDirectoryPeering) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
