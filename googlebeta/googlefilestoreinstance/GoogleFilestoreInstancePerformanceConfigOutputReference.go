...
func (g *jsiiProxy_GoogleFilestoreInstancePerformanceConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleFilestoreInstancePerformanceConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
