...
type GoogleFilestoreInstanceConfig struct {
	...
	DesiredReplicaState *string `field:"optional" json:"desiredReplicaState" yaml:"desiredReplicaState"`
	...
	DirectoryServices *GoogleFilestoreInstanceDirectoryServices `field:"optional" json:"directoryServices" yaml:"directoryServices"`
