...
func (j *jsiiProxy_GoogleFirebaseExtensionsInstanceRuntimeDataFatalErrorList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGoogleFirebaseExtensionsInstanceRuntimeDataFatalErrorList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleFirebaseExtensionsInstanceRuntimeDataFatalErrorList {
	_init_.Initialize()
...
func NewGoogleFirebaseExtensionsInstanceRuntimeDataFatalErrorList_Override(g GoogleFirebaseExtensionsInstanceRuntimeDataFatalErrorList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleFirebaseExtensionsInstanceRuntimeDataFatalErrorList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleFirebaseExtensionsInstanceRuntimeDataFatalErrorList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleFirebaseExtensionsInstanceRuntimeDataFatalErrorList) Resolve(context cdktn.IResolveContext) interface{} {
