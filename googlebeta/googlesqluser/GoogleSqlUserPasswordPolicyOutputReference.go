...
func (g *jsiiProxy_GoogleSqlUserPasswordPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleSqlUserPasswordPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
