...
func (g *jsiiProxy_GoogleDataFusionInstance) validateAddMoveTargetParameters(moveTarget *string) error {
	if moveTarget == nil {
...
func (g *jsiiProxy_GoogleDataFusionInstance) validateImportFromParameters(id *string) error {
	if id == nil {
...
func (g *jsiiProxy_GoogleDataFusionInstance) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (g *jsiiProxy_GoogleDataFusionInstance) validatePutAcceleratorsParameters(value interface{}) error {
	...
	case *[]*GoogleDataFusionInstanceAccelerators:
		value := value.(*[]*GoogleDataFusionInstanceAccelerators)
	...
	case []*GoogleDataFusionInstanceAccelerators:
		value_ := value.([]*GoogleDataFusionInstanceAccelerators)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleDataFusionInstanceAccelerators; received %#v (a %T)", value, value)
		}
	}
...
func validateGoogleDataFusionInstance_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	if scope == nil {
