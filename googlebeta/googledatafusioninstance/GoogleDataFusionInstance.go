...
func (j *jsiiProxy_GoogleDataFusionInstance) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleDataFusionInstance) EffectiveLabels() cdktn.StringMap {
...
func (j *jsiiProxy_GoogleDataFusionInstance) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleDataFusionInstance) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleDataFusionInstance) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleDataFusionInstance) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleDataFusionInstance) TerraformLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.43.0/docs/resources/google_data_fusion_instance google_data_fusion_instance} Resource.
...
func (j *jsiiProxy_GoogleDataFusionInstance)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleDataFusionInstance)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleDataFusionInstance)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleDataFusionInstance_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleDataFusionInstance) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleDataFusionInstance) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleDataFusionInstance) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleDataFusionInstance) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleDataFusionInstance) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleDataFusionInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
