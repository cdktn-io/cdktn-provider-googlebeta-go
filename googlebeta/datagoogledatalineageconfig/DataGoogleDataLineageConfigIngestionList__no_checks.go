...
func (d *jsiiProxy_DataGoogleDataLineageConfigIngestionList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (d *jsiiProxy_DataGoogleDataLineageConfigIngestionList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataGoogleDataLineageConfigIngestionList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataGoogleDataLineageConfigIngestionList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
