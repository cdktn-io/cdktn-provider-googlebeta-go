...
func (g *jsiiProxy_GoogleDataprocBatchEnvironmentConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDataprocBatchEnvironmentConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
