...
func (g *jsiiProxy_GoogleDataprocBatchPysparkBatchOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDataprocBatchPysparkBatchOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
