...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSandboxLauncher", GoMethod: "ResetSandboxLauncher"},
			...
			_jsii_.MemberProperty{JsiiProperty: "sandboxLauncher", GoGetter: "SandboxLauncher"},
			_jsii_.MemberProperty{JsiiProperty: "sandboxLauncherInput", GoGetter: "SandboxLauncherInput"},
