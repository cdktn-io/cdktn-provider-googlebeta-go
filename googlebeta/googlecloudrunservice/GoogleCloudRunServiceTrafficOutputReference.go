...
func (g *jsiiProxy_GoogleCloudRunServiceTrafficOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleCloudRunServiceTrafficOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
