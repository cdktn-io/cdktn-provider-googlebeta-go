...
func (g *jsiiProxy_GoogleCloudRunServiceTemplateSpecVolumesEmptyDirOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleCloudRunServiceTemplateSpecVolumesEmptyDirOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
