...
func (g *jsiiProxy_GoogleCloudRunServiceTemplateSpecVolumesSecretOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleCloudRunServiceTemplateSpecVolumesSecretOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
