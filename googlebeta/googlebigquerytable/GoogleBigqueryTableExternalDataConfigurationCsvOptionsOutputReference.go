...
func (g *jsiiProxy_GoogleBigqueryTableExternalDataConfigurationCsvOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleBigqueryTableExternalDataConfigurationCsvOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
