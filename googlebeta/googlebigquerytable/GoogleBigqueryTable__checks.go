...
func (g *jsiiProxy_GoogleBigqueryTable) validatePutTableReplicationInfoParameters(value *GoogleBigqueryTableTableReplicationInfo) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(value, func() string { return "parameter value" }); err != nil {
...
func (j *jsiiProxy_GoogleBigqueryTable) validateSetDeletionPolicyParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_GoogleBigqueryTable) validateSetIgnoreAutoGeneratedSchemaParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
...
func (j *jsiiProxy_GoogleBigqueryTable) validateSetIgnoreSchemaChangesParameters(val *[]*string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_GoogleBigqueryTable) validateSetResourceTagsParameters(val *map[string]*string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
