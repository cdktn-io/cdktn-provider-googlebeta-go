...
func (g *jsiiProxy_GoogleTranscoderJobTemplateConfigOverlaysOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleTranscoderJobTemplateConfigOverlaysOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
