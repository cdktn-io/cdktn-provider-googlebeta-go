...
func (g *jsiiProxy_GoogleTranscoderJobTemplateConfigEncryptionsDrmSystemsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleTranscoderJobTemplateConfigEncryptionsDrmSystemsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
