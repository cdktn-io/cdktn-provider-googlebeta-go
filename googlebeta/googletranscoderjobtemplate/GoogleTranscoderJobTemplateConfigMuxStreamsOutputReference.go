...
func (g *jsiiProxy_GoogleTranscoderJobTemplateConfigMuxStreamsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleTranscoderJobTemplateConfigMuxStreamsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
