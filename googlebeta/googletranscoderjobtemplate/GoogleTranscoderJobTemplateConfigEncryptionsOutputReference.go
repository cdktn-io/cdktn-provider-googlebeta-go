...
func (g *jsiiProxy_GoogleTranscoderJobTemplateConfigEncryptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleTranscoderJobTemplateConfigEncryptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
