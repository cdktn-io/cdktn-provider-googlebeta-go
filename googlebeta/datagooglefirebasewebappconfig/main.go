...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "measurementId", GoGetter: "MeasurementId"},
			_jsii_.MemberProperty{JsiiProperty: "messagingSenderId", GoGetter: "MessagingSenderId"},
