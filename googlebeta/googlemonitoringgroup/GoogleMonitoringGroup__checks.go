...
func (g *jsiiProxy_GoogleMonitoringGroup) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (j *jsiiProxy_GoogleMonitoringGroup) validateSetCountParameters(val interface{}) error {
	switch val.(type) {
	case *float64:
		// ok
	case float64:
...
func (j *jsiiProxy_GoogleMonitoringGroup) validateSetDeletionPolicyParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_GoogleMonitoringGroup) validateSetLifecycleParameters(val *cdktn.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
