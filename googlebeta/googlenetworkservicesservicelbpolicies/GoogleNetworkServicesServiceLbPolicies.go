...
func (j *jsiiProxy_GoogleNetworkServicesServiceLbPolicies) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleNetworkServicesServiceLbPolicies) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleNetworkServicesServiceLbPolicies)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleNetworkServicesServiceLbPolicies) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleNetworkServicesServiceLbPolicies) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleNetworkServicesServiceLbPolicies) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
