...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.googleComputeDiskIamPolicy.GoogleComputeDiskIamPolicy",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleComputeDiskIamPolicy.GoogleComputeDiskIamPolicyConfig",
