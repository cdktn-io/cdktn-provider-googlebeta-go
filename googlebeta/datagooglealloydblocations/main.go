...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.dataGoogleAlloydbLocations.DataGoogleAlloydbLocationsConfig",
		reflect.TypeOf((*DataGoogleAlloydbLocationsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.dataGoogleAlloydbLocations.DataGoogleAlloydbLocationsLocations",
		reflect.TypeOf((*DataGoogleAlloydbLocationsLocations)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.dataGoogleAlloydbLocations.DataGoogleAlloydbLocationsLocationsList",
