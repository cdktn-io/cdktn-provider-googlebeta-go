...
func (g *jsiiProxy_GoogleDataPipelinePipelineWorkloadOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDataPipelinePipelineWorkloadOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
