...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googleloggingfoldersink/internal"
...
func (j *jsiiProxy_GoogleLoggingFolderSink) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleLoggingFolderSink) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleLoggingFolderSink) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleLoggingFolderSink) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleLoggingFolderSink) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleLoggingFolderSink)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleLoggingFolderSink)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleLoggingFolderSink)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleLoggingFolderSink_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleLoggingFolderSink) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleLoggingFolderSink) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleLoggingFolderSink) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleLoggingFolderSink) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleLoggingFolderSink) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleLoggingFolderSink) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
