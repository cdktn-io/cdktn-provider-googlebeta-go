...
func (j *jsiiProxy_GoogleComputeSnapshot) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleComputeSnapshot) EffectiveLabels() cdktn.StringMap {
...
func (j *jsiiProxy_GoogleComputeSnapshot) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleComputeSnapshot) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleComputeSnapshot) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleComputeSnapshot) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleComputeSnapshot) TerraformLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.45.0/docs/resources/google_compute_snapshot google_compute_snapshot} Resource.
func NewGoogleComputeSnapshot(scope constructs.Construct, id *string, config *GoogleComputeSnapshotConfig) GoogleComputeSnapshot {
	...
	_jsii_.Create(
		"@cdktn/provider-google-beta.googleComputeSnapshot.GoogleComputeSnapshot",
...
func (j *jsiiProxy_GoogleComputeSnapshot)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleComputeSnapshot)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleComputeSnapshot)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleComputeSnapshot_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleComputeSnapshot) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleComputeSnapshot) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleComputeSnapshot) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleComputeSnapshot) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleComputeSnapshot) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleComputeSnapshot) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
