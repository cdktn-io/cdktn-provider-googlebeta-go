...
func (j *jsiiProxy_DataGoogleComputeRoutersRoutersBgpAdvertisedIpRangesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleComputeRoutersRoutersBgpAdvertisedIpRangesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleComputeRoutersRoutersBgpAdvertisedIpRangesList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-google-beta.dataGoogleComputeRouters.DataGoogleComputeRoutersRoutersBgpAdvertisedIpRangesList",
...
func NewDataGoogleComputeRoutersRoutersBgpAdvertisedIpRangesList_Override(d DataGoogleComputeRoutersRoutersBgpAdvertisedIpRangesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComputeRoutersRoutersBgpAdvertisedIpRangesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComputeRoutersRoutersBgpAdvertisedIpRangesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComputeRoutersRoutersBgpAdvertisedIpRangesList) Resolve(context cdktn.IResolveContext) interface{} {
