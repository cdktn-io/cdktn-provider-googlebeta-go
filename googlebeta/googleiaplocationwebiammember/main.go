...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.googleIapLocationWebIamMember.GoogleIapLocationWebIamMember",
		reflect.TypeOf((*GoogleIapLocationWebIamMember)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_GoogleIapLocationWebIamMember{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnTerraformResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleIapLocationWebIamMember.GoogleIapLocationWebIamMemberCondition",
		reflect.TypeOf((*GoogleIapLocationWebIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.googleIapLocationWebIamMember.GoogleIapLocationWebIamMemberConditionOutputReference",
		reflect.TypeOf((*GoogleIapLocationWebIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleIapLocationWebIamMember.GoogleIapLocationWebIamMemberConfig",
		reflect.TypeOf((*GoogleIapLocationWebIamMemberConfig)(nil)).Elem(),
	)
}
