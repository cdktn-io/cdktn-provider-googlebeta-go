...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.googleVertexAiEndpointIamBinding.GoogleVertexAiEndpointIamBinding",
		reflect.TypeOf((*GoogleVertexAiEndpointIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleVertexAiEndpointIamBinding.GoogleVertexAiEndpointIamBindingCondition",
		reflect.TypeOf((*GoogleVertexAiEndpointIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.googleVertexAiEndpointIamBinding.GoogleVertexAiEndpointIamBindingConditionOutputReference",
		reflect.TypeOf((*GoogleVertexAiEndpointIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleVertexAiEndpointIamBinding.GoogleVertexAiEndpointIamBindingConfig",
		reflect.TypeOf((*GoogleVertexAiEndpointIamBindingConfig)(nil)).Elem(),
	)
}
