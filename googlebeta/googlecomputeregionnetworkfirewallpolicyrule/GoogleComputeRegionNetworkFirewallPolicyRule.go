...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googlecomputeregionnetworkfirewallpolicyrule/internal"
...
func (j *jsiiProxy_GoogleComputeRegionNetworkFirewallPolicyRule) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleComputeRegionNetworkFirewallPolicyRule) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleComputeRegionNetworkFirewallPolicyRule) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleComputeRegionNetworkFirewallPolicyRule) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleComputeRegionNetworkFirewallPolicyRule) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleComputeRegionNetworkFirewallPolicyRule) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleComputeRegionNetworkFirewallPolicyRule) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.44.0/docs/resources/google_compute_region_network_firewall_policy_rule google_compute_region_network_firewall_policy_rule} Resource.
...
func (j *jsiiProxy_GoogleComputeRegionNetworkFirewallPolicyRule)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_GoogleComputeRegionNetworkFirewallPolicyRule)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleComputeRegionNetworkFirewallPolicyRule)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleComputeRegionNetworkFirewallPolicyRule)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleComputeRegionNetworkFirewallPolicyRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleComputeRegionNetworkFirewallPolicyRule) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleComputeRegionNetworkFirewallPolicyRule) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleComputeRegionNetworkFirewallPolicyRule) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleComputeRegionNetworkFirewallPolicyRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleComputeRegionNetworkFirewallPolicyRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleComputeRegionNetworkFirewallPolicyRule) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleComputeRegionNetworkFirewallPolicyRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
