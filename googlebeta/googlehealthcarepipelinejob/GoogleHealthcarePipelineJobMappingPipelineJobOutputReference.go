...
func (g *jsiiProxy_GoogleHealthcarePipelineJobMappingPipelineJobOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleHealthcarePipelineJobMappingPipelineJobOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
