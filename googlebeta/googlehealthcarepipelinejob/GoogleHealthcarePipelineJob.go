...
func (g *jsiiProxy_GoogleHealthcarePipelineJob) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleHealthcarePipelineJob) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleHealthcarePipelineJob) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
