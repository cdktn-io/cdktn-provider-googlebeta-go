...
func (g *jsiiProxy_GoogleHealthcarePipelineJobMappingPipelineJobMappingConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleHealthcarePipelineJobMappingPipelineJobMappingConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
