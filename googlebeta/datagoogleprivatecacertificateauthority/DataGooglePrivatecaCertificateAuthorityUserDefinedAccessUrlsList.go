...
func (j *jsiiProxy_DataGooglePrivatecaCertificateAuthorityUserDefinedAccessUrlsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGooglePrivatecaCertificateAuthorityUserDefinedAccessUrlsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGooglePrivatecaCertificateAuthorityUserDefinedAccessUrlsList {
	_init_.Initialize()
...
func NewDataGooglePrivatecaCertificateAuthorityUserDefinedAccessUrlsList_Override(d DataGooglePrivatecaCertificateAuthorityUserDefinedAccessUrlsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGooglePrivatecaCertificateAuthorityUserDefinedAccessUrlsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGooglePrivatecaCertificateAuthorityUserDefinedAccessUrlsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGooglePrivatecaCertificateAuthorityUserDefinedAccessUrlsList) Resolve(context cdktn.IResolveContext) interface{} {
