...
func (j *jsiiProxy_DataGooglePrivatecaCertificateAuthorityConfigSubjectConfigSubjectAltNameList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGooglePrivatecaCertificateAuthorityConfigSubjectConfigSubjectAltNameList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGooglePrivatecaCertificateAuthorityConfigSubjectConfigSubjectAltNameList {
	_init_.Initialize()
...
func NewDataGooglePrivatecaCertificateAuthorityConfigSubjectConfigSubjectAltNameList_Override(d DataGooglePrivatecaCertificateAuthorityConfigSubjectConfigSubjectAltNameList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGooglePrivatecaCertificateAuthorityConfigSubjectConfigSubjectAltNameList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGooglePrivatecaCertificateAuthorityConfigSubjectConfigSubjectAltNameList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGooglePrivatecaCertificateAuthorityConfigSubjectConfigSubjectAltNameList) Resolve(context cdktn.IResolveContext) interface{} {
