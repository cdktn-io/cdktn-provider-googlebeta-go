...
func (j *jsiiProxy_GoogleBackupDrBackupPlanAssociationRulesConfigInfoList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGoogleBackupDrBackupPlanAssociationRulesConfigInfoList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleBackupDrBackupPlanAssociationRulesConfigInfoList {
	_init_.Initialize()
...
func NewGoogleBackupDrBackupPlanAssociationRulesConfigInfoList_Override(g GoogleBackupDrBackupPlanAssociationRulesConfigInfoList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleBackupDrBackupPlanAssociationRulesConfigInfoList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleBackupDrBackupPlanAssociationRulesConfigInfoList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleBackupDrBackupPlanAssociationRulesConfigInfoList) Resolve(context cdktn.IResolveContext) interface{} {
