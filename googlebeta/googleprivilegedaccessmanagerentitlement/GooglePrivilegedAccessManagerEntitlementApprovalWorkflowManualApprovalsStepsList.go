...
func (j *jsiiProxy_GooglePrivilegedAccessManagerEntitlementApprovalWorkflowManualApprovalsStepsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGooglePrivilegedAccessManagerEntitlementApprovalWorkflowManualApprovalsStepsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GooglePrivilegedAccessManagerEntitlementApprovalWorkflowManualApprovalsStepsList {
	_init_.Initialize()
...
func NewGooglePrivilegedAccessManagerEntitlementApprovalWorkflowManualApprovalsStepsList_Override(g GooglePrivilegedAccessManagerEntitlementApprovalWorkflowManualApprovalsStepsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GooglePrivilegedAccessManagerEntitlementApprovalWorkflowManualApprovalsStepsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GooglePrivilegedAccessManagerEntitlementApprovalWorkflowManualApprovalsStepsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GooglePrivilegedAccessManagerEntitlementApprovalWorkflowManualApprovalsStepsList) Resolve(context cdktn.IResolveContext) interface{} {
