...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetExadataInfrastructure", GoMethod: "ResetExadataInfrastructure"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "exascaleDbStorageDetailsInput", GoGetter: "ExascaleDbStorageDetailsInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putExascaleDbStorageDetails", GoMethod: "PutExascaleDbStorageDetails"},
			_jsii_.MemberMethod{JsiiMethod: "putTimeZone", GoMethod: "PutTimeZone"},
			_jsii_.MemberMethod{JsiiMethod: "resetAdditionalFlashCachePercent", GoMethod: "ResetAdditionalFlashCachePercent"},
