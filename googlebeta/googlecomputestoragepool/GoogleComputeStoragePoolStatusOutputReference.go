...
func (g *jsiiProxy_GoogleComputeStoragePoolStatusOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleComputeStoragePoolStatusOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
