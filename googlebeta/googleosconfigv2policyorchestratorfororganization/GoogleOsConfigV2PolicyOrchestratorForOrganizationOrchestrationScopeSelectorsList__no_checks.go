...
func (g *jsiiProxy_GoogleOsConfigV2PolicyOrchestratorForOrganizationOrchestrationScopeSelectorsList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
