...
type GoogleComputeRegionInstantSnapshotIamMemberConfig struct {
	// Experimental.
	...
	Condition *GoogleComputeRegionInstantSnapshotIamMemberCondition `field:"optional" json:"condition" yaml:"condition"`
