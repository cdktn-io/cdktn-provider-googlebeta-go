...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleBiglakeHiveTableIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleBiglakeHiveTableIamBinding.GoogleBiglakeHiveTableIamBindingCondition",
		reflect.TypeOf((*GoogleBiglakeHiveTableIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.googleBiglakeHiveTableIamBinding.GoogleBiglakeHiveTableIamBindingConditionOutputReference",
		reflect.TypeOf((*GoogleBiglakeHiveTableIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleBiglakeHiveTableIamBinding.GoogleBiglakeHiveTableIamBindingConfig",
		reflect.TypeOf((*GoogleBiglakeHiveTableIamBindingConfig)(nil)).Elem(),
	)
}
