...
func (j *jsiiProxy_GoogleDialogflowCxWebhook) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleDialogflowCxWebhook) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleDialogflowCxWebhook) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleDialogflowCxWebhook) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleDialogflowCxWebhook) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleDialogflowCxWebhook)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleDialogflowCxWebhook)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleDialogflowCxWebhook)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleDialogflowCxWebhook_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleDialogflowCxWebhook) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleDialogflowCxWebhook) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleDialogflowCxWebhook) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleDialogflowCxWebhook) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleDialogflowCxWebhook) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleDialogflowCxWebhook) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
