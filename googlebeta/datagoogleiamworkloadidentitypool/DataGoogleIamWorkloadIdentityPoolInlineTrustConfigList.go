...
func (j *jsiiProxy_DataGoogleIamWorkloadIdentityPoolInlineTrustConfigList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleIamWorkloadIdentityPoolInlineTrustConfigList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleIamWorkloadIdentityPoolInlineTrustConfigList {
	_init_.Initialize()
...
func NewDataGoogleIamWorkloadIdentityPoolInlineTrustConfigList_Override(d DataGoogleIamWorkloadIdentityPoolInlineTrustConfigList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleIamWorkloadIdentityPoolInlineTrustConfigList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleIamWorkloadIdentityPoolInlineTrustConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleIamWorkloadIdentityPoolInlineTrustConfigList) Resolve(context cdktf.IResolveContext) interface{} {
