...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.dataGoogleComputeReservation.DataGoogleComputeReservationParams",
		reflect.TypeOf((*DataGoogleComputeReservationParams)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.dataGoogleComputeReservation.DataGoogleComputeReservationParamsList",
