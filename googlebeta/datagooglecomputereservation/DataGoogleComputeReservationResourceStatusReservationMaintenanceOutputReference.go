...
func (j *jsiiProxy_DataGoogleComputeReservationResourceStatusReservationMaintenanceOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleComputeReservationResourceStatusReservationMaintenanceOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataGoogleComputeReservationResourceStatusReservationMaintenanceOutputReference {
	_init_.Initialize()
...
func NewDataGoogleComputeReservationResourceStatusReservationMaintenanceOutputReference_Override(d DataGoogleComputeReservationResourceStatusReservationMaintenanceOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComputeReservationResourceStatusReservationMaintenanceOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComputeReservationResourceStatusReservationMaintenanceOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleComputeReservationResourceStatusReservationMaintenanceOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataGoogleComputeReservationResourceStatusReservationMaintenanceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleComputeReservationResourceStatusReservationMaintenanceOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
