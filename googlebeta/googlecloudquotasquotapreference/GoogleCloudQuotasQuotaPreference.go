...
func (g *jsiiProxy_GoogleCloudQuotasQuotaPreference) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleCloudQuotasQuotaPreference) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
