...
type GoogleAgenticApplicationsAnalystAgentPersonaArtifactsConfigVisualizationOptionsVisualizationExamplesResource struct {
	...
	BigqueryResource *GoogleAgenticApplicationsAnalystAgentPersonaArtifactsConfigVisualizationOptionsVisualizationExamplesResourceBigqueryResource `field:"optional" json:"bigqueryResource" yaml:"bigqueryResource"`
	...
	F1Resource *GoogleAgenticApplicationsAnalystAgentPersonaArtifactsConfigVisualizationOptionsVisualizationExamplesResourceF1Resource `field:"optional" json:"f1Resource" yaml:"f1Resource"`
	...
	GoogleCloudStorageResource *GoogleAgenticApplicationsAnalystAgentPersonaArtifactsConfigVisualizationOptionsVisualizationExamplesResourceGoogleCloudStorageResource `field:"optional" json:"googleCloudStorageResource" yaml:"googleCloudStorageResource"`
	...
	GoogleDriveResource *GoogleAgenticApplicationsAnalystAgentPersonaArtifactsConfigVisualizationOptionsVisualizationExamplesResourceGoogleDriveResource `field:"optional" json:"googleDriveResource" yaml:"googleDriveResource"`
	...
	RawFileResource *GoogleAgenticApplicationsAnalystAgentPersonaArtifactsConfigVisualizationOptionsVisualizationExamplesResourceRawFileResource `field:"optional" json:"rawFileResource" yaml:"rawFileResource"`
