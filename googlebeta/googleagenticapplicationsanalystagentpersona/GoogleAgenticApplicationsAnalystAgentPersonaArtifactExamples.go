...
type GoogleAgenticApplicationsAnalystAgentPersonaArtifactExamples struct {
	// resource block.
	//
	...
	Resource *GoogleAgenticApplicationsAnalystAgentPersonaArtifactExamplesResource `field:"required" json:"resource" yaml:"resource"`
}
