...
type GoogleAgenticApplicationsAnalystAgentPersonaArtifactsConfigSlideGenerationOptionsSlideExamplesResource struct {
	...
	BigqueryResource *GoogleAgenticApplicationsAnalystAgentPersonaArtifactsConfigSlideGenerationOptionsSlideExamplesResourceBigqueryResource `field:"optional" json:"bigqueryResource" yaml:"bigqueryResource"`
	...
	F1Resource *GoogleAgenticApplicationsAnalystAgentPersonaArtifactsConfigSlideGenerationOptionsSlideExamplesResourceF1Resource `field:"optional" json:"f1Resource" yaml:"f1Resource"`
	...
	GoogleCloudStorageResource *GoogleAgenticApplicationsAnalystAgentPersonaArtifactsConfigSlideGenerationOptionsSlideExamplesResourceGoogleCloudStorageResource `field:"optional" json:"googleCloudStorageResource" yaml:"googleCloudStorageResource"`
	...
	GoogleDriveResource *GoogleAgenticApplicationsAnalystAgentPersonaArtifactsConfigSlideGenerationOptionsSlideExamplesResourceGoogleDriveResource `field:"optional" json:"googleDriveResource" yaml:"googleDriveResource"`
	...
	RawFileResource *GoogleAgenticApplicationsAnalystAgentPersonaArtifactsConfigSlideGenerationOptionsSlideExamplesResourceRawFileResource `field:"optional" json:"rawFileResource" yaml:"rawFileResource"`
