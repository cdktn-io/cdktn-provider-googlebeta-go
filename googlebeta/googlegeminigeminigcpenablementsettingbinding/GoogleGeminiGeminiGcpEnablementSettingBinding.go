...
func (j *jsiiProxy_GoogleGeminiGeminiGcpEnablementSettingBinding) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleGeminiGeminiGcpEnablementSettingBinding) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleGeminiGeminiGcpEnablementSettingBinding)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleGeminiGeminiGcpEnablementSettingBinding) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleGeminiGeminiGcpEnablementSettingBinding) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleGeminiGeminiGcpEnablementSettingBinding) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
