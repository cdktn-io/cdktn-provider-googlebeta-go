...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googleprivatecacertificatetemplate/internal"
...
func (j *jsiiProxy_GooglePrivatecaCertificateTemplate) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GooglePrivatecaCertificateTemplate) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GooglePrivatecaCertificateTemplate) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GooglePrivatecaCertificateTemplate) EffectiveLabels() cdktn.StringMap {
...
func (j *jsiiProxy_GooglePrivatecaCertificateTemplate) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GooglePrivatecaCertificateTemplate) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GooglePrivatecaCertificateTemplate) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GooglePrivatecaCertificateTemplate) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GooglePrivatecaCertificateTemplate) TerraformLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.45.0/docs/resources/google_privateca_certificate_template google_privateca_certificate_template} Resource.
...
func (j *jsiiProxy_GooglePrivatecaCertificateTemplate)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_GooglePrivatecaCertificateTemplate)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GooglePrivatecaCertificateTemplate)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GooglePrivatecaCertificateTemplate)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GooglePrivatecaCertificateTemplate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GooglePrivatecaCertificateTemplate) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GooglePrivatecaCertificateTemplate) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GooglePrivatecaCertificateTemplate) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GooglePrivatecaCertificateTemplate) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GooglePrivatecaCertificateTemplate) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GooglePrivatecaCertificateTemplate) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GooglePrivatecaCertificateTemplate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
