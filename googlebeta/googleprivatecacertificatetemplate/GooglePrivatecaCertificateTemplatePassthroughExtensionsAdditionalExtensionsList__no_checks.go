...
func (g *jsiiProxy_GooglePrivatecaCertificateTemplatePassthroughExtensionsAdditionalExtensionsList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
