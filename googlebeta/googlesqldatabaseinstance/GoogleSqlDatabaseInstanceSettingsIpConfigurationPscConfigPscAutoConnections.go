...
type GoogleSqlDatabaseInstanceSettingsIpConfigurationPscConfigPscAutoConnections struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.39.0/docs/resources/google_sql_database_instance#consumer_network GoogleSqlDatabaseInstance#consumer_network}
	ConsumerNetwork *string `field:"required" json:"consumerNetwork" yaml:"consumerNetwork"`
	// The project ID of consumer service project of this consumer endpoint.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.39.0/docs/resources/google_sql_database_instance#consumer_service_project_id GoogleSqlDatabaseInstance#consumer_service_project_id}
