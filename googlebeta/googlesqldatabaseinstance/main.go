...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "performanceCaptureConfigInput", GoGetter: "PerformanceCaptureConfigInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putPerformanceCaptureConfig", GoMethod: "PutPerformanceCaptureConfig"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPerformanceCaptureConfig", GoMethod: "ResetPerformanceCaptureConfig"},
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleSqlDatabaseInstance.GoogleSqlDatabaseInstanceSettingsPerformanceCaptureConfig",
		reflect.TypeOf((*GoogleSqlDatabaseInstanceSettingsPerformanceCaptureConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleSqlDatabaseInstanceSettingsPerformanceCaptureConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "cpuUtilizationThresholdPercent", GoGetter: "CpuUtilizationThresholdPercent"},
			_jsii_.MemberProperty{JsiiProperty: "cpuUtilizationThresholdPercentInput", GoGetter: "CpuUtilizationThresholdPercentInput"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "enabled", GoGetter: "Enabled"},
			_jsii_.MemberProperty{JsiiProperty: "enabledInput", GoGetter: "EnabledInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			...
			_jsii_.MemberProperty{JsiiProperty: "historyListLengthThresholdCountInput", GoGetter: "HistoryListLengthThresholdCountInput"},
			_jsii_.MemberProperty{JsiiProperty: "internalValue", GoGetter: "InternalValue"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "memoryUsageThresholdPercent", GoGetter: "MemoryUsageThresholdPercent"},
			_jsii_.MemberProperty{JsiiProperty: "memoryUsageThresholdPercentInput", GoGetter: "MemoryUsageThresholdPercentInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "probingIntervalSecondsInput", GoGetter: "ProbingIntervalSecondsInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetCpuUtilizationThresholdPercent", GoMethod: "ResetCpuUtilizationThresholdPercent"},
			_jsii_.MemberMethod{JsiiMethod: "resetEnabled", GoMethod: "ResetEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetHistoryListLengthThresholdCount", GoMethod: "ResetHistoryListLengthThresholdCount"},
			_jsii_.MemberMethod{JsiiMethod: "resetMemoryUsageThresholdPercent", GoMethod: "ResetMemoryUsageThresholdPercent"},
			_jsii_.MemberMethod{JsiiMethod: "resetProbeThreshold", GoMethod: "ResetProbeThreshold"},
			_jsii_.MemberMethod{JsiiMethod: "resetProbingIntervalSeconds", GoMethod: "ResetProbingIntervalSeconds"},
			_jsii_.MemberMethod{JsiiMethod: "resetRunningThreadsThreshold", GoMethod: "ResetRunningThreadsThreshold"},
			_jsii_.MemberMethod{JsiiMethod: "resetSecondsBehindSourceThreshold", GoMethod: "ResetSecondsBehindSourceThreshold"},
			_jsii_.MemberMethod{JsiiMethod: "resetSemaphoreWaitThresholdCount", GoMethod: "ResetSemaphoreWaitThresholdCount"},
			_jsii_.MemberMethod{JsiiMethod: "resetTransactionDurationThreshold", GoMethod: "ResetTransactionDurationThreshold"},
			_jsii_.MemberMethod{JsiiMethod: "resetTransactionKillExcludedUserHosts", GoMethod: "ResetTransactionKillExcludedUserHosts"},
			_jsii_.MemberMethod{JsiiMethod: "resetTransactionKillThresholdSeconds", GoMethod: "ResetTransactionKillThresholdSeconds"},
			_jsii_.MemberMethod{JsiiMethod: "resetTransactionKillType", GoMethod: "ResetTransactionKillType"},
			_jsii_.MemberMethod{JsiiMethod: "resetTransactionLockWaitThresholdCount", GoMethod: "ResetTransactionLockWaitThresholdCount"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "runningThreadsThreshold", GoGetter: "RunningThreadsThreshold"},
			_jsii_.MemberProperty{JsiiProperty: "runningThreadsThresholdInput", GoGetter: "RunningThreadsThresholdInput"},
			_jsii_.MemberProperty{JsiiProperty: "secondsBehindSourceThreshold", GoGetter: "SecondsBehindSourceThreshold"},
			_jsii_.MemberProperty{JsiiProperty: "secondsBehindSourceThresholdInput", GoGetter: "SecondsBehindSourceThresholdInput"},
			_jsii_.MemberProperty{JsiiProperty: "semaphoreWaitThresholdCount", GoGetter: "SemaphoreWaitThresholdCount"},
			_jsii_.MemberProperty{JsiiProperty: "semaphoreWaitThresholdCountInput", GoGetter: "SemaphoreWaitThresholdCountInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
			_jsii_.MemberProperty{JsiiProperty: "transactionDurationThreshold", GoGetter: "TransactionDurationThreshold"},
			_jsii_.MemberProperty{JsiiProperty: "transactionDurationThresholdInput", GoGetter: "TransactionDurationThresholdInput"},
			_jsii_.MemberProperty{JsiiProperty: "transactionKillExcludedUserHosts", GoGetter: "TransactionKillExcludedUserHosts"},
			_jsii_.MemberProperty{JsiiProperty: "transactionKillExcludedUserHostsInput", GoGetter: "TransactionKillExcludedUserHostsInput"},
			_jsii_.MemberProperty{JsiiProperty: "transactionKillThresholdSeconds", GoGetter: "TransactionKillThresholdSeconds"},
			_jsii_.MemberProperty{JsiiProperty: "transactionKillThresholdSecondsInput", GoGetter: "TransactionKillThresholdSecondsInput"},
			_jsii_.MemberProperty{JsiiProperty: "transactionKillType", GoGetter: "TransactionKillType"},
			_jsii_.MemberProperty{JsiiProperty: "transactionKillTypeInput", GoGetter: "TransactionKillTypeInput"},
			_jsii_.MemberProperty{JsiiProperty: "transactionLockWaitThresholdCount", GoGetter: "TransactionLockWaitThresholdCount"},
			_jsii_.MemberProperty{JsiiProperty: "transactionLockWaitThresholdCountInput", GoGetter: "TransactionLockWaitThresholdCountInput"},
		},
		func() interface{} {
