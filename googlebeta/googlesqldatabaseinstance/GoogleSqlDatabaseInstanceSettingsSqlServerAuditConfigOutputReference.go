...
func (g *jsiiProxy_GoogleSqlDatabaseInstanceSettingsSqlServerAuditConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleSqlDatabaseInstanceSettingsSqlServerAuditConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
