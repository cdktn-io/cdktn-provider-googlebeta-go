...
func (g *jsiiProxy_GoogleSqlDatabaseInstanceSettingsMaintenanceWindowOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleSqlDatabaseInstanceSettingsMaintenanceWindowOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
