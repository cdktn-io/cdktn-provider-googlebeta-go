...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.44.0/docs/resources/google_sql_database_instance google_sql_database_instance}.
...
func (j *jsiiProxy_GoogleSqlDatabaseInstance) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleSqlDatabaseInstance) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.44.0/docs/resources/google_sql_database_instance google_sql_database_instance} Resource.
...
func (j *jsiiProxy_GoogleSqlDatabaseInstance)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleSqlDatabaseInstance) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleSqlDatabaseInstance) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleSqlDatabaseInstance) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleSqlDatabaseInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
