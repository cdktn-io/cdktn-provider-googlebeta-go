...
func (g *jsiiProxy_GoogleSqlDatabaseInstanceCloneOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleSqlDatabaseInstanceCloneOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
