...
func (g *jsiiProxy_GoogleComputeRegionHealthCheckSslHealthCheckOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleComputeRegionHealthCheckSslHealthCheckOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
