...
func (j *jsiiProxy_GoogleComputeOrganizationSecurityPolicyRulePreconfiguredWafConfigExclusionRequestCookieOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	case *GoogleComputeOrganizationSecurityPolicyRulePreconfiguredWafConfigExclusionRequestCookie:
		val := val.(*GoogleComputeOrganizationSecurityPolicyRulePreconfiguredWafConfigExclusionRequestCookie)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case GoogleComputeOrganizationSecurityPolicyRulePreconfiguredWafConfigExclusionRequestCookie:
		val_ := val.(GoogleComputeOrganizationSecurityPolicyRulePreconfiguredWafConfigExclusionRequestCookie)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktn.IResolvable, *GoogleComputeOrganizationSecurityPolicyRulePreconfiguredWafConfigExclusionRequestCookie; received %#v (a %T)", val, val)
		}
	}
