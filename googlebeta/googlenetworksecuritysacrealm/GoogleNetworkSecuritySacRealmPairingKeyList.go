...
func (j *jsiiProxy_GoogleNetworkSecuritySacRealmPairingKeyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGoogleNetworkSecuritySacRealmPairingKeyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleNetworkSecuritySacRealmPairingKeyList {
	_init_.Initialize()
...
func NewGoogleNetworkSecuritySacRealmPairingKeyList_Override(g GoogleNetworkSecuritySacRealmPairingKeyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleNetworkSecuritySacRealmPairingKeyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleNetworkSecuritySacRealmPairingKeyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleNetworkSecuritySacRealmPairingKeyList) Resolve(context cdktn.IResolveContext) interface{} {
