...
func (g *jsiiProxy_GoogleNetworkSecuritySacRealmPairingKeyList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (g *jsiiProxy_GoogleNetworkSecuritySacRealmPairingKeyList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_GoogleNetworkSecuritySacRealmPairingKeyList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_GoogleNetworkSecuritySacRealmPairingKeyList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
