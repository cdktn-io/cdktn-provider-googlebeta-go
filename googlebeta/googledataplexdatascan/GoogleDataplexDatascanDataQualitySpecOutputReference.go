...
func (g *jsiiProxy_GoogleDataplexDatascanDataQualitySpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDataplexDatascanDataQualitySpecOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
