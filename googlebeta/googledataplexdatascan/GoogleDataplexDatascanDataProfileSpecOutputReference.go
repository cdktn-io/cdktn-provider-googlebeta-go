...
func (g *jsiiProxy_GoogleDataplexDatascanDataProfileSpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDataplexDatascanDataProfileSpecOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
