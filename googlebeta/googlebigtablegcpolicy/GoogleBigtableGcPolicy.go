...
func (j *jsiiProxy_GoogleBigtableGcPolicy) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleBigtableGcPolicy) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleBigtableGcPolicy) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleBigtableGcPolicy) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleBigtableGcPolicy) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleBigtableGcPolicy)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleBigtableGcPolicy)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleBigtableGcPolicy)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleBigtableGcPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleBigtableGcPolicy) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleBigtableGcPolicy) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleBigtableGcPolicy) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleBigtableGcPolicy) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleBigtableGcPolicy) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleBigtableGcPolicy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
