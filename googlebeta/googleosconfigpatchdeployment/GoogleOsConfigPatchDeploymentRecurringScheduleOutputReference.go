...
func (g *jsiiProxy_GoogleOsConfigPatchDeploymentRecurringScheduleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleOsConfigPatchDeploymentRecurringScheduleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
