...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googleosconfigpatchdeployment/internal"
...
func (j *jsiiProxy_GoogleOsConfigPatchDeployment) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleOsConfigPatchDeployment) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleOsConfigPatchDeployment) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleOsConfigPatchDeployment) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleOsConfigPatchDeployment) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleOsConfigPatchDeployment)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleOsConfigPatchDeployment)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleOsConfigPatchDeployment)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleOsConfigPatchDeployment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleOsConfigPatchDeployment) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleOsConfigPatchDeployment) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleOsConfigPatchDeployment) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleOsConfigPatchDeployment) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleOsConfigPatchDeployment) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleOsConfigPatchDeployment) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
