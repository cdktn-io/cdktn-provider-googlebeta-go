...
func (g *jsiiProxy_GoogleOsConfigPatchDeploymentPatchConfigYumOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleOsConfigPatchDeploymentPatchConfigYumOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
