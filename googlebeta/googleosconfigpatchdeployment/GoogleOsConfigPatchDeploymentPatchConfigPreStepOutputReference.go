...
func (g *jsiiProxy_GoogleOsConfigPatchDeploymentPatchConfigPreStepOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleOsConfigPatchDeploymentPatchConfigPreStepOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
