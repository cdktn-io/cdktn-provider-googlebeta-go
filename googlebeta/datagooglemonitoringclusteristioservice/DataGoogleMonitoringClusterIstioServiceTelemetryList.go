...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v18/datagooglemonitoringclusteristioservice/internal"
...
func (j *jsiiProxy_DataGoogleMonitoringClusterIstioServiceTelemetryList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleMonitoringClusterIstioServiceTelemetryList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleMonitoringClusterIstioServiceTelemetryList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-google-beta.dataGoogleMonitoringClusterIstioService.DataGoogleMonitoringClusterIstioServiceTelemetryList",
...
func NewDataGoogleMonitoringClusterIstioServiceTelemetryList_Override(d DataGoogleMonitoringClusterIstioServiceTelemetryList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleMonitoringClusterIstioServiceTelemetryList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleMonitoringClusterIstioServiceTelemetryList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleMonitoringClusterIstioServiceTelemetryList) Resolve(context cdktn.IResolveContext) interface{} {
