...
func (j *jsiiProxy_DataGoogleServiceAccountIdToken) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataGoogleServiceAccountIdToken) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataGoogleServiceAccountIdToken) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataGoogleServiceAccountIdToken) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataGoogleServiceAccountIdToken) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.32.0/docs/data-sources/google_service_account_id_token google_service_account_id_token} Data Source.
func NewDataGoogleServiceAccountIdToken(scope constructs.Construct, id *string, config *DataGoogleServiceAccountIdTokenConfig) DataGoogleServiceAccountIdToken {
	...
	_jsii_.Create(
		"@cdktn/provider-google-beta.dataGoogleServiceAccountIdToken.DataGoogleServiceAccountIdToken",
...
func (j *jsiiProxy_DataGoogleServiceAccountIdToken)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataGoogleServiceAccountIdToken)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataGoogleServiceAccountIdToken)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataGoogleServiceAccountIdToken_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataGoogleServiceAccountIdToken) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleServiceAccountIdToken) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleServiceAccountIdToken) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
