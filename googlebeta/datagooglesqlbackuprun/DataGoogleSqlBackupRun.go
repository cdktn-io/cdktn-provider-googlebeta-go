...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/datagooglesqlbackuprun/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.45.0/docs/data-sources/google_sql_backup_run google_sql_backup_run} Data Source.
func NewDataGoogleSqlBackupRun(scope constructs.Construct, id *string, config *DataGoogleSqlBackupRunConfig) DataGoogleSqlBackupRun {
	...
	_jsii_.Create(
		"@cdktn/provider-google-beta.dataGoogleSqlBackupRun.DataGoogleSqlBackupRun",
