...
func (j *jsiiProxy_DataGoogleCloudRunV2ServiceTemplateContainersLivenessProbeOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleCloudRunV2ServiceTemplateContainersLivenessProbeOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataGoogleCloudRunV2ServiceTemplateContainersLivenessProbeOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktn/provider-google-beta.dataGoogleCloudRunV2Service.DataGoogleCloudRunV2ServiceTemplateContainersLivenessProbeOutputReference",
...
func NewDataGoogleCloudRunV2ServiceTemplateContainersLivenessProbeOutputReference_Override(d DataGoogleCloudRunV2ServiceTemplateContainersLivenessProbeOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleCloudRunV2ServiceTemplateContainersLivenessProbeOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleCloudRunV2ServiceTemplateContainersLivenessProbeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleCloudRunV2ServiceTemplateContainersLivenessProbeOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataGoogleCloudRunV2ServiceTemplateContainersLivenessProbeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleCloudRunV2ServiceTemplateContainersLivenessProbeOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
