...
func (j *jsiiProxy_DataGoogleGkeHubFeatureSpecFleetobservabilityLoggingConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleGkeHubFeatureSpecFleetobservabilityLoggingConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleGkeHubFeatureSpecFleetobservabilityLoggingConfigList {
	_init_.Initialize()
...
func NewDataGoogleGkeHubFeatureSpecFleetobservabilityLoggingConfigList_Override(d DataGoogleGkeHubFeatureSpecFleetobservabilityLoggingConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleGkeHubFeatureSpecFleetobservabilityLoggingConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleGkeHubFeatureSpecFleetobservabilityLoggingConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleGkeHubFeatureSpecFleetobservabilityLoggingConfigList) Resolve(context cdktn.IResolveContext) interface{} {
