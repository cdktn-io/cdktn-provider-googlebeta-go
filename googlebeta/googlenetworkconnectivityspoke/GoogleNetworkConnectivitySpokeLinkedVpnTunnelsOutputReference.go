...
func (g *jsiiProxy_GoogleNetworkConnectivitySpokeLinkedVpnTunnelsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleNetworkConnectivitySpokeLinkedVpnTunnelsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
