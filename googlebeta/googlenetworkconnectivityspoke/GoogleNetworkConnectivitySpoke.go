...
func (j *jsiiProxy_GoogleNetworkConnectivitySpoke) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleNetworkConnectivitySpoke) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleNetworkConnectivitySpoke)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleNetworkConnectivitySpoke) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleNetworkConnectivitySpoke) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleNetworkConnectivitySpoke) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleNetworkConnectivitySpoke) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
