...
type GoogleIapWebRegionForwardingRuleServiceIamMemberConfig struct {
	// Experimental.
	...
	Condition *GoogleIapWebRegionForwardingRuleServiceIamMemberCondition `field:"optional" json:"condition" yaml:"condition"`
