...
func (j *jsiiProxy_GoogleComputeInstanceNetworkInterfaceAliasIpRangeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGoogleComputeInstanceNetworkInterfaceAliasIpRangeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleComputeInstanceNetworkInterfaceAliasIpRangeList {
	_init_.Initialize()
...
func NewGoogleComputeInstanceNetworkInterfaceAliasIpRangeList_Override(g GoogleComputeInstanceNetworkInterfaceAliasIpRangeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleComputeInstanceNetworkInterfaceAliasIpRangeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleComputeInstanceNetworkInterfaceAliasIpRangeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleComputeInstanceNetworkInterfaceAliasIpRangeList) Resolve(context cdktn.IResolveContext) interface{} {
