...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleComputeInstance.GoogleComputeInstanceNetworkInterfaceAliasIpv6Range",
		reflect.TypeOf((*GoogleComputeInstanceNetworkInterfaceAliasIpv6Range)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.googleComputeInstance.GoogleComputeInstanceNetworkInterfaceAliasIpv6RangeList",
		reflect.TypeOf((*GoogleComputeInstanceNetworkInterfaceAliasIpv6RangeList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.googleComputeInstance.GoogleComputeInstanceNetworkInterfaceAliasIpv6RangeOutputReference",
		reflect.TypeOf((*GoogleComputeInstanceNetworkInterfaceAliasIpv6RangeOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
		...
		func() interface{} {
			j := jsiiProxy_GoogleComputeInstanceNetworkInterfaceAliasIpv6RangeOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnComplexObject)
			return &j
		},
	)
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleComputeInstance.GoogleComputeInstanceWorkloadIdentityConfig",
		reflect.TypeOf((*GoogleComputeInstanceWorkloadIdentityConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.googleComputeInstance.GoogleComputeInstanceWorkloadIdentityConfigOutputReference",
		reflect.TypeOf((*GoogleComputeInstanceWorkloadIdentityConfigOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
