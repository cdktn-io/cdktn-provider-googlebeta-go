...
func (g *jsiiProxy_GoogleComputeInstanceBootDiskOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleComputeInstanceBootDiskOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
