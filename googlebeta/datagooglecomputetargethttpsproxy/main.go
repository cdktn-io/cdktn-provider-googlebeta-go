...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataGoogleComputeTargetHttpsProxy)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.dataGoogleComputeTargetHttpsProxy.DataGoogleComputeTargetHttpsProxyConfig",
		reflect.TypeOf((*DataGoogleComputeTargetHttpsProxyConfig)(nil)).Elem(),
	)
}
