...
func (d *jsiiProxy_DataGoogleContainerEngineVersions) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (d *jsiiProxy_DataGoogleContainerEngineVersions) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
