...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googlefirebasedataconnectservice/internal"
...
func (j *jsiiProxy_GoogleFirebaseDataConnectService) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleFirebaseDataConnectService) EffectiveAnnotations() cdktn.StringMap {
...
func (j *jsiiProxy_GoogleFirebaseDataConnectService) EffectiveLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"effectiveLabels",
...
func (j *jsiiProxy_GoogleFirebaseDataConnectService) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleFirebaseDataConnectService) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleFirebaseDataConnectService) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleFirebaseDataConnectService) Reconciling() cdktn.IResolvable {
...
func (j *jsiiProxy_GoogleFirebaseDataConnectService) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleFirebaseDataConnectService) TerraformLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
func (j *jsiiProxy_GoogleFirebaseDataConnectService)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleFirebaseDataConnectService)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleFirebaseDataConnectService)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleFirebaseDataConnectService_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleFirebaseDataConnectService) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleFirebaseDataConnectService) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleFirebaseDataConnectService) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleFirebaseDataConnectService) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleFirebaseDataConnectService) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleFirebaseDataConnectService) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
