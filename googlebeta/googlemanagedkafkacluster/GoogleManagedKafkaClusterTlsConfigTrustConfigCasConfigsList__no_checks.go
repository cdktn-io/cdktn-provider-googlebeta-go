...
func (g *jsiiProxy_GoogleManagedKafkaClusterTlsConfigTrustConfigCasConfigsList) validateResolveParameters(context cdktn.IResolveContext) error {
	return nil
}
...
func (j *jsiiProxy_GoogleManagedKafkaClusterTlsConfigTrustConfigCasConfigsList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	return nil
}
...
func validateNewGoogleManagedKafkaClusterTlsConfigTrustConfigCasConfigsListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
	return nil
}
