...
func (g *jsiiProxy_GoogleManagedKafkaClusterCapacityConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleManagedKafkaClusterCapacityConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
