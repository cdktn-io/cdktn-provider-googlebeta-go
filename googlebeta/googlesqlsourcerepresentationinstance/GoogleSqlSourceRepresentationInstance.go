...
func (j *jsiiProxy_GoogleSqlSourceRepresentationInstance) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleSqlSourceRepresentationInstance) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_sql_source_representation_instance google_sql_source_representation_instance} Resource.
...
func (j *jsiiProxy_GoogleSqlSourceRepresentationInstance)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleSqlSourceRepresentationInstance) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleSqlSourceRepresentationInstance) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleSqlSourceRepresentationInstance) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleSqlSourceRepresentationInstance) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
