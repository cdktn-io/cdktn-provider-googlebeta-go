...
type GoogleClouddeployCustomTargetTypeTasksRender struct {
	// container block.
	//
	...
	Container *GoogleClouddeployCustomTargetTypeTasksRenderContainer `field:"optional" json:"container" yaml:"container"`
}
