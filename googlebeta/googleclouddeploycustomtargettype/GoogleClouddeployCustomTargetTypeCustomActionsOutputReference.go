...
func (g *jsiiProxy_GoogleClouddeployCustomTargetTypeCustomActionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleClouddeployCustomTargetTypeCustomActionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
