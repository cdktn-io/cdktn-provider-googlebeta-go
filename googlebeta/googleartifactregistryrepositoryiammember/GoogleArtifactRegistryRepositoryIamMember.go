...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googleartifactregistryrepositoryiammember/internal"
...
func (j *jsiiProxy_GoogleArtifactRegistryRepositoryIamMember) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleArtifactRegistryRepositoryIamMember) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleArtifactRegistryRepositoryIamMember) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleArtifactRegistryRepositoryIamMember) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleArtifactRegistryRepositoryIamMember) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.44.0/docs/resources/google_artifact_registry_repository_iam_member google_artifact_registry_repository_iam_member} Resource.
func NewGoogleArtifactRegistryRepositoryIamMember(scope constructs.Construct, id *string, config *GoogleArtifactRegistryRepositoryIamMemberConfig) GoogleArtifactRegistryRepositoryIamMember {
	...
	_jsii_.Create(
		"@cdktn/provider-google-beta.googleArtifactRegistryRepositoryIamMember.GoogleArtifactRegistryRepositoryIamMember",
...
func (j *jsiiProxy_GoogleArtifactRegistryRepositoryIamMember)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleArtifactRegistryRepositoryIamMember)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleArtifactRegistryRepositoryIamMember)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleArtifactRegistryRepositoryIamMember_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleArtifactRegistryRepositoryIamMember) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleArtifactRegistryRepositoryIamMember) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleArtifactRegistryRepositoryIamMember) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleArtifactRegistryRepositoryIamMember) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleArtifactRegistryRepositoryIamMember) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleArtifactRegistryRepositoryIamMember) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
