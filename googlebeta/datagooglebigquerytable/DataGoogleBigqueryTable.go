...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.45.0/docs/data-sources/google_bigquery_table google_bigquery_table} Data Source.
func NewDataGoogleBigqueryTable(scope constructs.Construct, id *string, config *DataGoogleBigqueryTableConfig) DataGoogleBigqueryTable {
	...
	_jsii_.Create(
		"@cdktn/provider-google-beta.dataGoogleBigqueryTable.DataGoogleBigqueryTable",
