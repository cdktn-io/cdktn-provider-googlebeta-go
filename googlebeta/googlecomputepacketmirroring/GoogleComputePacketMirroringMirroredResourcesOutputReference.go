...
func (g *jsiiProxy_GoogleComputePacketMirroringMirroredResourcesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleComputePacketMirroringMirroredResourcesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
