...
func (j *jsiiProxy_GoogleComputePacketMirroringMirroredResourcesSubnetworksList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGoogleComputePacketMirroringMirroredResourcesSubnetworksList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleComputePacketMirroringMirroredResourcesSubnetworksList {
	_init_.Initialize()
...
func NewGoogleComputePacketMirroringMirroredResourcesSubnetworksList_Override(g GoogleComputePacketMirroringMirroredResourcesSubnetworksList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleComputePacketMirroringMirroredResourcesSubnetworksList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleComputePacketMirroringMirroredResourcesSubnetworksList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleComputePacketMirroringMirroredResourcesSubnetworksList) Resolve(context cdktn.IResolveContext) interface{} {
