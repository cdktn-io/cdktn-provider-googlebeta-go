...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googlehealthcarehl7v2store/internal"
...
func (j *jsiiProxy_GoogleHealthcareHl7V2Store) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleHealthcareHl7V2Store) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleHealthcareHl7V2Store) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleHealthcareHl7V2Store) EffectiveLabels() cdktn.StringMap {
...
func (j *jsiiProxy_GoogleHealthcareHl7V2Store) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleHealthcareHl7V2Store) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleHealthcareHl7V2Store) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleHealthcareHl7V2Store) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleHealthcareHl7V2Store) TerraformLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
func (j *jsiiProxy_GoogleHealthcareHl7V2Store)SetDeletionPolicy(val *string) {
...
func (j *jsiiProxy_GoogleHealthcareHl7V2Store)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleHealthcareHl7V2Store)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleHealthcareHl7V2Store)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleHealthcareHl7V2Store_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleHealthcareHl7V2Store) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleHealthcareHl7V2Store) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleHealthcareHl7V2Store) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleHealthcareHl7V2Store) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleHealthcareHl7V2Store) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleHealthcareHl7V2Store) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleHealthcareHl7V2Store) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
