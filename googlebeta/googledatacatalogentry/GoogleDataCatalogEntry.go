...
func (g *jsiiProxy_GoogleDataCatalogEntry) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleDataCatalogEntry) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleDataCatalogEntry) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
