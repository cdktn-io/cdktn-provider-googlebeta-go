...
func (j *jsiiProxy_GoogleDataCatalogEntryGcsFilesetSpecSampleGcsFileSpecsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGoogleDataCatalogEntryGcsFilesetSpecSampleGcsFileSpecsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleDataCatalogEntryGcsFilesetSpecSampleGcsFileSpecsList {
	_init_.Initialize()
...
func NewGoogleDataCatalogEntryGcsFilesetSpecSampleGcsFileSpecsList_Override(g GoogleDataCatalogEntryGcsFilesetSpecSampleGcsFileSpecsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleDataCatalogEntryGcsFilesetSpecSampleGcsFileSpecsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleDataCatalogEntryGcsFilesetSpecSampleGcsFileSpecsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleDataCatalogEntryGcsFilesetSpecSampleGcsFileSpecsList) Resolve(context cdktn.IResolveContext) interface{} {
