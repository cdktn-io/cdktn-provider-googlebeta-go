...
func (j *jsiiProxy_GoogleVertexAiEndpoint) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleVertexAiEndpoint) EffectiveLabels() cdktn.StringMap {
...
func (j *jsiiProxy_GoogleVertexAiEndpoint) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleVertexAiEndpoint) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleVertexAiEndpoint) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleVertexAiEndpoint) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleVertexAiEndpoint) TerraformLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.0/docs/resources/google_vertex_ai_endpoint google_vertex_ai_endpoint} Resource.
...
func (j *jsiiProxy_GoogleVertexAiEndpoint)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleVertexAiEndpoint)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleVertexAiEndpoint)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleVertexAiEndpoint_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleVertexAiEndpoint) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleVertexAiEndpoint) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleVertexAiEndpoint) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleVertexAiEndpoint) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleVertexAiEndpoint) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleVertexAiEndpoint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
