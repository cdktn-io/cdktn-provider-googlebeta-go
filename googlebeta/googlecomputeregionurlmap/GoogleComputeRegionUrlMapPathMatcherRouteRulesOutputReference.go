...
func (g *jsiiProxy_GoogleComputeRegionUrlMapPathMatcherRouteRulesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleComputeRegionUrlMapPathMatcherRouteRulesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
