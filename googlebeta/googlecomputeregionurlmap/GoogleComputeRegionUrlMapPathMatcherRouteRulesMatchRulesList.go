...
func (j *jsiiProxy_GoogleComputeRegionUrlMapPathMatcherRouteRulesMatchRulesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGoogleComputeRegionUrlMapPathMatcherRouteRulesMatchRulesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleComputeRegionUrlMapPathMatcherRouteRulesMatchRulesList {
	_init_.Initialize()
...
func NewGoogleComputeRegionUrlMapPathMatcherRouteRulesMatchRulesList_Override(g GoogleComputeRegionUrlMapPathMatcherRouteRulesMatchRulesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleComputeRegionUrlMapPathMatcherRouteRulesMatchRulesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleComputeRegionUrlMapPathMatcherRouteRulesMatchRulesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleComputeRegionUrlMapPathMatcherRouteRulesMatchRulesList) Resolve(context cdktn.IResolveContext) interface{} {
