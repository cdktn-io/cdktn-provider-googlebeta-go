...
func (d *jsiiProxy_DataGoogleDiscoveryEngineDataStoresDataStoresList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataGoogleDiscoveryEngineDataStoresDataStoresList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_DataGoogleDiscoveryEngineDataStoresDataStoresList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_DataGoogleDiscoveryEngineDataStoresDataStoresList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
