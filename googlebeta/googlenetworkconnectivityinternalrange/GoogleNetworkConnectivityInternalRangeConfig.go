...
type GoogleNetworkConnectivityInternalRangeConfig struct {
	...
	AllocationOptions *GoogleNetworkConnectivityInternalRangeAllocationOptions `field:"optional" json:"allocationOptions" yaml:"allocationOptions"`
	...
	Migration *GoogleNetworkConnectivityInternalRangeMigration `field:"optional" json:"migration" yaml:"migration"`
