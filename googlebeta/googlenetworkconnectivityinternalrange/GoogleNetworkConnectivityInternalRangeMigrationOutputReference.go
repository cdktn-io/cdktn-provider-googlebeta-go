...
func (g *jsiiProxy_GoogleNetworkConnectivityInternalRangeMigrationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleNetworkConnectivityInternalRangeMigrationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
