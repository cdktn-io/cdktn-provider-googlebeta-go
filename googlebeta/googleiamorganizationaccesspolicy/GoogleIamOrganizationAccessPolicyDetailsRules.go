...
type GoogleIamOrganizationAccessPolicyDetailsRules struct {
	...
	Operation *GoogleIamOrganizationAccessPolicyDetailsRulesOperation `field:"required" json:"operation" yaml:"operation"`
