...
func (j *jsiiProxy_GoogleContainerAwsClusterWorkloadIdentityConfigList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGoogleContainerAwsClusterWorkloadIdentityConfigList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleContainerAwsClusterWorkloadIdentityConfigList {
	_init_.Initialize()
...
func NewGoogleContainerAwsClusterWorkloadIdentityConfigList_Override(g GoogleContainerAwsClusterWorkloadIdentityConfigList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleContainerAwsClusterWorkloadIdentityConfigList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleContainerAwsClusterWorkloadIdentityConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleContainerAwsClusterWorkloadIdentityConfigList) Resolve(context cdktn.IResolveContext) interface{} {
