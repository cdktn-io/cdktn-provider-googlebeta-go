...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.googleResourceManagerLien.GoogleResourceManagerLien",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleResourceManagerLien.GoogleResourceManagerLienConfig",
		reflect.TypeOf((*GoogleResourceManagerLienConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleResourceManagerLien.GoogleResourceManagerLienTimeouts",
