...
func (j *jsiiProxy_DataGoogleComputeDiskSourceImageEncryptionKeyList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleComputeDiskSourceImageEncryptionKeyList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleComputeDiskSourceImageEncryptionKeyList {
	_init_.Initialize()
...
func NewDataGoogleComputeDiskSourceImageEncryptionKeyList_Override(d DataGoogleComputeDiskSourceImageEncryptionKeyList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComputeDiskSourceImageEncryptionKeyList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComputeDiskSourceImageEncryptionKeyList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComputeDiskSourceImageEncryptionKeyList) Resolve(context cdktn.IResolveContext) interface{} {
