...
func (g *jsiiProxy_GoogleComputeBackendService) validatePutBackendParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleComputeBackendServiceBackend; received %#v (a %T)", value, value)
		}
	}
...
func (g *jsiiProxy_GoogleComputeBackendService) validatePutCustomMetricsParameters(value interface{}) error {
	...
	case *[]*GoogleComputeBackendServiceCustomMetrics:
		value := value.(*[]*GoogleComputeBackendServiceCustomMetrics)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*GoogleComputeBackendServiceCustomMetrics:
		value_ := value.([]*GoogleComputeBackendServiceCustomMetrics)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleComputeBackendServiceCustomMetrics; received %#v (a %T)", value, value)
		}
	}
...
func (g *jsiiProxy_GoogleComputeBackendService) validatePutLocalityLbPoliciesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleComputeBackendServiceLocalityLbPolicies; received %#v (a %T)", value, value)
		}
	}
