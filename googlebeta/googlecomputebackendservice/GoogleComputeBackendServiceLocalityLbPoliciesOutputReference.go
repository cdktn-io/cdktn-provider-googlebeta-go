...
func (g *jsiiProxy_GoogleComputeBackendServiceLocalityLbPoliciesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleComputeBackendServiceLocalityLbPoliciesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
