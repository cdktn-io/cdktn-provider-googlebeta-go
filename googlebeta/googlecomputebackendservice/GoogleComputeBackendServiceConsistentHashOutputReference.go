...
func (g *jsiiProxy_GoogleComputeBackendServiceConsistentHashOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleComputeBackendServiceConsistentHashOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
