...
func (j *jsiiProxy_DataGoogleComputeRouterStatusBestRoutesForRouterList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleComputeRouterStatusBestRoutesForRouterList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleComputeRouterStatusBestRoutesForRouterList {
	_init_.Initialize()
...
func NewDataGoogleComputeRouterStatusBestRoutesForRouterList_Override(d DataGoogleComputeRouterStatusBestRoutesForRouterList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComputeRouterStatusBestRoutesForRouterList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComputeRouterStatusBestRoutesForRouterList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComputeRouterStatusBestRoutesForRouterList) Resolve(context cdktn.IResolveContext) interface{} {
