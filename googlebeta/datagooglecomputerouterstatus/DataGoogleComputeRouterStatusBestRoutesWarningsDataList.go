...
func (j *jsiiProxy_DataGoogleComputeRouterStatusBestRoutesWarningsDataList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleComputeRouterStatusBestRoutesWarningsDataList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleComputeRouterStatusBestRoutesWarningsDataList {
	_init_.Initialize()
...
func NewDataGoogleComputeRouterStatusBestRoutesWarningsDataList_Override(d DataGoogleComputeRouterStatusBestRoutesWarningsDataList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleComputeRouterStatusBestRoutesWarningsDataList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleComputeRouterStatusBestRoutesWarningsDataList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleComputeRouterStatusBestRoutesWarningsDataList) Resolve(context cdktn.IResolveContext) interface{} {
