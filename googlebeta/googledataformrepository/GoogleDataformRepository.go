...
func (j *jsiiProxy_GoogleDataformRepository) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleDataformRepository) EffectiveLabels() cdktn.StringMap {
...
func (j *jsiiProxy_GoogleDataformRepository) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleDataformRepository) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleDataformRepository) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleDataformRepository) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleDataformRepository) TerraformLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
func (j *jsiiProxy_GoogleDataformRepository)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleDataformRepository)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleDataformRepository)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleDataformRepository_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleDataformRepository) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleDataformRepository) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleDataformRepository) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleDataformRepository) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleDataformRepository) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleDataformRepository) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
