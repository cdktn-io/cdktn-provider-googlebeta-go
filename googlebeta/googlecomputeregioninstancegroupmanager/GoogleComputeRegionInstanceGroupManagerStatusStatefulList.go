...
func (j *jsiiProxy_GoogleComputeRegionInstanceGroupManagerStatusStatefulList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGoogleComputeRegionInstanceGroupManagerStatusStatefulList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleComputeRegionInstanceGroupManagerStatusStatefulList {
	_init_.Initialize()
...
func NewGoogleComputeRegionInstanceGroupManagerStatusStatefulList_Override(g GoogleComputeRegionInstanceGroupManagerStatusStatefulList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleComputeRegionInstanceGroupManagerStatusStatefulList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleComputeRegionInstanceGroupManagerStatusStatefulList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleComputeRegionInstanceGroupManagerStatusStatefulList) Resolve(context cdktn.IResolveContext) interface{} {
