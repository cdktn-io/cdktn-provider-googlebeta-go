...
func (g *jsiiProxy_GoogleCertificateManagerTrustConfigTrustStoresIntermediateCasList) validateResolveParameters(context cdktn.IResolveContext) error {
	if context == nil {
...
func (j *jsiiProxy_GoogleCertificateManagerTrustConfigTrustStoresIntermediateCasList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewGoogleCertificateManagerTrustConfigTrustStoresIntermediateCasListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
