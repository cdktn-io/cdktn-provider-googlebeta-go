...
func (j *jsiiProxy_GoogleCertificateManagerTrustConfigTrustStoresTrustAnchorsList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewGoogleCertificateManagerTrustConfigTrustStoresTrustAnchorsList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleCertificateManagerTrustConfigTrustStoresTrustAnchorsList {
	_init_.Initialize()
...
func NewGoogleCertificateManagerTrustConfigTrustStoresTrustAnchorsList_Override(g GoogleCertificateManagerTrustConfigTrustStoresTrustAnchorsList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleCertificateManagerTrustConfigTrustStoresTrustAnchorsList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleCertificateManagerTrustConfigTrustStoresTrustAnchorsList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleCertificateManagerTrustConfigTrustStoresTrustAnchorsList) Resolve(context cdktn.IResolveContext) interface{} {
