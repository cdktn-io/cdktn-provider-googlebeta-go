...
func (j *jsiiProxy_GoogleBigtableAppProfile) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleBigtableAppProfile) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleBigtableAppProfile)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleBigtableAppProfile) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleBigtableAppProfile) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleBigtableAppProfile) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleBigtableAppProfile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
