...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googlebillingsubaccount/internal"
...
func (j *jsiiProxy_GoogleBillingSubaccount) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleBillingSubaccount) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleBillingSubaccount) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleBillingSubaccount) Open() cdktn.IResolvable {
...
func (j *jsiiProxy_GoogleBillingSubaccount) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleBillingSubaccount) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.46.1/docs/resources/google_billing_subaccount google_billing_subaccount} Resource.
func NewGoogleBillingSubaccount(scope constructs.Construct, id *string, config *GoogleBillingSubaccountConfig) GoogleBillingSubaccount {
	...
	_jsii_.Create(
		"@cdktn/provider-google-beta.googleBillingSubaccount.GoogleBillingSubaccount",
...
func (j *jsiiProxy_GoogleBillingSubaccount)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleBillingSubaccount)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleBillingSubaccount)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleBillingSubaccount_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleBillingSubaccount) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleBillingSubaccount) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleBillingSubaccount) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleBillingSubaccount) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleBillingSubaccount) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleBillingSubaccount) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
