...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "policyQueryInput", GoGetter: "PolicyQueryInput"},
			_jsii_.MemberProperty{JsiiProperty: "provider", GoGetter: "Provider"},
			_jsii_.MemberProperty{JsiiProperty: "provisioners", GoGetter: "Provisioners"},
			_jsii_.MemberMethod{JsiiMethod: "putPolicyQuery", GoMethod: "PutPolicyQuery"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "valueJson", GoGetter: "ValueJson"},
			_jsii_.MemberProperty{JsiiProperty: "valueJsonInput", GoGetter: "ValueJsonInput"},
		},
		func() interface{} {
