...
func (g *jsiiProxy_GoogleOrgPolicyPolicyDryRunSpecRulesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleOrgPolicyPolicyDryRunSpecRulesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
