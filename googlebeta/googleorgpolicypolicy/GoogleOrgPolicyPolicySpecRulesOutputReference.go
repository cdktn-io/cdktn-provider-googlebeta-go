...
func (g *jsiiProxy_GoogleOrgPolicyPolicySpecRulesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleOrgPolicyPolicySpecRulesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
