...
func (g *jsiiProxy_GoogleOrgPolicyPolicyDryRunSpecOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleOrgPolicyPolicyDryRunSpecOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
