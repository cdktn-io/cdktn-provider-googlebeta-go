...
func (g *jsiiProxy_GoogleOrgPolicyPolicySpecRulesValuesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleOrgPolicyPolicySpecRulesValuesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
