...
func (g *jsiiProxy_GoogleMonitoringAlertPolicyDocumentationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleMonitoringAlertPolicyDocumentationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
