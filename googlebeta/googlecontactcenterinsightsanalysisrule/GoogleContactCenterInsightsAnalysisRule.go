...
func (j *jsiiProxy_GoogleContactCenterInsightsAnalysisRule) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleContactCenterInsightsAnalysisRule) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleContactCenterInsightsAnalysisRule)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleContactCenterInsightsAnalysisRule) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleContactCenterInsightsAnalysisRule) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleContactCenterInsightsAnalysisRule) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleContactCenterInsightsAnalysisRule) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
