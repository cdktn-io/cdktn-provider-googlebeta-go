...
func (j *jsiiProxy_GoogleVertexAiFeatureOnlineStore) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleVertexAiFeatureOnlineStore) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleVertexAiFeatureOnlineStore)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleVertexAiFeatureOnlineStore) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleVertexAiFeatureOnlineStore) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleVertexAiFeatureOnlineStore) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleVertexAiFeatureOnlineStore) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
