...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.googleBiglakeHiveTableIamMember.GoogleBiglakeHiveTableIamMember",
		reflect.TypeOf((*GoogleBiglakeHiveTableIamMember)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_GoogleBiglakeHiveTableIamMember{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnTerraformResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleBiglakeHiveTableIamMember.GoogleBiglakeHiveTableIamMemberCondition",
		reflect.TypeOf((*GoogleBiglakeHiveTableIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.googleBiglakeHiveTableIamMember.GoogleBiglakeHiveTableIamMemberConditionOutputReference",
		reflect.TypeOf((*GoogleBiglakeHiveTableIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleBiglakeHiveTableIamMember.GoogleBiglakeHiveTableIamMemberConfig",
		reflect.TypeOf((*GoogleBiglakeHiveTableIamMemberConfig)(nil)).Elem(),
	)
}
