...
func (j *jsiiProxy_DataGoogleCloudRunV2WorkerPoolInstanceSplitStatusesList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleCloudRunV2WorkerPoolInstanceSplitStatusesList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleCloudRunV2WorkerPoolInstanceSplitStatusesList {
	_init_.Initialize()
...
func NewDataGoogleCloudRunV2WorkerPoolInstanceSplitStatusesList_Override(d DataGoogleCloudRunV2WorkerPoolInstanceSplitStatusesList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleCloudRunV2WorkerPoolInstanceSplitStatusesList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleCloudRunV2WorkerPoolInstanceSplitStatusesList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleCloudRunV2WorkerPoolInstanceSplitStatusesList) Resolve(context cdktn.IResolveContext) interface{} {
