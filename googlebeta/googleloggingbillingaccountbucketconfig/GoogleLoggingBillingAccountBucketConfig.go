...
func (g *jsiiProxy_GoogleLoggingBillingAccountBucketConfig) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleLoggingBillingAccountBucketConfig) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleLoggingBillingAccountBucketConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
