...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleContainerAzureClient.GoogleContainerAzureClientConfig",
		reflect.TypeOf((*GoogleContainerAzureClientConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleContainerAzureClient.GoogleContainerAzureClientTimeouts",
