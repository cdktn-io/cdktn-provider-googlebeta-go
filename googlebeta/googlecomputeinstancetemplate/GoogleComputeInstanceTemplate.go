...
func (j *jsiiProxy_GoogleComputeInstanceTemplate) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_GoogleComputeInstanceTemplate) EffectiveLabels() cdktn.StringMap {
...
func (j *jsiiProxy_GoogleComputeInstanceTemplate) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_GoogleComputeInstanceTemplate) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleComputeInstanceTemplate) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_GoogleComputeInstanceTemplate) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleComputeInstanceTemplate) TerraformLabels() cdktn.StringMap {
	var returns cdktn.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
func (j *jsiiProxy_GoogleComputeInstanceTemplate)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleComputeInstanceTemplate)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleComputeInstanceTemplate)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func GoogleComputeInstanceTemplate_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleComputeInstanceTemplate) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleComputeInstanceTemplate) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (g *jsiiProxy_GoogleComputeInstanceTemplate) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (g *jsiiProxy_GoogleComputeInstanceTemplate) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleComputeInstanceTemplate) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleComputeInstanceTemplate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
