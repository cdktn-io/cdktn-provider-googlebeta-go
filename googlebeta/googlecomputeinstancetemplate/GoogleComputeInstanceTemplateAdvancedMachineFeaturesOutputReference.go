...
func (g *jsiiProxy_GoogleComputeInstanceTemplateAdvancedMachineFeaturesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleComputeInstanceTemplateAdvancedMachineFeaturesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
