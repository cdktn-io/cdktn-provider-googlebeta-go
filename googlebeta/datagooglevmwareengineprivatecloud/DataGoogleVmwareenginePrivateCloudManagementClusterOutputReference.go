...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v18/datagooglevmwareengineprivatecloud/internal"
...
func (j *jsiiProxy_DataGoogleVmwareenginePrivateCloudManagementClusterOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewDataGoogleVmwareenginePrivateCloudManagementClusterOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataGoogleVmwareenginePrivateCloudManagementClusterOutputReference {
	_init_.Initialize()
...
func NewDataGoogleVmwareenginePrivateCloudManagementClusterOutputReference_Override(d DataGoogleVmwareenginePrivateCloudManagementClusterOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleVmwareenginePrivateCloudManagementClusterOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleVmwareenginePrivateCloudManagementClusterOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleVmwareenginePrivateCloudManagementClusterOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (d *jsiiProxy_DataGoogleVmwareenginePrivateCloudManagementClusterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataGoogleVmwareenginePrivateCloudManagementClusterOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
