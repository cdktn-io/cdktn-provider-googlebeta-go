...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleFolderIamBinding.GoogleFolderIamBindingCondition",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleFolderIamBinding.GoogleFolderIamBindingConfig",
