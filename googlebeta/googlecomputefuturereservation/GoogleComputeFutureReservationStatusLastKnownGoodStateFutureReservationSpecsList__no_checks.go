...
func (g *jsiiProxy_GoogleComputeFutureReservationStatusLastKnownGoodStateFutureReservationSpecsList) validateResolveParameters(context cdktn.IResolveContext) error {
	return nil
}
...
func (j *jsiiProxy_GoogleComputeFutureReservationStatusLastKnownGoodStateFutureReservationSpecsList) validateSetTerraformResourceParameters(val cdktn.IInterpolatingParent) error {
	return nil
}
...
func validateNewGoogleComputeFutureReservationStatusLastKnownGoodStateFutureReservationSpecsListParameters(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
	return nil
}
