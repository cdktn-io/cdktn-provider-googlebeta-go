...
func (j *jsiiProxy_GoogleComputeFutureReservationStatusList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleComputeFutureReservationStatusList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleComputeFutureReservationStatusList {
	_init_.Initialize()
...
func NewGoogleComputeFutureReservationStatusList_Override(g GoogleComputeFutureReservationStatusList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleComputeFutureReservationStatusList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleComputeFutureReservationStatusList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleComputeFutureReservationStatusList) Resolve(context cdktf.IResolveContext) interface{} {
