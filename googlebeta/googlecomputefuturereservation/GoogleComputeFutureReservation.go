...
func (j *jsiiProxy_GoogleComputeFutureReservation) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleComputeFutureReservation) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.45.0/docs/resources/google_compute_future_reservation google_compute_future_reservation} Resource.
...
func (j *jsiiProxy_GoogleComputeFutureReservation)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleComputeFutureReservation) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleComputeFutureReservation) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleComputeFutureReservation) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleComputeFutureReservation) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
