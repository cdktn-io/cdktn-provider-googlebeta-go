...
func (g *jsiiProxy_GoogleComputeFutureReservationShareSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleComputeFutureReservationShareSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
