...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.googleBiglakeIcebergTableIamMember.GoogleBiglakeIcebergTableIamMember",
		reflect.TypeOf((*GoogleBiglakeIcebergTableIamMember)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_GoogleBiglakeIcebergTableIamMember{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnTerraformResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleBiglakeIcebergTableIamMember.GoogleBiglakeIcebergTableIamMemberCondition",
		reflect.TypeOf((*GoogleBiglakeIcebergTableIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.googleBiglakeIcebergTableIamMember.GoogleBiglakeIcebergTableIamMemberConditionOutputReference",
		reflect.TypeOf((*GoogleBiglakeIcebergTableIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleBiglakeIcebergTableIamMember.GoogleBiglakeIcebergTableIamMemberConfig",
		reflect.TypeOf((*GoogleBiglakeIcebergTableIamMemberConfig)(nil)).Elem(),
	)
}
