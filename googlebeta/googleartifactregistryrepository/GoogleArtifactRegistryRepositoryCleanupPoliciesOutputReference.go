...
func (g *jsiiProxy_GoogleArtifactRegistryRepositoryCleanupPoliciesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleArtifactRegistryRepositoryCleanupPoliciesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
