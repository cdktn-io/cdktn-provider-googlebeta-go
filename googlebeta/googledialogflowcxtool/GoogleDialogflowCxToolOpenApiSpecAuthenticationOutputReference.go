...
func (g *jsiiProxy_GoogleDialogflowCxToolOpenApiSpecAuthenticationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDialogflowCxToolOpenApiSpecAuthenticationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
