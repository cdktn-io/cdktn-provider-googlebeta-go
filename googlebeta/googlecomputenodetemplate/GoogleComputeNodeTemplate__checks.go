...
func (g *jsiiProxy_GoogleComputeNodeTemplate) validatePutAcceleratorsParameters(value interface{}) error {
	...
	case *[]*GoogleComputeNodeTemplateAccelerators:
		value := value.(*[]*GoogleComputeNodeTemplateAccelerators)
	...
	case []*GoogleComputeNodeTemplateAccelerators:
		value_ := value.([]*GoogleComputeNodeTemplateAccelerators)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*GoogleComputeNodeTemplateAccelerators; received %#v (a %T)", value, value)
		}
	}
...
func (g *jsiiProxy_GoogleComputeNodeTemplate) validatePutDisksParameters(value interface{}) error {
	...
	case *[]*GoogleComputeNodeTemplateDisks:
		value := value.(*[]*GoogleComputeNodeTemplateDisks)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*GoogleComputeNodeTemplateDisks:
		value_ := value.([]*GoogleComputeNodeTemplateDisks)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*GoogleComputeNodeTemplateDisks; received %#v (a %T)", value, value)
		}
	}
