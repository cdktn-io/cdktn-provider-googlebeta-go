...
func (g *jsiiProxy_GoogleComputeNodeTemplate) validatePutAcceleratorsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleComputeNodeTemplateAccelerators; received %#v (a %T)", value, value)
		}
	}
...
func (g *jsiiProxy_GoogleComputeNodeTemplate) validatePutDisksParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleComputeNodeTemplateDisks; received %#v (a %T)", value, value)
		}
	}
