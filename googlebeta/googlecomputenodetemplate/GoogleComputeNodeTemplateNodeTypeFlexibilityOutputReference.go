...
func (g *jsiiProxy_GoogleComputeNodeTemplateNodeTypeFlexibilityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleComputeNodeTemplateNodeTypeFlexibilityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
