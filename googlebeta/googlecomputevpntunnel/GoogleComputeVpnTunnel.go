...
func (j *jsiiProxy_GoogleComputeVpnTunnel) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleComputeVpnTunnel) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleComputeVpnTunnel)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleComputeVpnTunnel) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleComputeVpnTunnel) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleComputeVpnTunnel) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleComputeVpnTunnel) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
