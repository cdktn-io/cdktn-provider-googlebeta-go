...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googlecloudbuildworkerpool/internal"
...
type GoogleCloudbuildWorkerPool interface {
	...
	PrivateServiceConnect() GoogleCloudbuildWorkerPoolPrivateServiceConnectOutputReference
	PrivateServiceConnectInput() *GoogleCloudbuildWorkerPoolPrivateServiceConnect
	Project() *string
	...
	PutPrivateServiceConnect(value *GoogleCloudbuildWorkerPoolPrivateServiceConnect)
...
func (j *jsiiProxy_GoogleCloudbuildWorkerPool) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleCloudbuildWorkerPool) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
func (j *jsiiProxy_GoogleCloudbuildWorkerPool) PrivateServiceConnect() GoogleCloudbuildWorkerPoolPrivateServiceConnectOutputReference {
	var returns GoogleCloudbuildWorkerPoolPrivateServiceConnectOutputReference
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleCloudbuildWorkerPool) PrivateServiceConnectInput() *GoogleCloudbuildWorkerPoolPrivateServiceConnect {
...
func (j *jsiiProxy_GoogleCloudbuildWorkerPool)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleCloudbuildWorkerPool) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleCloudbuildWorkerPool) PutPrivateServiceConnect(value *GoogleCloudbuildWorkerPoolPrivateServiceConnect) {
...
func (g *jsiiProxy_GoogleCloudbuildWorkerPool) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleCloudbuildWorkerPool) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleCloudbuildWorkerPool) ResetPrivateServiceConnect() {
	_jsii_.InvokeVoid(
		g,
		"resetPrivateServiceConnect",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleCloudbuildWorkerPool) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
