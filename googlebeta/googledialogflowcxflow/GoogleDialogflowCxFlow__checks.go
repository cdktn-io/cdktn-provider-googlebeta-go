...
func (g *jsiiProxy_GoogleDialogflowCxFlow) validatePutEventHandlersParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleDialogflowCxFlowEventHandlers; received %#v (a %T)", value, value)
		}
	}
...
func (g *jsiiProxy_GoogleDialogflowCxFlow) validatePutTransitionRoutesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleDialogflowCxFlowTransitionRoutes; received %#v (a %T)", value, value)
		}
	}
