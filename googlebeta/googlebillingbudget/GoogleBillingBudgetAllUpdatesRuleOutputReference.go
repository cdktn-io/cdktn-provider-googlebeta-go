...
func (g *jsiiProxy_GoogleBillingBudgetAllUpdatesRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleBillingBudgetAllUpdatesRuleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
