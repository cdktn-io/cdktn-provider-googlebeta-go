...
func (g *jsiiProxy_GoogleDialogflowCxEntityType) validatePutEntitiesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleDialogflowCxEntityTypeEntities; received %#v (a %T)", value, value)
		}
	}
...
func (g *jsiiProxy_GoogleDialogflowCxEntityType) validatePutExcludedPhrasesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleDialogflowCxEntityTypeExcludedPhrases; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_GoogleDialogflowCxEntityType) validateSetDeletionPolicyParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
