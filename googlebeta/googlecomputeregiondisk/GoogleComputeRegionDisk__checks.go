...
func (g *jsiiProxy_GoogleComputeRegionDisk) validatePutGuestOsFeaturesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktn.IResolvable, *[]*GoogleComputeRegionDiskGuestOsFeatures; received %#v (a %T)", value, value)
		}
	}
