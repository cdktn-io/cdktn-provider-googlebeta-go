...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.googleSpannerInstanceIamBinding.GoogleSpannerInstanceIamBinding",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleSpannerInstanceIamBinding.GoogleSpannerInstanceIamBindingCondition",
		reflect.TypeOf((*GoogleSpannerInstanceIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktn/provider-google-beta.googleSpannerInstanceIamBinding.GoogleSpannerInstanceIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.googleSpannerInstanceIamBinding.GoogleSpannerInstanceIamBindingConfig",
