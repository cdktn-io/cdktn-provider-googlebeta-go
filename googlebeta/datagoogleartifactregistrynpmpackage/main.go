...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataGoogleArtifactRegistryNpmPackage)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktn/provider-google-beta.dataGoogleArtifactRegistryNpmPackage.DataGoogleArtifactRegistryNpmPackageConfig",
		reflect.TypeOf((*DataGoogleArtifactRegistryNpmPackageConfig)(nil)).Elem(),
	)
}
