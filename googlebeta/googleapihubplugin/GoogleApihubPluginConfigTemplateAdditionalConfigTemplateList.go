...
func (j *jsiiProxy_GoogleApihubPluginConfigTemplateAdditionalConfigTemplateList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleApihubPluginConfigTemplateAdditionalConfigTemplateList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleApihubPluginConfigTemplateAdditionalConfigTemplateList {
	_init_.Initialize()
...
func NewGoogleApihubPluginConfigTemplateAdditionalConfigTemplateList_Override(g GoogleApihubPluginConfigTemplateAdditionalConfigTemplateList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleApihubPluginConfigTemplateAdditionalConfigTemplateList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleApihubPluginConfigTemplateAdditionalConfigTemplateList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleApihubPluginConfigTemplateAdditionalConfigTemplateList) Resolve(context cdktf.IResolveContext) interface{} {
