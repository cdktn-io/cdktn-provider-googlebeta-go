...
import (
	...
	"github.com/cdktn-io/cdktn-provider-googlebeta-go/googlebeta/v20/googledataflowflextemplatejob/internal"
...
func (j *jsiiProxy_GoogleDataflowFlexTemplateJob) DeletionPolicy() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicy",
...
func (j *jsiiProxy_GoogleDataflowFlexTemplateJob) DeletionPolicyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deletionPolicyInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.43.0/docs/resources/google_dataflow_flex_template_job google_dataflow_flex_template_job} Resource.
...
func (j *jsiiProxy_GoogleDataflowFlexTemplateJob)SetDeletionPolicy(val *string) {
...
func (g *jsiiProxy_GoogleDataflowFlexTemplateJob) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (g *jsiiProxy_GoogleDataflowFlexTemplateJob) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (g *jsiiProxy_GoogleDataflowFlexTemplateJob) ResetDeletionPolicy() {
	_jsii_.InvokeVoid(
		g,
		"resetDeletionPolicy",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleDataflowFlexTemplateJob) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
